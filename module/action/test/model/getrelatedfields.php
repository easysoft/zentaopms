...
测试获取objectType execution    objectId 4 actionType created               extra 1  的动态信息 >> ,1,|~~|4
测试获取objectType story        objectId 5 actionType linked2build          extra 11 的动态信息 >> ,1,|11|0
测试获取objectType story        objectId 6 actionType unlinkedfrombuild     extra 11 的动态信息 >> ,1,|11|0
测试获取objectType story        objectId 7 actionType estimated             extra 11 的动态信息 >> ,1,|0|11
...
测试获取objectType testtask     objectId 13 actionType linked2testtask      extra 11 的动态信息 >> ,1,|11|0
...
测试获取objectType release      objectId 18 actionType activated            extra 1  的动态信息 >> ,1,|0|0
...
测试获取objectType whitelist    objectId 23 actionType started              extra 1  的动态信息 >> ,0,|0|0
...
//r($action->getRelatedFieldsTest($objectType[3],  $objectId[3],  $actionType[3],  $extra[3]))  && p('product|project|execution', '|') && e(',1,|~~|4');      // 测试获取objectType execution    objectId 4 actionType created               extra 1  的动态信息
//r($action->getRelatedFieldsTest($objectType[4],  $objectId[4],  $actionType[4],  $extra[4]))  && p('product|project|execution', '|') && e(',1,|11|0');      // 测试获取objectType story        objectId 5 actionType linked2build          extra 11 的动态信息
//r($action->getRelatedFieldsTest($objectType[5],  $objectId[5],  $actionType[5],  $extra[5]))  && p('product|project|execution', '|') && e(',1,|11|0');      // 测试获取objectType story        objectId 6 actionType unlinkedfrombuild     extra 11 的动态信息
...
//r($action->getRelatedFieldsTest($objectType[12], $objectId[12], $actionType[12], $extra[12])) && p('product|project|execution', '|') && e(',1,|11|0');      // 测试获取objectType testtask     objectId 13 actionType linked2testtask      extra 11 的动态信息
...
//r($action->getRelatedFieldsTest($objectType[17], $objectId[17], $actionType[17], $extra[17])) && p('product|project|execution', '|') && e(',1,|0|0');       // 测试获取objectType release      objectId 18 actionType activated            extra 1  的动态信息
...
//r($action->getRelatedFieldsTest($objectType[22], $objectId[22], $actionType[22], $extra[22])) && p('product|project|execution', '|') && e(',0,|0|0');       // 测试获取objectType whitelist    objectId 23 actionType started              extra 1  的动态信息
