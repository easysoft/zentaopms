...
$action->project->range('1{20},2{5},3{5}');
...
r($actionTest->getDynamicByProjectTest(1)) && p() && e('20');            // 正常项目ID获取所有用户动态
r($actionTest->getDynamicByProjectTest(1, 'admin')) && p() && e('10');   // 指定用户admin获取项目动态
r($actionTest->getDynamicByProjectTest(1, 'user1')) && p() && e('0');    // 指定用户user1获取项目动态
r($actionTest->getDynamicByProjectTest(0)) && p() && e('30');            // 无效项目ID（0）获取动态
r($actionTest->getDynamicByProjectTest(2)) && p() && e('5');             // 项目ID为2获取动态
