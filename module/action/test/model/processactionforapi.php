...
- 执行actionTest模块的processActionForAPIHistoryTest方法，参数是array  @状态
...
r($actionTest->processActionForAPIHistoryTest(array((object)array('id' => 4, 'actor' => 'admin', 'action' => 'edited', 'objectType' => 'task', 'objectID' => 4, 'date' => '2023-01-04 10:00:00', 'comment' => '', 'extra' => '', 'history' => array((object)array('field' => 'status', 'old' => 'wait', 'new' => 'doing')))), array('admin' => 'admin'), array('status' => '状态'))) && p() && e('状态');
