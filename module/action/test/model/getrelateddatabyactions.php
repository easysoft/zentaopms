...
r($action->getRelatedDataByActionsTest($actions[0], 'relatedProjects')) && p('project:1')                                                  && e('1');                                                                   // 获取动态1 2 3 4 5 relatedProjects的关联信息
r($action->getRelatedDataByActionsTest($actions[0], 'requirements'))    && p('1')                                                          && e('1');                                                                   // 获取动态1 2 3 4 5 requirements的关联信息
r($action->getRelatedDataByActionsTest($actions[1], 'objectNames'))     && p('task:1;build:1;bug:1;testcase:1;case:1;user:0')              && e('开发任务11;项目版本版本1;BUG1;这个是测试用例1;这个是测试用例1;guest'); // 获取动态6 7 8 9 10 objectNames的关联信息
