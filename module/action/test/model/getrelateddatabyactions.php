...
r($action->getRelatedDataByActionsTest($actions[2], 'objectNames'))     && p('testtask:1;doc:1;doclib:1;todo:1;user:0,1')                  && e('测试单1;文档标题1;执行主库;自定义1的待办;guest,admin');                // 获取动态11 12 13 14 15 objectNames的关联信息
