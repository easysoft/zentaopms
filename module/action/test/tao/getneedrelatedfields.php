...
- 测试story类型对象的相关字段获取 >> 期望返回product数组和project、execution字段
- 测试productplan类型对象的相关字段获取 >> 期望正确返回product字段
- 测试branch类型对象的相关字段获取 >> 期望正确返回product字段
- 测试testcase类型对象的相关字段获取 >> 期望正确返回相关字段
- 测试case类型对象的相关字段获取 >> 期望正确返回相关字段
- 测试task类型对象的相关字段获取 >> 期望正确返回相关字段
- 测试release类型对象的相关字段获取 >> 期望正确返回相关字段
- 测试不存在的对象类型的相关字段获取 >> 期望正确处理不存在的情况
