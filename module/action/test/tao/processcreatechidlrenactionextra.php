...
r(strpos($actionTest->processCreateChildrenActionExtraTest('19,20')->extra, '#19') !== false && strpos($actionTest->processCreateChildrenActionExtraTest('19,20')->extra, '#20') !== false) && p() && e('1'); // 测试两个任务ID(ID为19,20)
r($actionTest->processCreateChildrenActionExtraTest('')->extra == '') && p() && e('1'); // 测试空字符串
