...
$lang->action->desc->recordestimate = '$date, recorded by <strong>$actor</strong>，consumed <strong>$extra</strong> hour(s).';
$lang->action->desc->editestimate   = '$date, recorded by <strong>$actor</strong>，consumed <strong>$extra</strong> hour(s).';
$lang->action->desc->deleteestimate = '$date, recorded by <strong>$actor</strong>，consumed <strong>$extra</strong> hour(s).';
