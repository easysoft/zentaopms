...
$lang->action->desc->importfromgitlab = '$date, Created for link issue from gitlab by <strong>$actor</strong>.' . "\n";
...
$lang->action->label->importfromgitlab      = 'created for issue of Gitlab';
