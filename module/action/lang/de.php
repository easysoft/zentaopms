...
$lang->action->desc->adjustmemory            = '$date, resized to <strong>$newMemory</strong> memory by <strong>$actor</strong>.' . "\n";
$lang->action->desc->adjustcpu               = '$date, resized to <strong>$newMemory</strong> CPU by <strong>$actor</strong>.' . "\n";
