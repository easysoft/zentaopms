...
$lang->action->dynamicAction->program['create']   = '創建項目集';
$lang->action->dynamicAction->program['edit']     = '編輯項目集';
$lang->action->dynamicAction->program['activate'] = '激活項目集';
$lang->action->dynamicAction->program['delete']   = '刪除項目集';
$lang->action->dynamicAction->program['close']    = '關閉項目集';

$lang->action->dynamicAction->project['create']   = '創建項目';
$lang->action->dynamicAction->project['edit']     = '編輯項目';
$lang->action->dynamicAction->project['start']    = '開始項目';
$lang->action->dynamicAction->project['suspend']  = '延期項目';
$lang->action->dynamicAction->project['activate'] = '激活項目';
$lang->action->dynamicAction->project['close']    = '關閉項目';
