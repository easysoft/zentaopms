...
class projectreleaseModelTest extends baseTest
{
    ...
    {
        $objects = $this->instance->getList($projectID, $type, $orderBy);
    ...
    {
        $object = $this->instance->getLast($projectID);
    ...
    {
        $objects = $this->instance->getReleasedBuilds($projectID);
    ...
    public function processReleaseTest(int $releaseID): string|array
    {
        ...
        $this->instance->processRelease($release, $branchGroup, $builds);
    ...
    {
        $isClickable = $this->instance->isClickable($release, $action);
