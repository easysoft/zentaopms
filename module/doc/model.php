...
class docModel extends model
{
    ...
    /**
     * 迁移文档，设置新编辑器文档的 html，以及迁移老文档为新文档。
     * Migrate doc, set doc html generated by new editor, and migrate old doc to new doc.
     *
     * @param  int    $docID
     * @param  int    $version
     * @param  string $content
     */
    public function migrateDoc(int $docID, int $version, ?string $content): bool
    {
