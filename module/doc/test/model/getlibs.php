...
r($docTester->getLibsTest($types[6], $extras[0], $appendLibs[0], $objectIds[0], $excludeTypes[0])) && p('')   && e('0');                                 // 查询不到库的情况
r($docTester->getLibsTest($types[6], $extras[1], $appendLibs[0], $objectIds[0], $excludeTypes[0])) && p('')   && e('0');                                 // 查询不到库的情况
