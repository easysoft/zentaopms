...
$tester->dao->insert(TABLE_DOCCONTENT)->set('doc')->eq(1)->set('version')->eq(1)->set('type')->eq('doc')->set('title')->eq('无附件')->set('rawContent')->eq('{"type":"page"}')->set('content')->eq('')->set('addedBy')->eq('admin')->set('addedDate')->eq($now)->exec();
...
$tester->dao->insert(TABLE_DOCCONTENT)->set('doc')->eq(2)->set('version')->eq(1)->set('type')->eq('doc')->set('title')->eq('gid不存在')->set('rawContent')->eq('{"props":{"sourceId":"NOTEXIST"}}')->set('content')->eq('')->set('addedBy')->eq('admin')->set('addedDate')->eq($now)->exec();
...
$tester->dao->insert(TABLE_DOCCONTENT)->set('doc')->eq(10)->set('version')->eq(1)->set('type')->eq('doc')->set('title')->eq('源文档一个附件')->set('rawContent')->eq('{"props":{"sourceId":"GID_A"}}')->set('content')->eq('')->set('addedBy')->eq('admin')->set('addedDate')->eq($now)->exec();
...
$tester->dao->insert(TABLE_DOCCONTENT)->set('doc')->eq(11)->set('version')->eq(1)->set('type')->eq('doc')->set('title')->eq('源文档两个附件')->set('rawContent')->eq('{"props":{"sourceId":"GID_B"},{"props":{"sourceId":"GID_C"}}')->set('content')->eq('')->set('addedBy')->eq('admin')->set('addedDate')->eq($now)->exec();
...
$tester->dao->insert(TABLE_DOCCONTENT)->set('doc')->eq(12)->set('version')->eq(1)->set('type')->eq('doc')->set('title')->eq('源文档重复附件')->set('rawContent')->eq('{"props":{"sourceId":"GID_D"},{"props":{"sourceId":"GID_D"}}')->set('content')->eq('')->set('addedBy')->eq('admin')->set('addedDate')->eq($now)->exec();
