window.changeSpace = function(e)
{
    ...
    loadModal($.createLink('doc', modalAction, "docID=" + docID + "&libID=0&spaceType=" + spaceType + "&space=" + spaceID));
};
window.changeLib = function(e)
{
    let selectedLib = e.target.value;
    loadModal($.createLink('doc', modalAction, "docID=" + docID + "&libID=" + selectedLib + "&spaceType=" + spaceType + "&space=" + space));
};
