...
- 检查用例ID = 1 用例 fromCaseVersion 字段是否改动 @0
- 检查用例ID = 2 用例 fromCaseVersion 字段是否改动 @0
- 检查用例ID = 4 用例 fromCaseVersion 字段是否改动 @1
...
r($file->updateTestcaseVersionTest(1)) && p() && e('0'); //检查用例ID = 1 用例 fromCaseVersion 字段是否改动
r($file->updateTestcaseVersionTest(2)) && p() && e('0'); //检查用例ID = 2 用例 fromCaseVersion 字段是否改动
r($file->updateTestcaseVersionTest(4)) && p() && e('1'); //检查用例ID = 4 用例 fromCaseVersion 字段是否改动
