...
<div class='panel'>
  <div class='panel-heading'>
    <div class='panel-title'>
      <span class='text'><?php echo $measurement->name . " $lang->colon " . $lang->measurement->setPHP;?></span>
      <?php if($measurement->deleted):?>
      <span class='label label-danger'><?php echo $lang->measurement->deleted;?></span>
      <?php endif;?>
    </div>
  </div>
  <form method='post' id='measForm'>
    <table class='table table-form'>
      <tr>
        <td colspan="3"><?php echo html::textarea('code', $code, "placeholder='{$lang->measurement->placeholder->php}' class='form-control' rows='10'");?></td>
      </tr>
    </table>
