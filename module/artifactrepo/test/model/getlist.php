...
- 按照ID正序，每页5条，取第1页的数据
 ...
 - 第1条的repoName属性 @代码库1
 - 第1条的pipelineID属性 @1
 - 第1条的url属性 @https/repository/代码库1/
...
r($artifactrepoTester->getListTest($sorts[1], $recPerPages[0], $pageIds[0])) && p('1:name,products,serverID,repoName,pipelineID,url')  && e('制品库1,1,1,代码库1,1,https/repository/代码库1/');                           // 按照ID正序，每页5条，取第1页的数据
r($artifactrepoTester->getListTest($sorts[1], $recPerPages[1], $pageIds[0])) && p('1:name,products,serverID,repoName,pipelineID,url')  && e('制品库1,1,1,代码库1,1,https/repository/代码库1/');                           // 按照ID正序，每页10条，取第1页的数据
r($artifactrepoTester->getListTest($sorts[1], $recPerPages[2], $pageIds[0])) && p('1:name,products,serverID,repoName,pipelineID,url')  && e('制品库1,1,1,代码库1,1,https/repository/代码库1/');                           // 按照ID正序，每页20条，取第1页的数据
r($artifactrepoTester->getListTest($sorts[1], $recPerPages[0], $pageIds[1])) && p('1:name,products,serverID,repoName,pipelineID,url')  && e('制品库1,1,1,代码库1,1,https/repository/代码库1/');                           // 按照ID正序，每页5条，取第2页的数据
r($artifactrepoTester->getListTest($sorts[1], $recPerPages[1], $pageIds[1])) && p('1:name,products,serverID,repoName,pipelineID,url')  && e('制品库1,1,1,代码库1,1,https/repository/代码库1/');                           // 按照ID正序，每页10条，取第2页的数据
r($artifactrepoTester->getListTest($sorts[1], $recPerPages[2], $pageIds[1])) && p('1:name,products,serverID,repoName,pipelineID,url')  && e('制品库1,1,1,代码库1,1,https/repository/代码库1/');                           // 按照ID正序，每页20条，取第2页的数据
