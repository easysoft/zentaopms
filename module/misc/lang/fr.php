...
/* Release Detail. */
$lang->misc->feature->all['20.2.0'][]      = array('title' => "Optimization of the product matrix, addition of platform application configuration features, optimization of approval processes, addition of new business requirements to the OR interface, initiation of projects based on set milestones and charters as needed, support for infinite hierarchical business requirements, support for development phase estimations based on business requirements, support for delivery phase estimations during distribution and splitting of OR requirements, enabling OR requirements to be distributed as business requirements, achieving estimations of OR requirements and user needs during version upgrades, and adding TR4A review points in the development phase.", 'desc' => '');
