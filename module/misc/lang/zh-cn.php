...
$lang->misc->copyright   = "&copy; 2009 - " . date('Y') . " <a href='https://www.chandao.com' target='_blank'>禅道软件（青岛）集团有限公司</a> 电话：4006-8899-23 Email：<a href='mailto:co@zentao.net'>co@zentao.net</a>  QQ：1492153927";
...
/* Release Detail. */
$lang->misc->feature->all['22.4'][]        = array('title' => '细节功能完善支持在禅道智能会话中实时访问和操作禅道数据。禅道智能体优化、skills管理。功能优化兼容旗舰版。', 'desc' => '');
...
$lang->misc->feature->all['21.1'][]        = array('title' => '文档接口空间优化升级，接口空间核心功能入口优化，主机功能优化，对象间关联关系完善，度量项补0逻辑，DuckDB相关优化，上线功能优化。', 'desc' => '');
