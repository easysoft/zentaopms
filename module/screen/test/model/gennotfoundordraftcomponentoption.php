...
- 步骤1：测试component为null、chart有名称、type为chart
 - 属性hasOption @1
 - 属性hasTitle @1
 - 属性hasNotFoundText @1
 - 属性isDeleted @1
- 步骤2：测试component为null、chart有名称、type为pivot
 - 属性hasOption @1
 - 属性hasTitle @1
 - 属性hasNotFoundText @1
 - 属性isDeleted @1
- 步骤3：测试component为空对象、chart为null、type为chart
 - 属性hasOption @1
 - 属性hasTitle @1
 - 属性hasNotFoundText @1
 - 属性isDeleted @1
- 步骤4：测试component为空对象、chart无名称、type为pivot
 - 属性hasOption @1
 - 属性hasTitle @1
 - 属性hasNotFoundText @1
 - 属性isDeleted @1
