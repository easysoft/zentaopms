...
r($screenTest->genNotFoundOrDraftComponentOptionTest((object)array('id' => 1, 'name' => 'test', 'option' => (object)array('title' => (object)array('text' => 'existing'))), (object)array('name' => '销售图表'), 'chart')) && p('notFoundText') && e('图表已存为草稿或删除'); // 步骤6：完整component结构，chart类型，测试notFoundText内容
r($screenTest->genNotFoundOrDraftComponentOptionTest((object)array('id' => 2, 'option' => (object)array('dataset' => array())), (object)array('name' => '数据透视'), 'pivot')) && p('notFoundText') && e('透视表已存为草稿或删除'); // 步骤7：完整component结构，pivot类型，测试notFoundText内容
