            ...
            <td <?php echo zget($visibleFields, 'story', "class='hidden'");?> style='overflow: visible'>
              <div class='input-group'>
                ...
                <span class='input-group-btn'>
                  <a id='preview<?php echo $i;?>' href='#' class='btn iframe btn-link btn-icon btn-copy' data-width='80%' disabled='disabled' title='<?php echo $lang->preview; ?>'><i class='icon-eye'></i></a>
