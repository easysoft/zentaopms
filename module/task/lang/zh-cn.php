...
$lang->task->case                = '相关用例';
$lang->task->confirmStoryChange  = "确认{$lang->productSRCommon}变动";
$lang->task->storyChange         = "{$lang->productSRCommon}变更";
...
$lang->task->execution        = '所属' . $lang->executionCommon;
$lang->task->module           = '所属模块';
$lang->task->moduleAB         = '模块';
$lang->task->story            = "相关{$lang->productSRCommon}";
$lang->task->storyAB          = $lang->productSRCommon;
$lang->task->storySpec        = "{$lang->productSRCommon}描述";
$lang->task->storyVerify      = '验收标准';
$lang->task->storyVersion     = "{$lang->productSRCommon}版本";
...
$lang->task->lblPri           = 'P';
$lang->task->lblHour          = '(h)';
$lang->task->lblTestStory     = "测试{$lang->productSRCommon}";

$lang->task->ditto             = '同上';
$lang->task->dittoNotice       = "该任务与上一任务不属于同一%s！";
$lang->task->selectTestStory   = "选择测试{$lang->productSRCommon}";
$lang->task->selectAllUser     = '全部';
$lang->task->noStory           = "无{$lang->productSRCommon}";
...
$lang->task->afterChoices['continueAdding'] = "继续为该{$lang->productSRCommon}添加任务";
$lang->task->afterChoices['toTaskList']     = '返回任务列表';
$lang->task->afterChoices['toStoryList']    = "返回{$lang->productSRCommon}列表";
...
$lang->task->copyStoryTitle        = "同{$lang->productSRCommon}";
...
$lang->task->confirmChangeProject  = "修改{$lang->executionCommon}会导致相应的所属模块、相关{$lang->productSRCommon}和指派人发生变化，确定吗？";
...
$lang->task->noticeLinkStory       = "没有可关联的相关{$lang->productSRCommon}，您可以为当前项目%s，然后%s";
