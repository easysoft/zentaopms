...
$lang->task->case                = '相關用例';
$lang->task->confirmStoryChange  = "確認{$lang->productSRCommon}變動";
$lang->task->storyChange         = "{$lang->productSRCommon}變更";
...
$lang->task->story            = "相關{$lang->productSRCommon}";
...
$lang->task->afterChoices['continueAdding'] = "繼續為該{$lang->productSRCommon}添加任務";
...
$lang->task->confirmChangeProject  = "修改{$lang->executionCommon}會導致相應的所屬模組、相關{$lang->productSRCommon}和指派人發生變化，確定嗎？";
...
$lang->task->noticeLinkStory       = "沒有可關聯的相關{$lang->productSRCommon}，您可以為當前項目%s，然後%s";
