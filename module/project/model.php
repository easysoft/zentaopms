...
class projectModel extends model
{
    ...
    public function setMenu($projects, $projectID, $buildID = 0, $extra = '')
    {
        ...
        if($methodName == 'create') $label = $this->lang->project->create;

        $projectIndex  = '<div class="btn-group angle-btn' . (strpos('index|all|create', $methodName) !== false ? ' active' : '') . '"><div class="btn-group"><button data-toggle="dropdown" type="button" class="btn">' . $label . ' <span class="caret"></span></button>';
    ...
    public function select($projects, $projectID, $buildID, $currentModule, $currentMethod, $extra = '')
    {
        ...
        $output  = "<div class='btn-group angle-btn'><div class='btn-group'><button data-toggle='dropdown' type='button' class='btn btn-limit' id='currentItem' title='{$currentProjectName}'><span class='text'>{$currentProjectName}</span> <span class='caret'></span></button><div id='dropMenu' class='dropdown-menu search-list' data-ride='searchList' data-url='$dropMenuLink'>";
