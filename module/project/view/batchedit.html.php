...
<table class='table table-form table-fixed'>
  <thead>
    <tr class='text-center'>
      ...
      <th class='w-150px<?php echo zget($hasFields, 'PM',     ' hidden')?>'><?php echo $lang->project->PM;?></th>
      <th class='w-150px<?php echo zget($hasFields, 'PO',     ' hidden')?>'><?php echo $lang->project->PO;?></th>
      <th class='w-150px<?php echo zget($hasFields, 'QD',     ' hidden')?>'><?php echo $lang->project->QD;?></th>
      <th class='w-150px<?php echo zget($hasFields, 'RD',     ' hidden')?>'><?php echo $lang->project->RD;?></th>
      <th class='w-100px<?php echo zget($hasFields, 'type',   ' hidden')?>'><?php echo $lang->project->type;?></th>
  ...
  <tr class='text-center'>
    ...
    <td class='text-left<?php echo zget($hasFields, 'PM', ' hidden')?>' style='overflow:visible'><?php echo html::select("PMs[$projectID]", $pmUsers, $projects[$projectID]->PM, "class='form-control chosen'");?></td>
    <td class='text-left<?php echo zget($hasFields, 'PO', ' hidden')?>' style='overflow:visible'><?php echo html::select("POs[$projectID]", $poUsers, $projects[$projectID]->PO, "class='form-control chosen'");?></td>
    <td class='text-left<?php echo zget($hasFields, 'QD', ' hidden')?>' style='overflow:visible'><?php echo html::select("QDs[$projectID]", $qdUsers, $projects[$projectID]->QD, "class='form-control chosen'");?></td>
    <td class='text-left<?php echo zget($hasFields, 'RD', ' hidden')?>' style='overflow:visible'><?php echo html::select("RDs[$projectID]", $rdUsers, $projects[$projectID]->RD, "class='form-control chosen'");?></td>
    <td class='<?php echo zget($hasFields, 'type',   'hidden')?>'><?php echo html::select("types[$projectID]",    $lang->project->typeList,   $projects[$projectID]->type,   'class=form-control');?></td>
