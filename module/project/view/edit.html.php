  ...
  <div class='center-block'>
    ...
    <form class='load-indicator main-form' method='post' target='hiddenwin' id='dataform'>
      <table class='table table-form'>
            ...
            <div class='row'>
              ...
              <div class='col-sm-4'>
                <div class='input-group'>
                  ...
                  <?php if($product->type != 'normal' and isset($branchGroups[$product->id])) echo html::select("branch[$i]", $branchGroups[$product->id], $product->branch, "class='form-control chosen'")?>
                </div>
              </div>
              <?php $i++;?>
              <?php endforeach;?>
        ...
        <tr <?php if($this->config->global->flow == 'onlyTask') echo "class='hidden'";?>>
          ...
          <td class='text-left' id="plansBox" colspan="2">
            ...
            <?php foreach($plans as $productID => $plan):?>
              <div class="col-sm-4" id="plan<?php echo $productID;?>">
        ...
        <tr><td colspan='3' class='text-center'><?php echo html::submitButton('', '', 'btn btn-wide btn-primary') . html::backButton('', '', 'btn btn-wide btn-gray');?></td></tr>
      </table>
    </form>
  </div>
</div>
