...
$lang->project->taskSummaryAll = "共『%s』个任务，未开始『%s』个，进行中『%s』个，已完成『%s』个，已关闭『%s』个，总共预计『%s』工时，一共消耗『%s』工时，还剩余『%s』工时。";
$lang->project->taskSummaryPart= "共『%s』个任务，总共预计『%s』工时，一共消耗『%s』工时，还剩余『%s』工时。";
