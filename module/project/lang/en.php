...
$lang->project->groupSummaryAB  = "Total Tasks<strong>%s</strong>, Wait <strong>%s</strong>, Doing <strong>%s</strong>.<br /> Total estimated <strong>%s</strong> man-hour, Cosumed <strong>%s</strong> man-hour，Remained <strong>%s</strong> man-hour.";
