...
$lang->project->beginLessThanParent  = "父項目的開始日期：%s，開始日期不能小於父項目的開始日期";
$lang->project->endGreatThanParent   = "父項目的完成日期：%s，完成日期不能大於父項目的完成日期";
$lang->project->beginGreatEqualChild = "項目集的最小開始日期：%s，項目的開始日期不能小於項目集的最小開始日期";
$lang->project->endLessThanChild     = "項目集的最大完成日期：%s，項目的完成日期不能大於項目集的最大完成日期";
