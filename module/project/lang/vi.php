...
$lang->project->PO            = "Sở hữu {$lang->executionCommon}";
$lang->project->PM            = "Quản lý {$lang->executionCommon}";
...
$lang->project->order         = "Đánh giá {$lang->executionCommon}";
...
$lang->project->all           = "Tất cả {$lang->executionCommon}";
...
$lang->project->readjustTime  = "Điều chỉnh {$lang->executionCommon} Thời gian";
...
$lang->project->view              = "Chi tiết {$lang->executionCommon}";
$lang->project->startAction       = "Bắt đầu {$lang->executionCommon}";
$lang->project->activateAction    = "Kích hoạt {$lang->executionCommon}";
$lang->project->delayAction       = "Tạm ngưng {$lang->executionCommon}";
$lang->project->suspendAction     = "Đình chỉ {$lang->executionCommon}";
$lang->project->closeAction       = "Đóng {$lang->executionCommon}";
$lang->project->testtaskAction    = "Yêu cầu {$lang->executionCommon}";
$lang->project->teamAction        = "Thành viên {$lang->executionCommon}";
$lang->project->kanbanAction      = "Kanban {$lang->executionCommon}";
$lang->project->printKanbanAction = "In Kanban";
$lang->project->treeAction        = "Xem cây {$lang->executionCommon}";
$lang->project->exportAction      = "Xuất {$lang->executionCommon}";
$lang->project->computeBurnAction = "Tính Burndown";
$lang->project->create            = "Tạo {$lang->executionCommon}";
...
$lang->project->updateOrder       = "Đánh giá {$lang->executionCommon}";
...
$lang->project->allProject      = "Tất cả {$lang->executionCommon}";
$lang->project->aboveAllProduct = "Tất cả {$lang->productCommon} trên";
$lang->project->aboveAllProject = "Tất cả {$lang->executionCommon} trên";

/* Page prompt. */
$lang->project->linkStoryByPlanTips = "Hành động này sẽ liên kết tất cả câu chuyện trong kế hoạch này tới {$lang->executionCommon} này.";
$lang->project->selectProject       = "Chọn {$lang->executionCommon}";
...
$lang->project->whyNoStories        = "Không có câu chuyện có thể liên kết. Vui lòng kiểm tra có câu chuyện trong {$lang->executionCommon} cái liên kết tới {$lang->productCommon} và chắc chắn nó đã được duyệt.";
$lang->project->productStories      = "Câu chuyện liên kết tới {$lang->executionCommon} là tập hợp con của câu chuyện liên kết tới {$lang->productCommon}. Các câu chuyện chỉ có thể liên kết sau khi chúng đã được duyệt. <a href='%s'> Liên kết câu chuyện</a> now.";
...
$lang->project->copyFromTeam        = "Sao chép từ {$lang->executionCommon} Đội nhóm: <strong>%s</strong>";
$lang->project->noMatched           = "Không có $lang->executionCommon bao gồm '%s' có thể được tìm thấy.";
$lang->project->copyTitle           = "Chọn một {$lang->executionCommon} để sao chép.";
$lang->project->copyTeamTitle       = "Chọn một {$lang->executionCommon} đội nhóm để sao chép.";
$lang->project->copyNoProject       = "Không có {$lang->executionCommon} có thể sao chép.";
$lang->project->copyFromProject     = "Sao chép từ {$lang->executionCommon} <strong>%s</strong>";
$lang->project->cancelCopy          = 'Hủy sao chép';
$lang->project->byPeriod            = 'Theo thời gian';
$lang->project->byUser              = 'Theo người dùng';
$lang->project->noProject           = "Không có {$lang->executionCommon} nào";
...
$lang->project->placeholder->code      = "Viết tắt của tên {$lang->executionCommon}";
$lang->project->placeholder->totalLeft = "Giờ dự kiến trong ngày đầu của {$lang->executionCommon}.";
