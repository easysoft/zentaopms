...
class projectTaoTest extends baseTest
{
    ...
    public function doStartTest($projectID = 0, $project = null)
    {
        ...
        $result = $method->invoke($this->instance, $projectID, $project);
        if(dao::isError()) return dao::getError();
    ...
    public function insertMemberTest($members = array(), $projectID = 0, $oldJoin = array())
    {
        ...
        $result = $method->invoke($this->instance, $members, $projectID, $oldJoin);
        if(dao::isError()) return dao::getError();
    ...
    public function unlinkTeamMemberTest($projectIdList = 0, $type = '', $account = '', $realname = '', $changes = array())
    {
        try
        {
            ...
            $result = $method->invoke($this->instance, $projectIdList, $type, $account, $realname, $changes);
    ...
    public function setNavGroupMenuTest($navGroup = '', $executionID = 0, $project = null)
    {
        ...
        try
        {
            ...
            $result = $method->invoke($this->instance, $navGroup, $executionID, $project);
            ob_end_clean();
