...
r(count($projectTester->testFetchProjectListByQuery('', 11)))    && p() && e('9'); // 根据项目ID获取项目
r(count($projectTester->testFetchProjectListByQuery('', 10000))) && p() && e('9'); // 获取不存在的项目

r(count($projectTester->testFetchProjectListByQuery('doing', 11))) && p() && e('3'); // 根据 不匹配的项目ID和状态 获取项目数量
r(count($projectTester->testFetchProjectListByQuery('doing', 12))) && p() && e('2'); // 根据 匹配的项目ID和状态 获取项目数量
