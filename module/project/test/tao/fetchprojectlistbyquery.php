...
- 根据项目ID获取项目 @9
- 获取不存在的项目 @9
- 根据 不匹配的项目ID和状态 获取项目数量 @3
- 根据 匹配的项目ID和状态 获取项目数量 @2
...
r(count($projectModel->fetchProjectListByQuery('wait')))   && p() && e('3'); // 获取未开始的项目数量
r(count($projectModel->fetchProjectListByQuery('undone'))) && p() && e('7'); // 获取状态不为done和closed的项目数量

r(count($projectModel->fetchProjectListByQuery('', 11)))    && p() && e('9'); // 根据项目ID获取项目
r(count($projectModel->fetchProjectListByQuery('', 10000))) && p() && e('9'); // 获取不存在的项目

r(count($projectModel->fetchProjectListByQuery('doing', 11))) && p() && e('3'); // 根据 不匹配的项目ID和状态 获取项目数量
r(count($projectModel->fetchProjectListByQuery('doing', 12))) && p() && e('2'); // 根据 匹配的项目ID和状态 获取项目数量

r(current($projectModel->fetchProjectListByQuery('all', 0, 'id_asc')))    && p('id,name') && e('11,项目11'); // 按照ID正序获取项目列表,查看排第一个的项目详情
r(current($projectModel->fetchProjectListByQuery('all', 0, 'name_desc'))) && p('id,name') && e('19,项目19'); // 按照项目名称倒序获取项目列表,查看排第一个的项目详情
