...
- 执行project模块的doClosed方法，参数是1, $project, $oldProject1属性 @1

- 执行project模块的doClosed方法，参数是2, $project, $oldProject2属性 @1

- 执行project模块的doClosed方法，参数是3, $project, $oldProject3属性 @1
