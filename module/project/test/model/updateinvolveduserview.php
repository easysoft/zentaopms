...
r($beforeUserView) && p('account|products|projects|sprints', '|') && e('user1|2|~~|~~'); // 测试用户user1在产品、项目、执行中没有权限
r($afterUserView)  && p('account|products|projects|sprints', '|') && e('user1|1|1,2|3');    // 测试用户user1在产品id为1、项目id为1、执行id为3中有权限
