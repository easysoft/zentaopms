...
$plan = array();
$plan[3] = array(1, 4, 7);
r(count($project->addPlansTest(13, $plan))) && p('') && e('8'); // 将计划1，4，7下的需求关联到项目13，查看关联后的需求数
r($project->addPlansTest(13, $plan)) && p('3:story,product') && e('8,2'); // 将计划1，4，7下的需求关联到项目13，查看关联后的需求ID/产品ID

$plan = array();
$plan[1] = array(2, 5, 10, 13);
r(count($project->addPlansTest(11, $plan))) && p('') && e('4'); // 将计划2，5，10，13下的需求关联到项目11，查看关联后的需求数
