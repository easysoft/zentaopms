...
$config->project->search['fields']['story']          = $lang->task->story;
...
$config->project->search['params']['story']         = array('operator' => 'include', 'control' => 'input',  'values' => '');
...
$config->project->search['params']['mailto']        = array('operator' => '=',       'control' => 'select', 'values' => 'users');
$config->project->search['params']['status']        = array('operator' => '=',       'control' => 'select', 'values' => $lang->task->statusList);
$config->project->search['params']['sclosedReason'] = array('operator' => '=',       'control' => 'select', 'values' => $lang->task->reasonList);
