...
$config->project->noSprintPriv['execution']   = array('task', 'grouptask', 'importplanstories', 'importBug', 'story', 'burn', 'computeBurn', 'fixFirst', 'burnData', 'linkStory', 'unlinkStory', 'batchUnlinkStory', 'updateOrder', 'taskKanban', 'printKanban', 'tree', 'treeTask', 'treeStory', 'storyKanban', 'storySort', 'storyEstimate', 'setKanban', 'storyView', 'calendar', 'effortCalendar', 'effort', 'taskEffort', 'computeTaskEffort', 'deleterelation', 'createrelation', 'editrelation', 'batcheditrelation', 'batchdeleterelation', 'relation', 'gantt', 'ganttsetting', 'ganttEdit', 'view', 'dynamic', 'create', 'edit', 'manageProducts', 'activate', 'putoff', 'suspend', 'execution2export', 'doc', 'importtask', 'team', 'manageMembers', 'unlinkMember', 'executionkanban', 'kanban', 'cfd', 'computeCFD');
