...
$config->project->search['fields']['model']          = $lang->project->manageType;
$config->project->search['fields']['parent']         = $lang->project->parent;
$config->project->search['fields']['status']         = $lang->project->projectStatus;
...
$config->project->search['fields']['realBeginAB']    = $lang->project->realBeginAB;
$config->project->search['fields']['realEndAB']      = $lang->project->realEndAB;
...
$config->project->search['params']['realBeginAB']    = array('operator' => '='      , 'control' => 'input' , 'values' => '', 'class' => 'date');
$config->project->search['params']['realEndAB']      = array('operator' => '='      , 'control' => 'input' , 'values' => '', 'class' => 'date');
