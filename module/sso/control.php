...
class sso extends control
{
    ...
    public function feishuLogin($code = '')
    {
        ...
        $appResult = $this->sso->http($appUrl, $appParams, 'POST', 'json');
        ...
        $tokenResult  = $this->sso->http($tokenUrl, $tokenParams, 'POST', 'json', array(), $tokenHeaders);
        ...
        $userResult  = $this->sso->http($userUrl, array(), 'GET', 'json', array(), $userHeaders);
