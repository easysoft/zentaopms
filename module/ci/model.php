...
class ciModel extends model
{
    ...
    public function setMenu($repoID = 0)
    {
        ...
        $homeMenuMethod = array('gitlab-browse', 'gitlab-create', 'gitlab-edit', 'gogs-browse', 'gogs-create', 'gogs-edit', 'gitea-browse', 'gitea-create', 'gitea-edit', 'jenkins-browse', 'jenkins-create', 'jenkins-edit', 'sonarqube-browse', 'sonarqube-create', 'sonarqube-edit');
