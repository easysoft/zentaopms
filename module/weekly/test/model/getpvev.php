...
- 测试projectID值为0，date值为空 @65.58,60.68

- 测试projectID值为11，date值为2022-05-01 @12.00,34.67

- 测试projectID值为11，date值为空 @46.06,34.67
...
r($weekly->getPVEVTest($projectIDList[0], $dateList[1])) && p() && e('65.58,60.68'); //测试projectID值为0，date值为空
r($weekly->getPVEVTest($projectIDList[1], $dateList[0])) && p() && e('12.00,34.67'); //测试projectID值为11，date值为2022-05-01
r($weekly->getPVEVTest($projectIDList[1], $dateList[1])) && p() && e('46.06,34.67'); //测试projectID值为11，date值为空
