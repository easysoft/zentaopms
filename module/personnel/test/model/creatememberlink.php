...
- 测试获取项目集 2 部门 1 的访问链接 @1
- 测试获取项目集 2 部门 2 的访问链接 @1
- 测试获取项目集 3 部门 1 的访问链接 @1

*/

$personnel = new personnelTest();

$programID = array(1, 2, 3);
$deptID    = array(1, 2);
...
r($personnel->createMemberLinkTest($programID[2], $deptID[0])) && p() && e('1'); // 测试获取项目集 3 部门 1 的访问链接
