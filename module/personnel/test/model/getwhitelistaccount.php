...
- 测试获取 项目   1 的白名单人员 @user10,user30

- 测试获取 产品   1 的白名单人员 @0
- 测试获取 执行   1 的白名单人员 @0
- 测试获取 项目集 2 的白名单人员 @0
- 测试获取 项目   2 的白名单人员 @0
- 测试获取 产品   2 的白名单人员 @user1,user21,user41

- 测试获取 执行   2 的白名单人员 @user11,user31

- 测试获取 项目集 3 的白名单人员 @user12,user32

- 测试获取 项目   3 的白名单人员 @user2,user22,user42

- 测试获取 产品   3 的白名单人员 @0
- 测试获取 执行   3 的白名单人员 @0
- 测试获取 项目集 4 的白名单人员 @0
- 测试获取 项目   4 的白名单人员 @0
- 测试获取 产品   4 的白名单人员 @user13,user33

- 测试获取 执行   4 的白名单人员 @user3,user23,user43
