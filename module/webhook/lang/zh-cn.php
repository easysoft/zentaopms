...
$lang->webhook->execution   = "关联{$lang->executionCommon}";
...
$lang->webhook->paramsList['execution']  = "所属{$lang->executionCommon}";
...
$lang->webhook->note->execution = "此项为空时所有{$lang->executionCommon}的动作都会触发钩子，否则只有关联{$lang->executionCommon}的动作才会触发。";
