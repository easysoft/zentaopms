...
$lang->webhook->paramsList['execution']  = "{$lang->executionCommon}";
...
$lang->webhook->note->execution = "Alle Aktionen triggern den Hook wenn das {$lang->executionCommon} leer ist, andernsfalls werden nur Aktionen des {$lang->executionCommon} ausgelöst.";
