...
$lang->webhook->project     = "{$lang->executionCommon}";
...
$lang->webhook->paramsList['project']    = "{$lang->executionCommon}";
...
$lang->webhook->note->project = "Alle Aktionen triggern den Hook wenn das {$lang->executionCommon} leer ist, andernsfalls werden nur Aktionen des {$lang->executionCommon} ausgelöst.";
