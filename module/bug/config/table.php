...
$config->bug->dtable->fieldList['toTaskName']['name']  = 'toTaskName';
$config->bug->dtable->fieldList['toTaskName']['title'] = $lang->bug->toTask;
$config->bug->dtable->fieldList['toTaskName']['type']  = 'text';
$config->bug->dtable->fieldList['toTaskName']['link']  = helper::createLink('task', 'view', 'taskID={toTask}');
$config->bug->dtable->fieldList['toTaskName']['group'] = '6';

$config->bug->dtable->fieldList['resolvedDate']['name']  = 'resolvedDate';
...
$config->bug->dtable->fieldList['storyName']['name']  = 'storyName';
$config->bug->dtable->fieldList['storyName']['title'] = $lang->bug->story;
$config->bug->dtable->fieldList['storyName']['type']  = 'text';
$config->bug->dtable->fieldList['storyName']['link']  = helper::createLink('story', 'view', 'storyID={story}');
$config->bug->dtable->fieldList['storyName']['group'] = '8';

$config->bug->dtable->fieldList['taskName']['name']  = 'taskName';
$config->bug->dtable->fieldList['taskName']['title'] = $lang->bug->task;
$config->bug->dtable->fieldList['taskName']['type']  = 'text';
$config->bug->dtable->fieldList['taskName']['link']  = helper::createLink('task', 'view', 'taskID={task}');
