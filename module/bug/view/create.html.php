            ...
            <td>
              <div class='table-row'>
                <div class='table-col' id='osBox'>
                  <?php echo html::select('os[]', $osList, $os, "class='form-control chosen' multiple");?>
                </div>
              </div>
            </td>
            <?php else:?>
            ...
            <td>
              <div class='table-row'>
                <div class='input-group' id='browserBox'>
                  ...
                  <?php echo html::select('browser[]', $browserList, $browser, "class='form-control chosen' multiple");?>
                </div>
              </div>
            </td>
            <?php endif;?>
