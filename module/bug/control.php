...
class bug extends control
{
    ...
    public function create(int $productID, string $branch = '', string $extras = '')
    {
        ...
        $this->view->loadUrl = $this->createLink('bug', 'create', "productID={product}&branch={branch}&extras=moduleID={module},projectID={project},executionID={execution},allBuilds={allBuilds}" . (empty($from) ? '' : "&from=$from"));
