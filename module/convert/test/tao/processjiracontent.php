...
- 执行convertTest模块的processJiraContentTest方法，参数是'No image markers here', $fileList1  @No image markers here
...
r($convertTest->processJiraContentTest('No image markers here', $fileList1)) && p() && e('No image markers here');
