...
- 执行convertTest模块的createProjectTest方法，参数是$data4, array
 - 属性PM @
 - 属性openedBy @
- 执行convertTest模块的createProjectTest方法，参数是$data5, array 属性storyType @story,epic,requirement
...
$data4->pname = '空用户项目';
$data4->pkey = 'NOUSER';
$data4->description = '无lead用户';
$data4->status = 'wait';
$data4->lead = '';
$data4->created = '2024-04-01 16:00:00';
$data4->id = 4;
r($convertTest->createProjectTest($data4, array())) && p('PM,openedBy') && e(',');
