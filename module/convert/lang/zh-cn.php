...
$lang->convert->jira->buildinFields['reporter']             = array('name'=> '报告人',   'jiraField' => 'REPORTER',             'control' => 'input',        'optionType' => 'user',   'type' => 'varchar',    'length' => '255');
$lang->convert->jira->buildinFields['environment']          = array('name'=> '环境信息', 'jiraField' => 'ENVIRONMENT',          'control' => 'multi-select', 'optionType' => 'custom', 'type' => 'text',       'length' => '0');
$lang->convert->jira->buildinFields['duedate']              = array('name'=> '截止日期', 'jiraField' => 'DUEDATE',              'control' => 'date',         'optionType' => 'custom', 'type' => 'date',       'length' => '0');
...
$lang->convert->jira->buildinFields['fixfor']               = array('name'=> '修复版本', 'jiraField' => 'FIXFOR',               'control' => 'integer',      'optionType' => 'custom', 'type' => 'int',        'length' => '6');
