...
$lang->convert->jira->buildinFields['summary']    = array('name'=> 'Summary',    'jiraField' => 'SUMMARY',     'control' => 'input',    'type' => 'varchar',    'length' => '255');
$lang->convert->jira->buildinFields['pri']        = array('name'=> 'Pri',        'jiraField' => 'PRIORITY',    'control' => 'select',   'type' => 'int',        'length' => '3');
$lang->convert->jira->buildinFields['resolution'] = array('name'=> 'Resolution', 'jiraField' => 'RESOLUTION',  'control' => 'select',   'type' => 'varchar',    'length' => '255');
$lang->convert->jira->buildinFields['desc']       = array('name'=> 'Desc',       'jiraField' => 'DESCRIPTION', 'control' => 'richtext', 'type' => 'mediumtext', 'length' => '0');
