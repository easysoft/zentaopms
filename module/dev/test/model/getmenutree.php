...
r($tester->dev->getMenuTree($typeList[2], $moduleList[1], $methodList[0])) && p('0:module,active') && e('my,1');    // 获取二级导航树，并高亮地盘
r($tester->dev->getMenuTree($typeList[2], $moduleList[1], $methodList[1])) && p('0:module')        && e('my');      // 获取二级导航树，并高亮地盘
r($tester->dev->getMenuTree($typeList[2], $moduleList[2], $methodList[0])) && p('3:module')        && e('project'); // 获取二级导航树，并高亮敏捷项目
r($tester->dev->getMenuTree($typeList[3], $moduleList[1], $methodList[1])) && p('0:module')        && e('my');      // 获取三级导航树，并高亮地盘
