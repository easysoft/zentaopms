...
$config->dev->postParams['task']['edit']['project']      = 'int';
$config->dev->postParams['task']['edit']['type']         = 'string';
$config->dev->postParams['task']['edit']['name']         = 'string';
$config->dev->postParams['task']['edit']['module']       = 'int';
$config->dev->postParams['task']['edit']['assignedTo']   = 'string';
$config->dev->postParams['task']['edit']['story']        = 'int';
$config->dev->postParams['task']['edit']['pri']          = 'int';
$config->dev->postParams['task']['edit']['color']        = 'string';
$config->dev->postParams['task']['edit']['desc']         = 'string';
$config->dev->postParams['task']['edit']['mailto']       = 'string';
$config->dev->postParams['task']['edit']['status']       = 'string';
$config->dev->postParams['task']['edit']['estStarted']   = 'date';
$config->dev->postParams['task']['edit']['realStarted']  = 'date';
$config->dev->postParams['task']['edit']['deadline']     = 'date';
$config->dev->postParams['task']['edit']['estimate']     = 'date';
$config->dev->postParams['task']['edit']['left']         = 'date';
$config->dev->postParams['task']['edit']['finishedBy']   = 'string';
$config->dev->postParams['task']['edit']['finishedDate'] = 'date';
$config->dev->postParams['task']['edit']['canceledBy']   = 'string';
$config->dev->postParams['task']['edit']['canceledDate'] = 'date';
$config->dev->postParams['task']['edit']['closedBy']     = 'string';
$config->dev->postParams['task']['edit']['closedDate']   = 'date';
$config->dev->postParams['task']['edit']['closedReason'] = 'string';
