      ...
      <tr>
        ...
        <td colspan='2'>
            <div>
                ...
                <?php echo html::input('colWidth', $kanban->colWidth, "class='form-control inline-block setting-input' required placeholder='264' autocomplete='off'");?>px
            </div>
            <div style="margin-top: 10px;">
                <?php echo html::radio('fluidBoard', array(1 => $lang->kanbancolumn->fluidBoardList['1']), $kanban->fluidBoard);?>
                <?php echo html::input('minColWidth', $kanban->minColWidth, "class='form-control inline-block setting-input' required placeholder='180' autocomplete='off'");?>px
                <span class="input-divider">~</span>
                <?php echo html::input('maxColWidth', $kanban->maxColWidth, "class='form-control inline-block setting-input' required placeholder='384' autocomplete='off'");?>px
            </div>
        </td>
      </tr>
      <?php if($laneCount > 1):?>
