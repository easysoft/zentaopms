...
r($kanban->createKanbanTest($kanban3)) && p('name,space,owner,whitelist') && e('测试创建公共看板,3,po17,~~');     // 创建公共空间
r($kanban->createKanbanTest($kanban4)) && p('name:0')                     && e('『看板名称』不能为空。');         // 创建没有名字的公共空间
r($kanban->createKanbanTest($kanban5)) && p('space:0')                    && e('『所属空间』不能为空。');         // 创建没有空间公共空间
r($kanban->createKanbanTest($kanban6)) && p('name:0')                     && e('『看板名称』已经有『测试创建公共看板』这条记录了。如果您确定该记录已删除，请到后台-系统设置-回收站还原。'); // 创建重名公共空间