...
r($tester->editLaneName($kanbanurl, ''))                 && p('message,status') && e('泳道名称必填提示信息正确,SUCCESS');//泳道名称必填校验
r($tester->editLaneName($kanbanurl, '泳道名称编辑测试')) && p('message,status') && e('泳道名称修改成功,SUCCESS');//修改泳道名称
