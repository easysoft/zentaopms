...
- 获取执行1 story pri的泳道 @,2,4,优先级: 无
- 获取执行1 story category的泳道 @,功能
- 获取执行1 story module的泳道 @,所属模块: 无
- 获取执行1 story source的泳道 @,用户,市场,来源: 无
...
r($kanban->getLanes4GroupTest($executionIDList[0], $browseTypeList[0], $groupByList[0])) && p('', '|') && e(',2,4,优先级: 无');     // 获取执行1 story pri的泳道
...
r($kanban->getLanes4GroupTest($executionIDList[0], $browseTypeList[0], $groupByList[3])) && p('', '|') && e(',用户,市场,来源: 无'); // 获取执行1 story source的泳道
