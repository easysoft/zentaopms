...
r(count($tester->kanban->getKanbanData(1), true)) && p() && e('507'); // 测试获取到的kanban下的数据数量
r(count($tester->kanban->getKanbanData(2), true)) && p() && e('507'); // 测试获取到的kanban下的数据数量
r(count($tester->kanban->getKanbanData(3), true)) && p() && e('507'); // 测试获取到的kanban下的数据数量
r(count($tester->kanban->getKanbanData(4), true)) && p() && e('507'); // 测试获取到的kanban下的数据数量
r(count($tester->kanban->getKanbanData(5), true)) && p() && e('507'); // 测试获取到的kanban下的数据数量