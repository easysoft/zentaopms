...
r($kanban->updateSpaceTest($spaceIDList[0], $param1)) && p('name|owner|whitelist|team', '|') && e('测试修改名称1|user3|,user3,po15,|,user3,po15,');      // 测试修改空间1
r($kanban->updateSpaceTest($spaceIDList[1], $param2)) && p('name|owner|whitelist|team', '|') && e('测试修改名称2|po16|,user4,po16,user3,|,user4,po16,'); // 测试修改空间2
...
r($kanban->updateSpaceTest($spaceIDList[3], $param4)) && p('name|owner|whitelist|team', '|') && e('测试修改名称4|po18|,user6,po18,|,user6,po18,');       // 测试修改空间4
