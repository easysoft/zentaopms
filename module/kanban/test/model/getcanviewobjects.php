...
- 测试查询admin有权限查看的未关闭看板个数 @32
- 测试查询admin有权限查看的私人看板个数 @32
- 测试查询admin有权限查看的协同看板个数 @32
- 测试查询admin有权限查看的公共看板个数 @32
...
r($kanban->getCanViewObjectsTest($userList[0], $objectType[0], $paramList[0])) && p() && e('32'); // 测试查询admin有权限查看的未关闭看板个数
r($kanban->getCanViewObjectsTest($userList[0], $objectType[0], $paramList[1])) && p() && e('32');  // 测试查询admin有权限查看的私人看板个数
r($kanban->getCanViewObjectsTest($userList[0], $objectType[0], $paramList[2])) && p() && e('32'); // 测试查询admin有权限查看的协同看板个数
r($kanban->getCanViewObjectsTest($userList[0], $objectType[0], $paramList[3])) && p() && e('32'); // 测试查询admin有权限查看的公共看板个数
