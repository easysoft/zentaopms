...
r($kanban->getSpacePairsTest($userList[1], $browseType[1])) && p() && e('34'); // 查询用户可以看到的po16 cooperation的空间数量
...
r($kanban->getSpacePairsTest($userList[2], $browseType[1])) && p() && e('34'); // 查询用户可以看到的test37 cooperation的空间数量
...
r($kanban->getSpacePairsTest($userList[3], $browseType[1])) && p() && e('34'); // 查询用户可以看到的user25 cooperation的空间数量
