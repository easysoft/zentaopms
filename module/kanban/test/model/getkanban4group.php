...
r($kanban->getKanban4GroupTest($executionIDList[0], $browseTypeList[0], $groupByList[0])[0]['data']['lanes']) && p('0:id,title') && e('pri2,优先级:2');           // 查看执行1按需求的优先级分组的泳道
...
r($kanban->getKanban4GroupTest($executionIDList[0], $browseTypeList[0], $groupByList[3])[0]['data']['lanes']) && p('0:id,title') && e('sourceuser,用户');         // 查看执行1按需求的来源分组的泳道
