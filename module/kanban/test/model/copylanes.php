...
$copyLane1  = (object)array('id' => 1, 'title' => '复制泳道1');
$copyLane2  = (object)array('id' => 2, 'title' => '复制泳道2');
$copyLane3  = (object)array('id' => 3, 'title' => '复制泳道3');
$copyLane4  = (object)array('id' => 4, 'title' => '复制泳道4');
$emptyLane  = (object)array('id' => 5, 'title' => '');

r($tester->kanban->copyLanes($kanban, [$copyLane1, $copyLane2, $copyLane3, $copyLane4], $regionID, $newGroupID)) && p("1,2,3,4") && e('2,3,4,5'); // 正常复制泳道，查看生成的泳道ID数量
