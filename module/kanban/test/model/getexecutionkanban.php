...
r($kanban->getExecutionKanbanTest($executionIDList[0]))                                      && p() && e('columns:2, lanes:2, cards:1');   // 测试获取execution2的执行看板信息
...
r($kanban->getExecutionKanbanTest($executionIDList[0], $browseTypeList[1]))                  && p() && e('columns:1, lanes:1, cards:1');   // 测试获取execution2 task的执行看板信息
...
r($kanban->getExecutionKanbanTest($executionIDList[1]))                                      && p() && e('columns:2, lanes:2, cards:1');   // 测试获取execution3的执行看板信息
...
r($kanban->getExecutionKanbanTest($executionIDList[2]))                                      && p() && e('columns:2, lanes:2, cards:1');   // 测试获取execution4的执行看板信息
r($kanban->getExecutionKanbanTest($executionIDList[2], $browseTypeList[1], $groupByList[2])) && p() && e('columns:2, lanes:1, cards:2');   // 测试获取execution4 task module的执行看板信息
