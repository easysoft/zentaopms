...
- 测试获取execution2的执行看板信息 @columns:2, lanes:2, cards:18

- 测试获取execution2 story的执行看板信息 @columns:1, lanes:1, cards:0

- 测试获取execution2 task的执行看板信息 @columns:1, lanes:1, cards:18

- 测试获取execution2 bug的执行看板信息 @columns:10, lanes:1, cards:0

- 测试获取execution3的执行看板信息 @columns:2, lanes:2, cards:18

- 测试获取execution3 story pri的执行看板信息 @columns:0, lanes:1, cards:0

- 测试获取execution3 story category的执行看板信息 @columns:0, lanes:1, cards:0

- 测试获取execution4的执行看板信息 @columns:2, lanes:2, cards:18

- 测试获取execution4 task module的执行看板信息 @columns:2, lanes:1, cards:37
...
r($kanban->getExecutionKanbanTest($executionIDList[0]))                                      && p() && e('columns:2, lanes:2, cards:18');  // 测试获取execution2的执行看板信息
...
r($kanban->getExecutionKanbanTest($executionIDList[0], $browseTypeList[1]))                  && p() && e('columns:1, lanes:1, cards:18');  // 测试获取execution2 task的执行看板信息
...
r($kanban->getExecutionKanbanTest($executionIDList[1]))                                      && p() && e('columns:2, lanes:2, cards:18');  // 测试获取execution3的执行看板信息
...
r($kanban->getExecutionKanbanTest($executionIDList[2]))                                      && p() && e('columns:2, lanes:2, cards:18');  // 测试获取execution4的执行看板信息
r($kanban->getExecutionKanbanTest($executionIDList[2], $browseTypeList[1], $groupByList[2])) && p() && e('columns:2, lanes:1, cards:37');  // 测试获取execution4 task module的执行看板信息
