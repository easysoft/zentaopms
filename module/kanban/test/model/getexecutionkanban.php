...
- 测试获取execution2的执行看板信息 @columns:2, lanes:2, cards:65

- 测试获取execution2 story的执行看板信息 @columns:1, lanes:1, cards:0

- 测试获取execution2 task的执行看板信息 @columns:1, lanes:1, cards:65
...
r($kanban->getExecutionKanbanTest($executionIDList[0]))                                      && p() && e('columns:2, lanes:2, cards:65');  // 测试获取execution2的执行看板信息
...
r($kanban->getExecutionKanbanTest($executionIDList[0], $browseTypeList[1]))                  && p() && e('columns:1, lanes:1, cards:65');  // 测试获取execution2 task的执行看板信息
