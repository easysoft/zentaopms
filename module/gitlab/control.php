...
class gitlab extends control
{
    ...
    protected function checkToken()
    {
        ...
        if(empty($result) or !isset($result->version) or ((float)$result->version < (float)$this->gitlab->minCompatibleVersion)) return $this->send(array('result' => 'fail', 'message' => array('url' => array($this->lang->gitlab->notCompatible))));
    }
