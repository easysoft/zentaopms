...
class transferModelTest extends baseTest
{
    ...
    public function getSourceByModuleMethodTest(string $module, string $callModule, string $method, string|array $params = '', string|array $pairs = ''): array|string
    {
        ...
        return $this->instance->getSourceByModuleMethod($module, $callModule, $method, $params, $pairs);
    }
    ...
    {
        $result = $this->instance->getFiles($module, $rows);
    ...
    public function setListValueTest(string $module = '')
    {
        ...
        $fieldList = $this->instance->initFieldList($module, $fields);

        return $this->instance->setListValue($module, $fieldList);
    }
    ...
    public function getQueryDatasTest(string $module = '', string $checkedItem = '')
    {
        ...
        return $this->instance->getQueryDatas($module);
    }
    ...
    public function getRowsTest(string $module = '', string $checkedItem = '')
    {
        ...
        return $this->instance->getRows($module, $fieldList);
    }
    ...
    public function parseExcelDropdownValuesTest(string $module, array $rows = array())
    {
        ...
        $fields = $this->instance->getImportFields($module);
        return $this->instance->parseExcelDropdownValues($module, $rows, '', $fields);
    }
    ...
    public function initFieldListTest(string $module, bool $withKey = false)
    {
        ...
        $fields = $this->instance->getImportFields($module);
        return $this->instance->initFieldList($module, array_keys($fields), $withKey);
    }
    ...
    {
        $this->initConfig($module);
        return $this->instance->getImportFields($module);
    }
    ...
    public function getPageDatasTest(array $datas = array(), int $pagerID = 1)
    {
        try
        {
            $result = $this->instance->getPageDatas($datas, $pagerID);
    ...
    public function formatTest(string $module = '', string $filter = '')
    {
        ...
        try
        {
            ...
            $result = $method->invoke($this->instance, $module, $filter);
    ...
    public function checkTmpFileTest($param = null)
    {
        ...
        try
        {
            ...
            {
                $this->instance->maxImport = isset($_COOKIE['maxImport']) ? (int)$_COOKIE['maxImport'] : 5;
            }
            else
            {
                $this->instance->maxImport = isset($_COOKIE['maxImport']) ? (int)$_COOKIE['maxImport'] : 0;
            }
    ...
    public function processRows4FieldsTest(array $rows = array(), array $fields = array())
    {
        ...
        try
        {
            ...
            $method->setAccessible(true);
            $result = $method->invoke($this->instance, $rows, $fields);
    ...
    public function createTmpFileTest(array $objectDatas = array())
    {
        ...
        try
        {
            ...
            $method->setAccessible(true);
            $method->invoke($this->instance, $objectDatas);
