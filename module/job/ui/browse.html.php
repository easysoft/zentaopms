...
(
    ...
    set::cols($cols),
    set::data($tableData),
    set::sortLink(createLink('job', 'browse', "repoID={$repoID}&browseType={$browseType}&queryID={$queryID}&orderBy={name}_{sortType}&recTotal={$pager->recTotal}&recPerPage={$pager->recPerPage}&pageID={$pager->pageID}")),
    set::orderBy($orderBy),
