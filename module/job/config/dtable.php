...
$config->job->dtable->fieldList['name']['type']        = 'shortTitle';
...
$config->job->dtable->fieldList['repo']['type']     = 'text';
$config->job->dtable->fieldList['repo']['sortType'] = true;
$config->job->dtable->fieldList['repo']['checkbox'] = false;
$config->job->dtable->fieldList['repo']['fixed']    = false;
...
$config->job->dtable->fieldList['buildSpec']['width']    = '80';
...
$config->job->dtable->fieldList['triggerType']['width']    = '80';
