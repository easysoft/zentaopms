...
$lang->productplan->noLinkedProject      = "当前产品还未关联{$lang->projectCommon}，请进入产品的{$lang->projectCommon}列表关联或创建一个{$lang->projectCommon}";
$lang->productplan->enterProjectList     = "进入产品的{$lang->projectCommon}列表";
