...
$lang->productplan->storySummary       = "Total: <strong>%s</strong> {$lang->ERCommon}s, <strong>%s</strong> {$lang->URCommon}s, <strong>%s</strong> {$lang->SRCommon}s on this page. Estimates <strong>%s</strong> {$lang->hourCommon},  and Case Coverage: <strong>%s</strong>.";
...
$lang->productplan->createdBy    = 'Created By';
$lang->productplan->createdDate  = 'Created Date';
$lang->productplan->finishedDate = 'Finished Date';
$lang->productplan->closedDate   = 'Closed Date';
