...
$lang->productplan->noLinkedProject      = "The current product has not been linked with a {$lang->projectCommon}. Please enter the list of the product to link or create a {$lang->projectCommon}.";
