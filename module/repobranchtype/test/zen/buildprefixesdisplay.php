...
r(strpos($result1[0]->prefixesDisplay, 'label') !== false) && p() && e('~~');
...
r($result2[0]->prefixesDisplay === '') && p() && e('~~');
...
r(strpos($result3[0]->prefixesDisplay, 'main/') !== false) && p() && e('~~');
...
r(strpos($result4[0]->prefixesDisplay, 'dev/') !== false && strpos($result4[0]->prefixesDisplay, 'develop/') !== false) && p() && e('~~');
