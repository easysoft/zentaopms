...
- 设置瀑布模型导航 @baseline-templatetype,stage-settype,stage-plusbrowse
- 设置融合瀑布模型导航 @baseline-templatetype,stage-settype,stage-browse,stage-browse,stage-browseplus
- 设置融合瀑布模型导航 @baseline-templatetype,stage-settype,stage-browse,stage-browse,stage-browseplus
...
r($stageTester->setMenuType($types[2], $method[0])) && p('', ';') && e('baseline-templatetype,stage-settype,stage-browse,stage-browse,stage-browseplus'); // 设置融合瀑布模型导航
r($stageTester->setMenuType($types[2], $method[1])) && p('', ';') && e('baseline-templatetype,stage-settype,stage-browse,stage-browse,stage-browseplus'); // 设置融合瀑布模型导航
