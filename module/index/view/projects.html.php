...
<table class='table-1 a-center' height='100%'>
  ...
  <tr>
    <td valign='middle'><?php printf($lang->index->noProjectsTip, $this->createLink('project', 'create'));?></td>
  </tr>
</table>
<?php else:?>
  <table class='table-1 tab-box' id='projectbox'>
    <tr>
      ...
      <?php foreach($projectStats['projects'] as $id => $project):?>
       <h2 class='tab-title' ><?php echo $lang->index->projects . $lang->colon . $project->name;?></h2>
