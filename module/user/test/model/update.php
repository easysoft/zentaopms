...
编辑用户，有重名用户的情况 >> 『用户名』已经有『admin』这条记录了。如果您确定该记录已删除，请到后台-系统设置-回收站还原。
...
r($user->updateUserTest(3, $existUser))          && p('account:0')   && e('『用户名』已经有『admin』这条记录了。如果您确定该记录已删除，请到后台-系统设置-回收站还原。');//编辑用户，有重名用户的情况
