...
r($user->checkPasswordTest($differentPassword))  && p('password1:0')    && e('两次密码应该相同。');         //两次密码不相同的情况
r($user->checkPasswordTest($weakPassword))       && p('password1:0')    && e('密码必须6位及以上，且包含大小写字母、数字。'); //密码强度小于系统设定
