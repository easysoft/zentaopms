...
- 用户视图最后更新时间大于相关表最后更新时间，获取admin账户最终可见的迭代列表属性sprints @101,101,103,109,105,110,115,120,101
...
- 用户视图最后更新时间大于相关表最后更新时间，获取user2账户最终可见的迭代列表属性sprints @103,109,102,107,112,117,101
...
- 用户视图最后更新时间小于相关表最后更新时间，获取admin账户最终可见的迭代列表属性sprints @105,106,107,108,113,114,115,116,101,102,103,104,109,110,105,110,115,120,101
...
- 用户视图最后更新时间小于相关表最后更新时间，获取user2账户最终可见的迭代列表属性sprints @107,108,113,114,102,103,104,109,102,107,112,117,101
...
r($user->grantUserViewTest('admin')) && p('sprints' , '-') && e('101,101,103,109,105,110,115,120,101');         // 用户视图最后更新时间大于相关表最后更新时间，获取admin账户最终可见的迭代列表
...
r($user->grantUserViewTest('user2')) && p('sprints' , '-') && e('103,109,102,107,112,117,101');             // 用户视图最后更新时间大于相关表最后更新时间，获取user2账户最终可见的迭代列表
...
r($user->grantUserViewTest('admin')) && p('sprints' , '-') && e('105,106,107,108,113,114,115,116,101,102,103,104,109,110,105,110,115,120,101'); // 用户视图最后更新时间小于相关表最后更新时间，获取admin账户最终可见的迭代列表
...
r($user->grantUserViewTest('user2')) && p('sprints' , '-') && e('107,108,113,114,102,103,104,109,102,107,112,117,101');                     // 用户视图最后更新时间小于相关表最后更新时间，获取user2账户最终可见的迭代列表
