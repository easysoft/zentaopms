...
r($user->checkProductPrivTest($product, 'user60', array(), array(), $stakeholders, $whiteList)) && p() && e('1'); //传入产品、用户名、干系人、白名单，判断user60用户是否对此产品有权限
r($user->checkProductPrivTest($product, 'test6', array(), array(), $stakeholders, $whiteList, $admins)) && p() && e('1'); //传入产品、用户名、干系人、白名单, admins，判断test6用户是否对此产品有权限
