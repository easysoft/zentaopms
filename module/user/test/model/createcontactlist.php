...
列表名称重复时                               >> 『列表名称』已经有『新的列表名称1』这条记录了。如果您确定该记录已删除，请到后台-系统设置-回收站还原。
列表名称为空时                               >> 1
...
r($userTester->createContactListTest('新的列表名称1', array()))   && p('message[listName]:0')  && e('『列表名称』已经有『新的列表名称1』这条记录了。如果您确定该记录已删除，请到后台-系统设置-回收站还原。'); // 列表名称重复时
r($userTester->createContactListTest('',              array()))   && p('message[listName]:0')  && e('『列表名称』不能为空。');                                                                                                      // 列表名称为空时
