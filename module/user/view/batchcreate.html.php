    ...
    <div class="table-responsive">
      <table class="table table-form">
        ...
        <tr class='text-center'>
          ...
          <?php $vision   = $config->systemMode == 'new' ? '' : 'rnd';?>
          <?php $multiple = $config->systemMode == 'new' ? 'multiple' : '';?>
          <td class='text-left'><?php echo html::select("visions[$i][]", $visionList, $i > 0 ? 'ditto' : $vision, "class='form-control chosen' $multiple");?></td>
