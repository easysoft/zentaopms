    ...
    <div class="table-responsive">
      <table class="table table-form">
        ...
        <tr class='text-center'>
          ...
          <td class="<?php echo $config->systemMode == 'new' ? 'text-left' : 'text-center';?>"><?php echo $config->systemMode == 'new' ? html::select("visions[$i][]", $visionList, $i > 1 ? 'ditto' : key($visionList), "class='form-control chosen' multiple") : $visionList['rnd'];?></td>
