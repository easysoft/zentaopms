          ...
          <div class="boards-wrapper">
            <div class="boards">
              ...
              <div class="board s-<?php echo $colStatus?>" data-type="<?php echo $colStatus;?>">
                ...
                <div class='board-item' data-id='<?php echo $execution->id?>' id='task-<?php echo $execution->id?>' data-type='execution' <?php if(isset($execution->delay)) echo "style='border: 1px solid #ff0000';";?>>
                  <div class='table-row'>
                    <div class='table-col'>
                      <?php
