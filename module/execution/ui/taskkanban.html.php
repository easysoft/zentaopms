...
$canCreateRisk       = $canModifyExecution && common::hasPriv('risk', 'create', $checkObject) && $config->edition != 'open';
$canBatchCreateRisk  = $canModifyExecution && common::hasPriv('risk', 'batchCreate', $checkObject) && $config->edition != 'open';
