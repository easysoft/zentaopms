...
$lang->execution->taskSummary          = "Total: <strong>%s</strong> tasks. Waiting: <strong>%s</strong>. Doing: <strong>%s</strong>. Estimate: <strong>%s</strong>h. Cost: <strong>%s</strong>h. Left: <strong>%s</strong>h.";
