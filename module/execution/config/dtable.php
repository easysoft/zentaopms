...
$config->execution->dtable->fieldList['estimate']['title']    = $lang->execution->totalEstimate;
$config->execution->dtable->fieldList['estimate']['name']     = 'estimate';
$config->execution->dtable->fieldList['estimate']['type']     = 'number';
$config->execution->dtable->fieldList['estimate']['sortType'] = false;
$config->execution->dtable->fieldList['estimate']['width']    = '64';
$config->execution->dtable->fieldList['estimate']['group']    = '4';
$config->execution->dtable->fieldList['estimate']['show']     = true;

$config->execution->dtable->fieldList['consumed']['title']    = $lang->execution->totalConsumed;
$config->execution->dtable->fieldList['consumed']['name']     = 'consumed';
$config->execution->dtable->fieldList['consumed']['type']     = 'number';
$config->execution->dtable->fieldList['consumed']['sortType'] = false;
$config->execution->dtable->fieldList['consumed']['width']    = '64';
$config->execution->dtable->fieldList['consumed']['group']    = '4';
$config->execution->dtable->fieldList['consumed']['show']     = true;

$config->execution->dtable->fieldList['left']['title']    = $lang->execution->totalLeft;
$config->execution->dtable->fieldList['left']['name']     = 'left';
$config->execution->dtable->fieldList['left']['type']     = 'number';
$config->execution->dtable->fieldList['left']['sortType'] = false;
$config->execution->dtable->fieldList['left']['width']    = '64';
$config->execution->dtable->fieldList['left']['group']    = '4';
$config->execution->dtable->fieldList['left']['show']     = true;
...
$config->execution->dtable->fieldList['burns']['title']    = $lang->execution->burn;
$config->execution->dtable->fieldList['burns']['name']     = 'burns';
$config->execution->dtable->fieldList['burns']['type']     = 'burn';
$config->execution->dtable->fieldList['burns']['sortType'] = false;
$config->execution->dtable->fieldList['burns']['width']    = '88';
$config->execution->dtable->fieldList['burns']['group']    = '4';
$config->execution->dtable->fieldList['burns']['show']     = true;
...
$config->execution->testtask->dtable->fieldList['taskID']['fixed']    = false;
