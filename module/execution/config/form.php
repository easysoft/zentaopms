...
$config->execution->form->create['name']          = array('type' => 'string', 'required' => true,  'control' => 'text',   'default' => '');
$config->execution->form->create['code']          = array('type' => 'string', 'required' => false, 'control' => 'text',   'default' => '');
$config->execution->form->create['begin']         = array('type' => 'date',   'required' => true,  'control' => 'date',   'default' => '');
$config->execution->form->create['end']           = array('type' => 'date',   'required' => true,  'control' => 'date',   'default' => '');
...
$config->execution->form->create['whitelist']     = array('type' => 'array',  'required' => false, 'control' => 'select', 'default' => array());
$config->execution->form->create['openedVersion'] = array('type' => 'string', 'required' => false, 'control' => 'text',   'default' => $config->version);
$config->execution->form->create['realBegan']     = array('type' => 'date',   'required' => false, 'control' => 'date',   'default' => '');
$config->execution->form->create['realEnd']       = array('type' => 'date',   'required' => false, 'control' => 'date',   'default' => '');
