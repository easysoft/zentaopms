...
class executionTao extends executionModel
{
    ...
    public function setKanbanMenu()
    {
        ...
        $this->lang->execution->menu->build    = array('link' => "{$this->lang->build->common}|execution|build|executionID=%s", 'alias' => 'bug', 'subModule' => 'projectbuild,build,testcase,testtask,bug');
