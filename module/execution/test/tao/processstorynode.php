...
title=测试executionModel->processStoryNode();
timeout=0
cid=1
...
r($execution->processStoryNodeTest($executionIDList[1])) && p('name') && e('产品1'); // 敏捷执行查询
r($execution->processStoryNodeTest($executionIDList[2])) && p('name') && e('产品2'); // 瀑布执行查询
r($execution->processStoryNodeTest($executionIDList[3])) && p('name') && e('产品3'); // 看板执行查询
r($execution->processStoryNodeTest($executionIDList[0])) && p()       && e('0');     // 错误执行查询
