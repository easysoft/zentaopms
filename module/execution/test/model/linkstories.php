...
$project->project->range('105,105,106,106,0,0,107,107,105,105');
...
$project->multiple->range('1{10}');
$project->parent->range('105,105,106,106,0,0,107,107,105,105');
$project->grade->range('1{8},2{2}');
$project->path->range(',105,101,,105,102,,106,103,,106,104,,105,,106,,105,107,,105,108,,105,109,,105,110,')->prefix(',')->postfix(',');
$project->gen(10);
...
$projectproduct->project->range('101,102,103,104,105');
$projectproduct->product->range('1-5');
$projectproduct->plan->range('1,0,3,4,5');
...
r($executionTest->linkStoriesTest(103, 3, 3)) && p() && e('0'); // 测试步骤3：看板执行关联需求
...
r($executionTest->linkStoriesTest(104, 4, 4)) && p() && e('0'); // 测试步骤6：正常执行关联需求
r($executionTest->linkStoriesTest(105, 5, 5)) && p() && e('0'); // 测试步骤7：正常执行关联需求