...
r($executionTester->processProductPlansTest($productIdList, $paramList[0]))        && p('5:15') && e('计划15 待定 / 主干'); // 处理产品的计划信息
r($executionTester->processProductPlansTest($productIdList, $paramList[1]))        && p('4:10') && e('计划10 待定 / 主干'); // 处理产品的带主干计划信息
r($executionTester->processProductPlansTest($productIdList, $paramList[2]))        && p('2:5')  && e('计划5 待定 / 主干');  // 处理产品的非父计划信息
