...
$executionIDList = array('103','104','105','106','107','108','109','110','111');
$productIDList   = array('2','1','3');

$changeName     = array('name' => '迭代名修改', 'code' => '迭代名修改code');
$changeStage    = array('project' =>'101', 'code' => '修改code');
$changeKanban   = array('project' =>'102', 'code' => '修改code3');
...
r($execution->updateObject($executionIDList[0], $changeStage))    && p('0:field,old,new') && e('project,0,101');                             // 测试修改迭代项目为瀑布项目
r($execution->updateObject($executionIDList[0], $changeKanban))   && p('0:field,old,new') && e('project,101,102');                             // 测试修改迭代项目为看板项目
