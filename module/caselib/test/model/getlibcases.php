...
r($caselib->getLibCasesTest($libIdList[0], $browseTypeList[0], $moduleIdList[2], $sortList[0])) && p() && e('429,427,425,423,421,419,417,415,413,411,409,407,405,403,401'); // bymodule 状态下 查询用例库 201 模块 11 排序 id_desc 的用例 id
...
r($caselib->getLibCasesTest($libIdList[0], $browseTypeList[0], $moduleIdList[2], $sortList[1])) && p() && e('401,403,405,407,409,411,413,415,417,419,421,423,425,427,429'); // bymodule 状态下 查询用例库 201 模块 11 排序 id_asc 的用例 id
...
r($caselib->getLibCasesTest($libIdList[0], $browseTypeList[1], $moduleIdList[2], $sortList[0])) && p() && e('429,427,425,423,421,419,417,415,413,411,409,407,405,403,401'); // all 状态下 查询用例库 201 模块 11 排序 id_desc 的用例 id
...
r($caselib->getLibCasesTest($libIdList[0], $browseTypeList[1], $moduleIdList[2], $sortList[1])) && p() && e('401,403,405,407,409,411,413,415,417,419,421,423,425,427,429'); // all 状态下 查询用例库 201 模块 11 排序 id_asc 的用例 id
...
r($caselib->getLibCasesTest($libIdList[0], $browseTypeList[2], $moduleIdList[2], $sortList[0])) && p() && e('429,425,421,417,413,409,405,401'); // wait 状态下 查询用例库 201 模块 11 排序 id_desc 的用例 id
...
r($caselib->getLibCasesTest($libIdList[0], $browseTypeList[2], $moduleIdList[2], $sortList[1])) && p() && e('401,405,409,413,417,421,425,429'); // wait 状态下 查询用例库 201 模块 11 排序 id_asc 的用例 id
...
r($caselib->getLibCasesTest($libIdList[1], $browseTypeList[0], $moduleIdList[2], $sortList[0])) && p() && e('430,428,426,424,422,420,418,416,414,412,410,408,406,404,402'); // bymodule 状态下 查询用例库 402 模块 11 排序 id_desc 的用例 id
...
r($caselib->getLibCasesTest($libIdList[1], $browseTypeList[0], $moduleIdList[2], $sortList[1])) && p() && e('402,404,406,408,410,412,414,416,418,420,422,424,426,428,430'); // bymodule 状态下 查询用例库 402 模块 11 排序 id_asc 的用例 id
