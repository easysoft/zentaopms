...
<div id='mainMenu' class='clearfix'>
  ...
  <div class='btn-toolbar pull-right'>
    <div class='btn-group'>
     <?php common::printLink('caselib', 'exportTemplet', "libID=$libID", "<i class='icon icon-export muted'> </i>" . $lang->caselib->exportTemplet, '', "class='btn btn-link export iframe' data-width='40%'");?>
