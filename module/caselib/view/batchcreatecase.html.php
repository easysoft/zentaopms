    ...
    <table align='center' class='table table-form' id="tableBody">
      <thead>
        <tr class='text-center'>
          ...
          <th class='c-status<?php  echo strpos($config->testcase->create->requiredFields, 'pri') ? ' required' : '';?>'><?php echo $lang->testcase->pri;?></th>
          <th class='c-text<?php  echo strpos($config->testcase->create->requiredFields, 'precondition') ? ' required' : '';?>'><?php echo $lang->testcase->precondition;?></th>
          <th class='c-text<?php  echo strpos($config->testcase->create->requiredFields, 'keywords') ? ' required' : '';?>'><?php echo $lang->testcase->keywords;?></th>
          <th class='c-text<?php  echo strpos($config->testcase->create->requiredFields, 'stage') ? ' required' : '';?>'><?php echo $lang->testcase->stage;?></th>
        </tr>
      </thead>
      <tbody>
