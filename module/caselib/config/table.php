...
$config->caselib->testcase->actionList['edit']['url']   = helper::createLink('testcase', 'edit', 'caseID={id}');
...
$config->caselib->testcase->actionList['delete']['url']   = helper::createLink('testcase', 'delete', 'caseID={id}');
