...
$lang->story->report->charts['storysPerProduct']      = '' . $lang->productCommon . ' câu chuyện';
$lang->story->report->charts['storysPerModule']       = 'Module câu chuyện';
$lang->story->report->charts['storysPerSource']       = 'Nguồn câu chuyện';
$lang->story->report->charts['storysPerPlan']         = 'kế hoạch';
$lang->story->report->charts['storysPerStatus']       = 'tình trạng';
$lang->story->report->charts['storysPerStage']        = 'Giai đoạn';
$lang->story->report->charts['storysPerPri']          = 'ưu tiên';
$lang->story->report->charts['storysPerEstimate']     = 'Dự tính';
$lang->story->report->charts['storysPerOpenedBy']     = 'tạo bởi';
$lang->story->report->charts['storysPerAssignedTo']   = 'giao cho';
$lang->story->report->charts['storysPerClosedReason'] = 'Lý do đóng';
$lang->story->report->charts['storysPerChange']       = 'Câu chuyện đã thay đổi';
...
$lang->story->report->storysPerSource->item       = 'Nguồn';
$lang->story->report->storysPerPlan->item         = 'Kế hoạch';
$lang->story->report->storysPerStatus->item       = 'Tình trạng';
$lang->story->report->storysPerStage->item        = 'Giai đoạn';
$lang->story->report->storysPerPri->item          = 'Ưu tiên';
$lang->story->report->storysPerOpenedBy->item     = 'Mở bởi';
$lang->story->report->storysPerAssignedTo->item   = 'Giao cho';
$lang->story->report->storysPerClosedReason->item = 'Lý do';
$lang->story->report->storysPerEstimate->item     = 'Dự tính';
$lang->story->report->storysPerChange->item       = 'Đã thay đổi câu chuyện';
...
$lang->story->report->storysPerSource->graph->xAxisName       = 'Nguồn';
$lang->story->report->storysPerPlan->graph->xAxisName         = 'Kế hoạch';
$lang->story->report->storysPerStatus->graph->xAxisName       = 'Tình trạng';
$lang->story->report->storysPerStage->graph->xAxisName        = 'Giai đoạn';
$lang->story->report->storysPerPri->graph->xAxisName          = 'Ưu tiên';
$lang->story->report->storysPerOpenedBy->graph->xAxisName     = 'Người tạo';
$lang->story->report->storysPerAssignedTo->graph->xAxisName   = 'Giao cho';
$lang->story->report->storysPerClosedReason->graph->xAxisName = 'Lý do đóng';
$lang->story->report->storysPerEstimate->graph->xAxisName     = 'Dự tính ';
$lang->story->report->storysPerChange->graph->xAxisName       = 'Số lần thay đổi';
