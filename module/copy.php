#!/usr/bin/env php
<?php
$sourceRoot  = '/home/denghongtao/dev/zentaopms/module/';
$moduleName  = isset($argv[1]) ? $argv[1] : '';
$targetClass = '/home/denghongtao/dev/zentaopms/test/class/';
$targetModel = "/home/denghongtao/dev/zentaopms/test/model/$moduleName/";
if(!$moduleName) die('别瞎搞！');
