...
$lang->dataview->duplicateField = '存在重复的字段名： %s。建议您：（1）修改 * 查询为具体的字段。（2）使用 as 为字段设置别名。';
...
$lang->dataview->varFilter->selectList['project.projectType'] = '项目类型';
...
$lang->dataview->tables['build']       = array('name' => '构建数据', 'desc' => '包括构建名称、所属产品、所属项目、所属执行、创建人等');
...
$lang->dataview->tables['release']     = array('name' => '产品发布数据', 'desc' => '包括发布名称、所属产品、所属项目、相关构建、创建人等');
...
$lang->dataview->tables['bugbuild']    = array('name' => '构建Bug数据', 'desc' => '构建的Bug严重程度、优先级、解决人、所属项目、所属产品等');
