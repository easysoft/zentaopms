...
$lang->dataview->duplicateField = 'Duplicate field names exist: %s. You are advised to: (1) Modify the * query to a specific field. (2) Use as to alias the field.';
...
$lang->dataview->varFilter->selectList['project.projectType'] = 'Project Type';
