...
$lang->product->involved         = "Involved in";
...
$lang->product->nameIsDuplicated     = "The product line already contains a record named [%s]. If you are sure it has been deleted, please restore it from Admin>System>Bin.";
...
$lang->product->checkedAllSummary    = "<strong>%total%</strong> stories selected, estimated <strong>%estimate%</strong> ({$lang->hourCommon}), with <strong>%rate%</strong> test case coverage.";
$lang->product->storySummary         = "<strong>%s</strong> {$lang->SRCommon} on this page, estimated <strong>%s</strong> ({$lang->hourCommon}), with <strong>%s</strong> test case coverage.";
$lang->product->checkedSRSummary     = "<strong>%total%</strong> {$lang->SRCommon} selected, estimated <strong>%estimate%</strong> ({$lang->hourCommon}), with <strong>%rate%</strong> test case coverage.";
$lang->product->requirementSummary   = "<strong>%s</strong> {$lang->URCommon} on this page, estimated <strong>%s</strong> ({$lang->hourCommon}).";
$lang->product->checkedURSummary     = "<strong>%total%</strong> {$lang->URCommon} selected, estimated  <strong>%estimate%</strong> ({$lang->hourCommon}).";
$lang->product->epicSummary          = "<strong>%s</strong> {$lang->ERCommon} on this page, estimated <strong>%s</strong> ({$lang->hourCommon}).";
$lang->product->checkedERSummary     = "<strong>%total%</strong> {$lang->ERCommon} selected, estimated <strong>%estimate%</strong> ({$lang->hourCommon}).";
