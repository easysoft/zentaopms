...
$lang->product->finishedStories         = "Finished {$lang->SRCommon}";
$lang->product->finishedStoriesTitle    = "Finished {$lang->SRCommon}";
...
$lang->product->finishedRequirements    = "Finished {$lang->URCommon}";
...
$lang->product->finishedEpics           = "Finished {$lang->ERCommon}";
...
$lang->product->fixedBugs               = 'Fixed Bug';
...
$lang->product->testCaseCoverageInfo = "Case Coverage = Number Of Stories With Cases / Number Of Non-parent Stories * 100%";
