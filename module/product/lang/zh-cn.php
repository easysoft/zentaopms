...
$lang->product->closedProducts   = "已关闭的{$lang->productCommon}";
...
$lang->product->changingStories         = "变更中{$lang->SRCommon}";
$lang->product->changingStoriesTitle    = "变更中{$lang->SRCommon}";
...
$lang->product->changingRequirements    = "变更中{$lang->URCommon}";
$lang->product->changedRequirements     = "已变更{$lang->URCommon}";
$lang->product->draftRequirements       = "草稿{$lang->URCommon}";
$lang->product->reviewingRequirements   = "评审中{$lang->URCommon}";
...
$lang->product->totalRequirements       = "{$lang->URCommon}数";
$lang->product->activeEpics             = "激活{$lang->ERCommon}";
$lang->product->changingEpics           = "变更中{$lang->ERCommon}";
$lang->product->changedEpics            = "已变更{$lang->ERCommon}";
$lang->product->draftEpics              = "草稿{$lang->ERCommon}";
$lang->product->reviewingEpics          = "评审中{$lang->ERCommon}";
$lang->product->finishedEpics           = "已完成{$lang->ERCommon}";
$lang->product->closedEpics             = "已关闭{$lang->ERCommon}";
$lang->product->epicCompleteRate        = "{$lang->ERCommon}完成率";
$lang->product->totalEpics              = "{$lang->ERCommon}数";
...
$lang->product->reviewStory          = '您不是 "%s" 的评审人，无法评审，本次操作已被过滤。';
...
$lang->product->closedDate     = '关闭日期';
$lang->product->mailto         = '抄送给';
$lang->product->vision         = '所属界面';
...
$lang->product->testCaseCoverageInfo = "用例覆盖率 = 有用例的需求数 / 非父需求数 * 100%";
