...
$lang->product->editLine         = "编辑{$lang->productCommon}线";
...
$lang->product->draftStory        = '需求草稿';
$lang->product->activeStory       = '激活';
$lang->product->changingStory     = '变更';
...
$lang->product->storySummary   = "本页共 %s 个%s，预计 %s 个{$lang->hourCommon}，用例覆盖率 %s。";
