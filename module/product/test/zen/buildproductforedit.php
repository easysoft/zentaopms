...
- 执行productTest模块的buildProductForEditTest方法，参数是1, 0
 ...
 - 属性PO @admin
 - 属性status @normal
- 执行productTest模块的buildProductForEditTest方法，参数是2, 1
 - 属性name @Updated Product 2
 - 属性type @branch
 - 属性status @normal
- 执行productTest模块的buildProductForEditTest方法，参数是3, 0
 - 属性name @Updated Product 3
 - 属性acl @open
 - 属性whitelist @~~
- 执行productTest模块的buildProductForEditTest方法，参数是4, 0
 - 属性name @Updated Product 4
 - 属性acl @private
 - 属性whitelist @user1,user2
- 执行productTest模块的buildProductForEditTest方法，参数是5, 0
