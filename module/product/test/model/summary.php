...
r($product->summaryTest($productIDList[1], $typeList[1]))  && p() && e('本页共 <strong>0</strong> 个用户需求，预计 <strong>0</strong> 个工时，用例覆盖率 <strong>0%%</strong>。'); // 获取空的产品的需求统计
...
r($product->summaryTest($productIDList[2], $typeList[1]))  && p() && e('本页共 <strong>0</strong> 个用户需求，预计 <strong>0</strong> 个工时，用例覆盖率 <strong>0%%</strong>。'); // 获取错误的产品的需求统计
