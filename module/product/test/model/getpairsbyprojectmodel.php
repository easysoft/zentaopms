...
r($product->getPairsByProjectModelTest($modelList[1])) && p('name') && e('30'); //用超级管理员账号，测试获取model为scrum产品数量
r($product->getPairsByProjectModelTest($modelList[2])) && p('name') && e('30'); //用超级管理员账号，测试获取model为waterfall产品数量
r($product->getPairsByProjectModelTest($modelList[3])) && p('name') && e('30'); //用超级管理员账号，测试获取model为kanban产品数量
...
r($product->getPairsByProjectModelTest($modelList[1])) && p('name') && e('20'); //用普通账号，测试获取model为scrum产品数量
r($product->getPairsByProjectModelTest($modelList[2])) && p('name') && e('20'); //用普通账号，测试获取model为waterfall产品数量
r($product->getPairsByProjectModelTest($modelList[3])) && p('name') && e('10'); //用普通账号，测试获取model为kanban产品数量
