...
r($list) && p('1:bugs')         && e('3');         // 获取第1个产品的bug数
r($list) && p('1:unResolved')   && e('3');         // 获取第1个产品的未解决bug数
r($list) && p('1:closedBugs')   && e('0');         // 获取第1个产品的关闭bug数
r($list) && p('1:fixedBugs')    && e('0');         // 获取第1个产品的已解决bug数
r($list) && p('1:thisWeekBugs') && e('0');         // 获取第1个产品的本周bug数
r($list) && p('1:assignToNull') && e('0');         // 获取第1个产品的未指派bug数
r($list) && p('1:progress')     && e('16.7');      // 获取第1个产品的完成需求的进度

r($list) && p('2:name')         && e('正常产品2'); // 获取第2个产品的名称
r($list) && p('2:plans')        && e('0');         // 获取第2个产品的计划数
r($list) && p('2:releases')     && e('10');        // 获取第2个产品的发布数
r($list) && p('2:bugs')         && e('3');         // 获取第2个产品的bug数
r($list) && p('2:unResolved')   && e('3');         // 获取第2个产品的未解决bug数
r($list) && p('2:closedBugs')   && e('0');         // 获取第2个产品的关闭bug数
r($list) && p('2:fixedBugs')    && e('0');         // 获取第2个产品的已解决bug数
r($list) && p('2:thisWeekBugs') && e('0');         // 获取第2个产品的本周bug数
r($list) && p('2:assignToNull') && e('0');         // 获取第2个产品的未指派bug数
r($list) && p('2:progress')     && e('16.7');      // 获取第2个产品的完成需求的进度
