...
- 管理员选择未关闭的且programID为1且包含影子产品ID1，或ID为23,24的产品 @2
- 管理员选择未关闭的且programID为1且包含影子产品ID2，或ID为23,24的产品 @2
...
- 普通用户选择未关闭的且programID为1且包含影子产品ID1，或ID为23,24的产品 @2
- 普通用户选择未关闭的且programID为1且包含影子产品ID2，或ID为23,24的产品 @2
...
r(count($product->getProductPairs('noclosed', 1, '23,24', '1')))  && p() && e('2');  // 管理员选择未关闭的且programID为1且包含影子产品ID1，或ID为23,24的产品
r(count($product->getProductPairs('noclosed', 1, '23,24', '2')))  && p() && e('2');  // 管理员选择未关闭的且programID为1且包含影子产品ID2，或ID为23,24的产品
...
r(count($product->getProductPairs('noclosed', 1, '23,24', '1')))  && p() && e('2');    // 普通用户选择未关闭的且programID为1且包含影子产品ID1，或ID为23,24的产品
r(count($product->getProductPairs('noclosed', 1, '23,24', '2')))  && p() && e('2');    // 普通用户选择未关闭的且programID为1且包含影子产品ID2，或ID为23,24的产品
