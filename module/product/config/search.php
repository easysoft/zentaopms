...
$config->product->all->search['fields']['status']      = $lang->product->status;
...
$config->product->all->search['params']['status']      = array('operator' => '=',       'control' => 'select', 'values' => $lang->product->statusList);
