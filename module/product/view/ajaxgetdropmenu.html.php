...
<input type='text' class='gray' id='search' value='' onkeyup='searchItems(this.value, "product", productID, module, method, extra)' autocomplete="off" placeholder='<?php echo $this->app->loadLang('search')->search->common;?>' />
