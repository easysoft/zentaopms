...
class productZen extends product
{
     ...
     * @return string
     */
    protected function getProductLink(string $module, string $method, string $extra = '', bool $branch = false): string
    {
        ...
        if(in_array($module, array('productplan', 'release')) && $method != 'create') return helper::createLink($module, 'browse', "productID=%s{$branchParam}");
