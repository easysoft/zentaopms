    ...
    <div class='main'>
      <div class='tabs'>
        ...
        <ul class='nav nav-tabs'>
          ...
          <li><a href='#newBugs' data-toggle='tab'><?php echo html::icon($lang->icons['bug']) . ' ' . $lang->release->generatedBugs; if($countNewBugs > 0) echo "<span class='label label-danger label-badge label-circle'>" . $countNewBugs . "</span>";?></a></li>
        </ul>
