...
$lang->selectedItems = '<strong>{0}</strong> items selected';
...
$lang->deliverable->common          = 'Deliverables';
...
$lang->pager->digest       = "Total: <strong>%s</strong> items, %s <strong>%s/%s</strong> &nbsp;";
...
$lang->pager->totalCountAB = "{recTotal} items";
