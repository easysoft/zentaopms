...
$lang->product->viewMenu->set         = array('link' => '設置|tree|browse|productID=%s&view=story');
...
$lang->menu->waterfall->qa             = array('link' => '測試|bug|browse|product={PRODUCT}', 'subModule' => ',testcase,testtask,testsuite,caselib,');
