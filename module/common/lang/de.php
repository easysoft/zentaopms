...
$lang->agreement      = "I have read and agreed to the terms and <a href='" . $config->webRoot . "privacy.txt' target='_blank'>Privacy Agreement</a>. <span class='text-danger'>Without authorization, I should not remove, hide or cover any logos/links of ZenTao.</span>";
