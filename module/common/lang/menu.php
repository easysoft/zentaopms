...
$lang->product->menu->story       = array('link' => "$lang->SRCommon|product|browse|productID=%s", 'alias' => 'batchedit', 'subModule' => 'story', 'exclude' => (function(){return $this->get->storyType == 'requirement' ? 'browse,story-report,story-create,story-batchcreate' : '';})());
...
$lang->devops->homeMenu->WIPs        = array('link' => "{$lang->app->common}|space|browse", 'subModule' => 'instance,store', 'alias' => 'createapplication');
