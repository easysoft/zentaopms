...
$lang->devops->menu->code     = array('link' => "{$lang->repocode->common}|repo|browse|repoID=%s", 'subModule' => 'repo', 'exclude' => 'repo-review,repo-browsetag,repo-browsebranch,repo-log,repo-diff,repo-revision,repo-setrules,repo-browsebranchtype,repo-browsereviewflow,repo-createreviewflow,repo-editreviewflow,repo-setbranchrule');
