...
$lang->devops->homeMenu->repos       = array('link' => "{$lang->devops->repo}|repo|browse", 'alias' => 'diff,view,revision,log,blame,showsynccommit');
...
$lang->devops->homeMenu->environment = array('link' => "{$lang->devops->environment}|repo|maintain", 'subModule' => 'gitlab,jenkins,sonarqube,gitea,gogs', 'alias' => 'setrules,create,edit,import');
...
$lang->devops->dividerMenu = ',repos,app,';

$lang->devops->homeMenu->environment['subMenu'] = new stdclass();
$lang->devops->homeMenu->environment['subMenu']->repo      = array('link' => "{$lang->devops->repo}|repo|maintain", 'alias' => 'create,edit,import');
