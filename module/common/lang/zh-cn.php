...
$lang->agreement      = "已阅读并同意 授权协议 和<a href='" . $config->webRoot . "privacy.html' target='_blank'>隐私政策</a>。<span class='text-danger'>未经许可，不得去除、隐藏或遮掩禅道软件的任何标志及链接。</span>";
