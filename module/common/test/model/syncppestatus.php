...
$app->setMethodName('task');
$app->rawModule = 'execution';
$app->rawMethod = 'task';
$_SESSION['project'] = 11;

$project1 = $tester->project->getById(11); // 同步前，查看项目状态
$project2 = $tester->project->getById(12); // 同步前，查看项目状态
$project3 = $tester->project->getById(13); // 同步前，查看项目状态
...
$project2 = $tester->project->getById(12);
$project3 = $tester->project->getById(13);

r($project1) && p('status') && e('doing'); // 同步后，查看项目状态
r($project2) && p('status') && e('doing'); // 同步后，查看项目状态
r($project3) && p('status') && e('doing'); // 同步后，查看项目状态

$app->setModuleName('project');
$app->setMethodName('all');
$app->rawModule = 'project';
$app->rawMethod = 'all';
$_SESSION['project'] = 15;

$program1 = $tester->program->getById(5); // 同步前，查看项目集状态
$program2 = $tester->program->getById(6); // 同步前，查看项目集状态
$program3 = $tester->program->getById(7); // 同步前，查看项目集状态
...
$program1 = $tester->program->getById(5);
$program2 = $tester->program->getById(6);
$program3 = $tester->program->getById(7);
