...
$tester->common->lang->db->custom['executionMenu']['menu']['story'] = '需求1';
...
r($tester->common->lang->execution->menu->story)          && p('link') && e("需求1|execution|story|executionID=%s"); // 替换二级导航下拉的语言项。
