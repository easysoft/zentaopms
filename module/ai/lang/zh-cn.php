...
$lang->ai->assistantBrowse         = '浏览助手';
$lang->ai->assistantView           = '查看助手详情';
$lang->ai->assistantCreate         = '创建助手';
$lang->ai->assistantEdit           = '编辑助手';
$lang->ai->assistantPublish        = '发布助手';
$lang->ai->assistantWithdraw       = '下架助手';
$lang->ai->assistantDelete         = '删除助手';
...
$lang->ai->assistants->createdDate              = '添加时间';
$lang->ai->assistants->publishedDate            = '发布时间';
$lang->ai->assistants->desc                     = '简介';
$lang->ai->assistants->descPlaceholder          = '请简述此 AI 助手的功能及可以给使用者带来的体验。';
$lang->ai->assistants->systemMessage            = '系统内置消息';
$lang->ai->assistants->systemMessagePlaceholder = '您可以赋予此 AI 对话“人设”，例如，“你是一个周报小助手，会根据输入的内容生成格式化的周报”。';
...
$lang->ai->assistants->confirmPublishTip        = '发布后将显示在禅道右下角 AI 对话和客户端对话中，是否确认发布？';
$lang->ai->assistants->confirmWithdrawTip       = '停用后前台用户将无法看到此 AI 助手，是否确认停用？';
...
$lang->ai->assistants->defaultAssistant         = '全能助手';
