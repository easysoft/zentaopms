...
$lang->ai->formSchema['execution']['testreport']->title = '测试报告';
...
$lang->ai->formSchema['execution']['testreport']->properties->begin->description  = '测试开始时间';
$lang->ai->formSchema['execution']['testreport']->properties->end->type           = 'date';
$lang->ai->formSchema['execution']['testreport']->properties->end->description    = '测试开始时间';
$lang->ai->formSchema['execution']['testreport']->properties->title->type         = 'string';
$lang->ai->formSchema['execution']['testreport']->properties->title->description  = '测试报告的标题';
$lang->ai->formSchema['execution']['testreport']->properties->report->type        = 'string';
$lang->ai->formSchema['execution']['testreport']->properties->report->description = '测试报告的内容';
