...
$lang->ai->targetForm['epic']['create']             = 'Create ' . $lang->ERCommon;
$lang->ai->targetForm['epic']['batchcreate']        = 'Batch Create ' . $lang->ERCommon;
$lang->ai->targetForm['epic']['edit']               = 'Edit ' . $lang->ERCommon;
$lang->ai->targetForm['epic']['batchedit']          = 'Batch Edit ' . $lang->ERCommon;
$lang->ai->targetForm['epic']['change']             = 'Change ' . $lang->ERCommon;
$lang->ai->targetForm['requirement']['create']      = 'Create ' . $lang->URCommon;
$lang->ai->targetForm['requirement']['batchcreate'] = 'Batch Create ' . $lang->URCommon;
$lang->ai->targetForm['requirement']['edit']        = 'Edit ' . $lang->URCommon;
$lang->ai->targetForm['requirement']['batchedit']   = 'Batch Edit ' . $lang->URCommon;
$lang->ai->targetForm['requirement']['change']      = 'Change ' . $lang->URCommon;
$lang->ai->targetForm['story']['create']            = 'Create ' . $lang->SRCommon;
$lang->ai->targetForm['story']['batchcreate']       = 'Batch Create ' . $lang->SRCommon;
$lang->ai->targetForm['story']['totask']            = $lang->SRCommon . ' to Task';
$lang->ai->targetForm['story']['testcasecreate']    = $lang->SRCommon . ' to Test Case';
$lang->ai->targetForm['story']['edit']              = 'Edit ' . $lang->SRCommon;
$lang->ai->targetForm['story']['batchedit']         = 'Batch Edit ' . $lang->SRCommon;
$lang->ai->targetForm['story']['change']            = 'Change ' . $lang->SRCommon;
$lang->ai->targetForm['story']['subdivide']         = 'Subdivide ' . $lang->SRCommon;
...
$lang->ai->targetForm['feedback']['batchcreate'] = 'Batch Create Feedback';
$lang->ai->targetForm['feedback']['edit']        = 'Edit Feedback';
$lang->ai->targetForm['feedback']['batchedit']   = 'Batch Edit Feedback';
...
$lang->ai->formSchema['feedback']['create']->title = 'Feedback';
...
$lang->ai->formSchema['feedback']['create']->properties->type->description        = 'Type of feedback';
$lang->ai->formSchema['feedback']['create']->properties->title->type              = 'string';
$lang->ai->formSchema['feedback']['create']->properties->title->description       = 'Title of feedback';
$lang->ai->formSchema['feedback']['create']->properties->pri->type                = 'string';
$lang->ai->formSchema['feedback']['create']->properties->pri->description         = 'Priority of feedback';
...
$lang->ai->formSchema['feedback']['create']->properties->desc->description        = 'Description of feedback';
$lang->ai->formSchema['feedback']['create']->properties->feedbackBy->type         = 'string';
$lang->ai->formSchema['feedback']['create']->properties->feedbackBy->description  = 'Feedback provider';
$lang->ai->formSchema['feedback']['create']->properties->source->type             = 'string';
$lang->ai->formSchema['feedback']['create']->properties->source->description      = 'Source of feedback';
$lang->ai->formSchema['feedback']['create']->properties->notifyEmail->type        = 'string';
$lang->ai->formSchema['feedback']['create']->properties->notifyEmail->description = 'Notify email';
$lang->ai->formSchema['feedback']['create']->properties->keywords->type           = 'string';
$lang->ai->formSchema['feedback']['create']->properties->keywords->description    = 'Keywords';
...
$lang->ai->formSchema['feedback']['batchcreate']->title = 'Feedbacks';
...
$lang->ai->formSchema['feedback']['batchcreate']->properties->feedbacks->description = 'Feedbacks';
...
$lang->ai->formSchema['feedback']['batchedit']->title = 'Feedbacks';
...
$lang->ai->formSchema['ticket']['create']->properties->title->description     = 'Title of ticket';
$lang->ai->formSchema['ticket']['create']->properties->type->type             = 'string';
$lang->ai->formSchema['ticket']['create']->properties->type->description      = 'Type of ticket';
...
$lang->ai->formSchema['ticket']['create']->properties->pri->description       = 'Priority of ticket';
...
$lang->ai->formSchema['ticket']['create']->properties->desc->description      = 'Description of ticket';
$lang->ai->formSchema['ticket']['create']->properties->estimate->type         = 'number';
$lang->ai->formSchema['ticket']['create']->properties->estimate->description  = 'Estimated hours of ticket';
...
$lang->ai->formSchema['ticket']['create']->properties->deadline->description  = 'Deadline of ticket';
$lang->ai->formSchema['ticket']['create']->properties->keywords->type         = 'string';
$lang->ai->formSchema['ticket']['create']->properties->keywords->description  = 'Keywords';
...
$lang->ai->formSchema['issue']['create']->title = 'Issue';
...
$lang->ai->formSchema['issue']['create']->properties->title->description     = 'Title of issue';
$lang->ai->formSchema['issue']['create']->properties->type->type             = 'string';
$lang->ai->formSchema['issue']['create']->properties->type->description      = 'Type of issue';
...
$lang->ai->formSchema['issue']['create']->properties->severity->description  = 'Severity of issue';
...
$lang->ai->formSchema['issue']['create']->properties->pri->description       = 'Priority of issue';
...
$lang->ai->formSchema['issue']['create']->properties->desc->description      = 'Description of issue';
...
$lang->ai->formSchema['issue']['create']->properties->deadline->description  = 'Planned resolution date';
...
$lang->ai->formSchema['issue']['batchcreate']->title = 'Issues';
...
$lang->ai->formSchema['issue']['batchcreate']->properties->issues->description = 'Issues';
...
$lang->ai->formSchema['risk']['create']->title = 'Risk';
...
$lang->ai->formSchema['risk']['create']->properties->name->description        = 'Name of risk';
$lang->ai->formSchema['risk']['create']->properties->source->type             = 'string';
$lang->ai->formSchema['risk']['create']->properties->source->description      = 'Source of risk';
...
$lang->ai->formSchema['risk']['create']->properties->category->description    = 'Category of risk';
...
$lang->ai->formSchema['risk']['create']->properties->strategy->description    = 'Strategy of risk';
...
$lang->ai->formSchema['risk']['create']->properties->impact->description      = 'Impact of risk';
...
$lang->ai->formSchema['risk']['create']->properties->probability->description = 'Probability of risk';
...
$lang->ai->formSchema['risk']['create']->properties->pri->description         = 'Priority of risk';
...
$lang->ai->formSchema['risk']['create']->properties->prevention->description  = 'Prevention measures';
$lang->ai->formSchema['risk']['create']->properties->remedy->type             = 'string';
$lang->ai->formSchema['risk']['create']->properties->remedy->format           = 'html';
$lang->ai->formSchema['risk']['create']->properties->remedy->description      = 'Remedy measures';
...
$lang->ai->formSchema['risk']['batchcreate']->title = 'Risks';
...
$lang->ai->formSchema['risk']['batchcreate']->properties->risks->description = 'Risks';
