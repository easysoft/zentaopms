...
$lang->ai->miniPrograms->field->fields            = 'Form Configuration';
...
$lang->ai->formSchema['project']['create'] = new stdclass();
$lang->ai->formSchema['project']['create']->title = 'Project';
$lang->ai->formSchema['project']['create']->type  = 'object';
$lang->ai->formSchema['project']['create']->properties = new stdclass();
$lang->ai->formSchema['project']['create']->properties->name       = new stdclass();
$lang->ai->formSchema['project']['create']->properties->code       = new stdclass();
$lang->ai->formSchema['project']['create']->properties->model      = new stdclass();
$lang->ai->formSchema['project']['create']->properties->PM         = new stdclass();
$lang->ai->formSchema['project']['create']->properties->budget     = new stdclass();
$lang->ai->formSchema['project']['create']->properties->budgetUnit = new stdclass();
$lang->ai->formSchema['project']['create']->properties->begin      = new stdclass();
$lang->ai->formSchema['project']['create']->properties->end        = new stdclass();
$lang->ai->formSchema['project']['create']->properties->days       = new stdclass();
$lang->ai->formSchema['project']['create']->properties->desc       = new stdclass();
$lang->ai->formSchema['project']['create']->properties->acl        = new stdclass();
$lang->ai->formSchema['project']['create']->properties->name->type             = 'string';
$lang->ai->formSchema['project']['create']->properties->name->description      = 'Name of project';
$lang->ai->formSchema['project']['create']->properties->code->type             = 'string';
$lang->ai->formSchema['project']['create']->properties->code->description      = 'Code of project';
$lang->ai->formSchema['project']['create']->properties->model->type            = 'string';
$lang->ai->formSchema['project']['create']->properties->model->description     = 'Management model of project';
$lang->ai->formSchema['project']['create']->properties->model->enum            = array('scrum', 'waterfall', 'kanban', 'agileplus', 'waterfallplus', 'ipd');
$lang->ai->formSchema['project']['create']->properties->PM->type               = 'string';
$lang->ai->formSchema['project']['create']->properties->PM->description        = 'Manager account of project';
$lang->ai->formSchema['project']['create']->properties->budget->type           = 'number';
$lang->ai->formSchema['project']['create']->properties->budget->description    = 'Budget of project';
$lang->ai->formSchema['project']['create']->properties->budgetUnit->type        = 'string';
$lang->ai->formSchema['project']['create']->properties->budgetUnit->description = 'Budget currency';
$lang->ai->formSchema['project']['create']->properties->begin->type            = 'string';
$lang->ai->formSchema['project']['create']->properties->begin->format          = 'date';
$lang->ai->formSchema['project']['create']->properties->begin->description     = 'Planned begin date of project';
$lang->ai->formSchema['project']['create']->properties->end->type              = 'string';
$lang->ai->formSchema['project']['create']->properties->end->format            = 'date';
$lang->ai->formSchema['project']['create']->properties->end->description       = 'Planned end date of project';
$lang->ai->formSchema['project']['create']->properties->days->type             = 'integer';
$lang->ai->formSchema['project']['create']->properties->days->description      = 'Available workdays of project';
$lang->ai->formSchema['project']['create']->properties->desc->type             = 'string';
$lang->ai->formSchema['project']['create']->properties->desc->format           = 'html';
$lang->ai->formSchema['project']['create']->properties->desc->description      = 'Description of project';
$lang->ai->formSchema['project']['create']->properties->acl->type              = 'string';
$lang->ai->formSchema['project']['create']->properties->acl->description       = 'Access control of project';
$lang->ai->formSchema['project']['create']->properties->acl->enum              = array('open', 'private', 'program');
$lang->ai->formSchema['project']['create']->required = array('name', 'begin');
$lang->ai->formSchema['project']['edit'] = clone $lang->ai->formSchema['project']['create'];
$lang->ai->formSchema['project']['edit']->properties = clone $lang->ai->formSchema['project']['create']->properties;

$lang->ai->formSchema['execution']['create'] = new stdclass();
$lang->ai->formSchema['execution']['create']->title = 'Execution';
$lang->ai->formSchema['execution']['create']->type  = 'object';
$lang->ai->formSchema['execution']['create']->properties = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->name      = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->code      = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->lifetime  = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->attribute = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->begin     = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->end       = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->days      = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->percent   = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->PM        = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->PO        = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->QD        = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->RD        = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->team      = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->desc      = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->acl       = new stdclass();
$lang->ai->formSchema['execution']['create']->properties->name->type             = 'string';
$lang->ai->formSchema['execution']['create']->properties->name->description      = 'Name of execution';
$lang->ai->formSchema['execution']['create']->properties->code->type             = 'string';
$lang->ai->formSchema['execution']['create']->properties->code->description      = 'Code of execution';
$lang->ai->formSchema['execution']['create']->properties->lifetime->type         = 'string';
$lang->ai->formSchema['execution']['create']->properties->lifetime->description  = 'Lifetime of execution';
$lang->ai->formSchema['execution']['create']->properties->lifetime->enum         = array('short', 'long', 'ops');
$lang->ai->formSchema['execution']['create']->properties->attribute->type        = 'string';
$lang->ai->formSchema['execution']['create']->properties->attribute->description = 'Stage attribute';
$lang->ai->formSchema['execution']['create']->properties->attribute->enum        = array('request', 'design', 'dev', 'qa', 'release', 'review', 'other');
$lang->ai->formSchema['execution']['create']->properties->begin->type            = 'string';
$lang->ai->formSchema['execution']['create']->properties->begin->format          = 'date';
$lang->ai->formSchema['execution']['create']->properties->begin->description     = 'Planned begin date';
$lang->ai->formSchema['execution']['create']->properties->end->type              = 'string';
$lang->ai->formSchema['execution']['create']->properties->end->format            = 'date';
$lang->ai->formSchema['execution']['create']->properties->end->description       = 'Planned end date';
$lang->ai->formSchema['execution']['create']->properties->days->type             = 'integer';
$lang->ai->formSchema['execution']['create']->properties->days->description      = 'Available workdays';
$lang->ai->formSchema['execution']['create']->properties->percent->type          = 'number';
$lang->ai->formSchema['execution']['create']->properties->percent->description   = 'Stage workload percent';
$lang->ai->formSchema['execution']['create']->properties->PM->type               = 'string';
$lang->ai->formSchema['execution']['create']->properties->PM->description        = 'Execution manager account';
$lang->ai->formSchema['execution']['create']->properties->PO->type               = 'string';
$lang->ai->formSchema['execution']['create']->properties->PO->description        = 'Product owner account';
$lang->ai->formSchema['execution']['create']->properties->QD->type               = 'string';
$lang->ai->formSchema['execution']['create']->properties->QD->description        = 'Test owner account';
$lang->ai->formSchema['execution']['create']->properties->RD->type               = 'string';
$lang->ai->formSchema['execution']['create']->properties->RD->description        = 'Release owner account';
$lang->ai->formSchema['execution']['create']->properties->team->type             = 'string';
$lang->ai->formSchema['execution']['create']->properties->team->description      = 'Team name';
$lang->ai->formSchema['execution']['create']->properties->desc->type             = 'string';
$lang->ai->formSchema['execution']['create']->properties->desc->format           = 'html';
$lang->ai->formSchema['execution']['create']->properties->desc->description      = 'Description of execution';
$lang->ai->formSchema['execution']['create']->properties->acl->type              = 'string';
$lang->ai->formSchema['execution']['create']->properties->acl->description       = 'Access control of execution';
$lang->ai->formSchema['execution']['create']->properties->acl->enum              = array('open', 'private');
$lang->ai->formSchema['execution']['create']->required = array('name', 'begin', 'end');
$lang->ai->formSchema['execution']['edit'] = clone $lang->ai->formSchema['execution']['create'];
$lang->ai->formSchema['execution']['edit']->properties = clone $lang->ai->formSchema['execution']['create']->properties;
$lang->ai->formSchema['execution']['edit']->properties->status = new stdclass();
$lang->ai->formSchema['execution']['edit']->properties->status->type        = 'string';
$lang->ai->formSchema['execution']['edit']->properties->status->description = 'Status of execution';
$lang->ai->formSchema['execution']['edit']->properties->status->enum        = array('wait', 'doing', 'suspended', 'closed');
...
$lang->ai->promptMenu->assignedTo    = 'Assignee %s';
