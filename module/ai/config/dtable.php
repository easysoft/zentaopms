...
$config->ai->dtable->assistants['name']          = array('name' => 'name', 'title' => $lang->ai->assistants->name, 'flex' => 1, 'type' => 'link', 'link' => array('module' => 'ai', 'method' => 'assistantview', 'params' => 'assistantID={id}'));
$config->ai->dtable->assistants['model']         = array('name' => 'model', 'title' => $lang->ai->assistants->refModel, 'flex' => 'auto', 'type' => 'text', 'sortType' => true, 'minWidth' => 120,);
