...
$config->ai->actionList['modelenable']['url']          = array('module' => 'ai', 'method' => 'modelenable', 'params' => 'model={id}');
...
$config->ai->actionList['modeldisable']['url']         = array('module' => 'ai', 'method' => 'modeldisable', 'params' => 'model={id}');
...
$config->ai->actionList['modeltestconnection']['url']  = array('module' => 'ai', 'method' => 'modeltestconnection', 'params' => 'model={id}');
...
$config->ai->actionList['modeledit']['url']            = array('module' => 'ai', 'method' => 'modeledit', 'params' => 'model={id}');
