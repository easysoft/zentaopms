  ...
  <div class="main-col col-8">
    <div class='main-actions'>
      <div class="btn-toolbar">
        ...
        <?php if($prompt->status == 'active') echo html::a(helper::createLink('ai', 'promptunpublish', "id={$prompt->id}"), '<i class="icon icon-ban icon-sm"></i> ' . $lang->ai->prompts->action->unpublish, '', "class='btn'");?>
        <div class='divider'></div>
