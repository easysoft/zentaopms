...
- 步骤3：切换不存在的模型ID @1
- 步骤4：使用0值禁用模型ID为3的模型 @1
- 步骤5：使用1值启用模型ID为4的模型 @1
...
r($aiTest->toggleModelTest(999, true)) && p() && e('1');    // 步骤3：切换不存在的模型ID
r($aiTest->toggleModelTest(3, 0)) && p() && e('1');         // 步骤4：使用0值禁用模型ID为3的模型
r($aiTest->toggleModelTest(4, 1)) && p() && e('1');         // 步骤5：使用1值启用模型ID为4的模型