...
r(count($aiTest->filterPromptsForExecutionTest(array((object)array('id' => 1, 'name' => 'test1', 'module' => 'story', 'source' => 'story.story', 'targetForm' => 'story.create', 'actionPurpose' => 'story.create', 'displayPosition' => 'form', 'purpose' => '测试', 'status' => 'active'))))) && p() && e('1');
r(count($aiTest->filterPromptsForExecutionTest(array((object)array('id' => 2, 'name' => '', 'module' => 'story', 'source' => 'story.story', 'targetForm' => 'story.create', 'actionPurpose' => 'story.create', 'displayPosition' => 'form', 'purpose' => '测试', 'status' => 'active'), (object)array('id' => 3, 'name' => 'test3', 'module' => 'story', 'source' => 'story.story', 'targetForm' => 'story.create', 'actionPurpose' => 'story.create', 'displayPosition' => 'form', 'purpose' => '测试', 'status' => 'active'))))) && p() && e('1');
r(count($aiTest->filterPromptsForExecutionTest(array((object)array('id' => 4, 'name' => 'test4', 'module' => 'task', 'source' => 'task.task', 'targetForm' => 'task.edit', 'actionPurpose' => 'task.edit', 'displayPosition' => 'form', 'purpose' => '测试', 'status' => 'active')), false))) && p() && e('1');
r($aiTest->filterPromptsForExecutionTest(array((object)array('id' => 5, 'name' => 'test5', 'module' => 'story', 'source' => 'story.story', 'targetForm' => 'story.create', 'actionPurpose' => 'story.create', 'displayPosition' => 'form', 'purpose' => '测试', 'status' => 'active')), true)) && p('0:name') && e('test5');
