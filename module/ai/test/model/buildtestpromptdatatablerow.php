...
r(trim($aiTest->buildTestPromptDataTableRowTest('stories', array('pri'), $testData, 0))) && p() && e('| 5 |');
r(trim($aiTest->buildTestPromptDataTableRowTest('tasks', array('name'), $testData, 0))) && p() && e('|');
