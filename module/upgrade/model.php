...
class upgradeModel extends model
{
    ...
    public function getOpenConfirm($openVersion, $fromVersion)
    {
        ...
        switch($openVersion)
        {
            ...
            case '18_0_beta3':
             ...
             case '18_10':
                $confirmContent .= file_get_contents($this->getUpgradeFile('18.10'));
             case '18_10_1':
                $confirmContent .= file_get_contents($this->getUpgradeFile('18.10.1'));
             case '18_11':
                $confirmContent .= file_get_contents($this->getUpgradeFile('18.11')); // confirm insert position.
        }
    ...
    public function addFlowFields($version)
    {
        ...
        $workFlowDataSource = $this->dao->select('code,id')->from(TABLE_WORKFLOWDATASOURCE)->fetchPairs();
