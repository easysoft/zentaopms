...
$lang->upgrade->needCreateProject  = "{$lang->projectCommon} that relates multiple {$lang->productCommon}: No projects in ZenTao. Upgrade the historical {$lang->projectCommon} as a project, or create a new project.";
