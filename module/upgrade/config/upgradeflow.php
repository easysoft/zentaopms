...
$config->upgrade->execFlow['22_1']        = array('functions' => 'importBuildinWorkflow', 'params' => array('importBuildinWorkflow' => array('all', 'testcase,caselib,release,productplan', 'testcase-runCase,caselib-viewCase,release-publish,productplan-start,productplan-finish,productplan-close,productplan-activate', 1)));
