...
$config->upgrade->execFlow['22_1']        = array('functions' => 'importBuildinWorkflow', 'params' => array('importBuildinWorkflow' => array('all', 'testcase,caselib,release,productplan,task,bug,story,requirement,epic', 'testcase-runCase,caselib-viewCase,release-publish,productplan-start,productplan-finish,productplan-close,productplan-activate,task-copy,bug-copy,story-copy,testcase-copy,requirement-copy,epic-copy', 1)));
