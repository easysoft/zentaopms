...
r($check) && p('') && e(1);  //检查isProjectType为false默认值时，项目id为1，产品id为1,2,3,4,100的关联关系已经生成的分支计划id是否正确。
...
r($check) && p('') && e(1);  //检查isProjectType为true的时候，项目id为1，产品id为5,6,7,8的关联关系已经生成的分支计划id是否正确。
