...
*/
chdir (__DIR__);
include '../lib/ui/batcheditstoryinlite.ui.class.php';
...
$tester = new batchEditStoryInLiteTester();
$tester->login();


r($tester->batchEditStoryInLite()) && p('message,status') && e('批量编辑目标成功,SUCCESS');
