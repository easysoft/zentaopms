...
r($item) && p('id,type,owner_id,start_date,parent') && e("1,task,``,28-09-2023,0"); //检查构建分组Gantt数据。
...
$item = $tester->programplan->buildTaskDataForGantt($task, $dateLimit, 0);
r($item) && p('id,type,owner_id,start_date,parent') && e("2,task,``,28-09-2023,0"); //检查构建分组Gantt数据。
...
$item = $tester->programplan->buildTaskDataForGantt($task, $dateLimit, 0);
r($item) && p('id,type,owner_id,start_date,parent') && e("3,task,``,28-09-2023,0"); //检查构建分组Gantt数据。
...
$item = $tester->programplan->buildTaskDataForGantt($task, $dateLimit, 0);
r($item) && p('id,type,owner_id,start_date,parent') && e("4,task,``,28-09-2023,0"); //检查构建分组Gantt数据。
...
$item = $tester->programplan->buildTaskDataForGantt($task, $dateLimit, 0);
r($item) && p('id,type,owner_id,start_date,parent') && e("5,task,``,28-09-2023,0"); //检查构建分组Gantt数据。
