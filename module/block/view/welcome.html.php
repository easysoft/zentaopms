    ...
    <div class="col col-right">
      ...
      <div class="row tiles">
        <div class="col tile">
          ...
          <div class="tile-amount"><?php echo empty($tasks) ? 0 : html::a($this->createLink('my', 'work', 'mode=task'), (int)$tasks, '', "class='text-primary'");?></div>
        ...
        <div class="col tile">
          ...
          <div class="tile-amount"><?php echo empty($bugs) ? 0 : html::a($this->createLink('my', 'work', 'mode=bug'), (int)$bugs, '', "class='text-primary'");?></div>
        ...
        <div class="col tile">
          ...
          <div class="tile-amount"><?php echo empty($stories) ? 0 : html::a($this->createLink('my', 'work', 'mode=story'), (int)$stories, '', "class='text-primary'");?></div>
        </div>
      </div>
    </div>
  </div>
