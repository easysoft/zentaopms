          ...
          <nav class='panel-actions nav nav-default'>
            ...
            <li class='dropdown'>
              ...
              <ul class='dropdown-menu pull-right'>
                ...
                <li><a href='javascript:deleteBlock(<?php echo $index;?>);' class='hidden-panel'><?php echo $lang->block->hidden . $lang->block->common;?></a>
                <li>
          ...
          <nav class='panel-actions nav nav-default'>
            ...
            <li class='dropdown'>
              ...
              <ul class='dropdown-menu pull-right'>
                ...
                <?php if(!$useGuest):?>
                <li><a data-toggle='modal' href="<?php echo $this->createLink("block", "admin", "id=$block->id&module=$module"); ?>" class='edit-block' data-title='<?php echo $block->title; ?>' ><?php echo $lang->edit . $lang->block->common; ?></a></li>
                <li><a href='javascript:deleteBlock(<?php echo $index?>);' class='hidden-panel'><?php echo $lang->block->hidden . $lang->block->common; ?></a></li>
                <?php if($this->app->user->admin):?>
