...
$config->block->story->dtable->fieldList['title']    = array('name' => 'title',    'title' => $this->lang->story->title,      'type' => 'title',    'sort' => true, 'flex' => 1, 'link' => array('module' => 'story', 'method' => 'view', 'params' => 'storyID={id}&vision={version}&param=0&storyType={type}'));
