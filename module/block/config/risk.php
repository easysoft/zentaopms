...
$config->block->risk->dtable->fieldList['pri']      = array('name' => 'pri',      'title' => $lang->risk->priAB,    'type' => 'status', 'sort' => true);
...
$config->block->risk->dtable->fieldList['strategy'] = array('name' => 'strategy', 'title' => $lang->risk->strategy, 'type' => 'status', 'sort' => true);
