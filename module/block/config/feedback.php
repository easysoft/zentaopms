...
if(in_array($config->edition, array('max', 'biz', 'ipd')))
{
    ...
    $config->block->feedback->dtable->fieldList['title']    = array('name' => 'title',   'title' => $lang->feedback->title,   'type' => 'title',    'sort' => true,  'flex' => 1, 'link' => array('module' => 'feedback', 'method' => 'adminView', 'params' => 'feedbackID={id}'));
