...
$config->block->testtask->dtable->fieldList['pri']     = array('name' => 'pri',            'title' => $lang->priAB,                                          'type' => 'pri',   'sort' => true);
$config->block->testtask->dtable->fieldList['product'] = array('name' => 'productName',    'title' => $lang->testtask->product,                              'type' => 'text',  'sort' => true,  'link' => array('module' => 'product', 'method' => 'browse', 'params' => 'productID={product}'));
$config->block->testtask->dtable->fieldList['build']   = array('name' => 'executionBuild', 'title' => "{$lang->testtask->execution}/{$lang->build->common}", 'type' => 'text',  'sort' => true,  'link' => array('module' => 'build', 'method' => 'view', 'params' => 'buildID={build}'));
