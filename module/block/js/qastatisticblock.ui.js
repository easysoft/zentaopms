$(function()
{
    $('.qastatistic-block.block-sm .nav.nav-tabs').find('.nav-item.nav-switch').removeClass('active');
    $('.qastatistic-block.block-sm .nav.nav-tabs').find('.nav-item.nav-switch').each(function()
    {
...
$('.qastatistic-block.block-sm .nav.nav-tabs').on('show', function(event, info)
{
...
$('.qastatistic-block .nav.nav-tabs').on('show', function(event, info)
{
