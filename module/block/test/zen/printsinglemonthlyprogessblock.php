...
- 执行blockTest模块的printSingleMonthlyProgressBlockTest方法，参数是1 
 - 属性success @1
 - 属性monthCount @6
- 执行blockTest模块的printSingleMonthlyProgressBlockTest方法 属性success @1
- 执行blockTest模块的printSingleMonthlyProgressBlockTest方法，参数是999 
 - 属性success @1
 - 属性productID @999
- 执行blockTest模块的printSingleMonthlyProgressBlockTest方法，参数是1 属性dataCount @6
- 执行blockTest模块的printSingleMonthlyProgressBlockTest方法，参数是2 
 - 属性hasMetricData @1
 - 属性success @1
...
r($blockTest->printSingleMonthlyProgressBlockTest(0)) && p('success') && e('1');
r($blockTest->printSingleMonthlyProgressBlockTest(999)) && p('success,productID') && e('1,999');
r($blockTest->printSingleMonthlyProgressBlockTest(1)) && p('dataCount') && e('6');
