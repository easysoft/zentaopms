...
$lang->block->createdRequirements = '创建的用户需求/史诗数';
$lang->block->createdStories      = '创建的软件需求/故事数';
...
$lang->block->flowchart['product'] = array($lang->productCommon . '经理', '创建' . $lang->productCommon, '维护模块', "维护{$lang->planCommon}", "维护{$lang->SRCommon}", '创建发布');
