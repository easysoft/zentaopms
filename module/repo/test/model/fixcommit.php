...
$history->repo->range('1,1,3{5},4,5{2}');
$history->revision->range('a1b2c3,d4e5f6,j1k2l3,m4n5o6,p7q8r9,s1t2u3,v4w5x6,y7z8a9,b1c2d3,final');
$history->commit->range('100,200,300,400,500,600,700,800,900,1000');
$history->comment->range('Initial commit,Fix bug,Update docs,Refactor code,Fix test,Add test,Update readme,Fix style,Final commit,Last commit');
$history->committer->range('user1,user2,admin,dev1,dev2,tester1,tester2,pm1,admin,dev3');
$history->time->range('10-20')->prefix('2022-01-01 ')->postfix(':00:00');
$history->gen(10);
