...
$pager->recPerPage = 2;
$pager->pageID     = 1;
$repoTest->objectModel->app->rawModule = 'repo';
$repoTest->objectModel->app->rawMethod = 'getlistbycondition';
...
r(count($repoTest->getListByConditionTest("name='testHtml'", ''))) && p() && e('0');
