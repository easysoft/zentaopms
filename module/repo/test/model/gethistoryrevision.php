...
r($repoModel->getHistoryRevision($repoID, $revision))                          && p()                  && e('d30919bdb9b4cf8e2698f4a6a30e41910427c01c');
r($repoModel->getHistoryRevision($repoID, $revision, $withCommit))             && p('revision,commit') && e('d30919bdb9b4cf8e2698f4a6a30e41910427c01c,2');
r($repoModel->getHistoryRevision($repoID, $revision, $withCommit, $condition)) && p('revision,commit') && e('0dbb150d4904c9a9d5a804b6cdddea3cb3d856bb,1');
r($repoModel->getHistoryRevision(999, $revision)) && p() && e('0');
r($repoModel->getHistoryRevision($repoID, 'nonexistent')) && p() && e('0');
