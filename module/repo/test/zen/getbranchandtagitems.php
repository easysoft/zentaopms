...
- 调用getBranchAndTagItemsTest验证返回 @1
- 第二次调用返回一致 @1
- 第三次调用返回一致 @1
- 第四次调用返回一致 @1
- 第五次调用返回一致 @1
...
$r1 = $test->getBranchAndTagItemsTest();
$r2 = $test->getBranchAndTagItemsTest();
$r3 = $test->getBranchAndTagItemsTest();
$r4 = $test->getBranchAndTagItemsTest();
$r5 = $test->getBranchAndTagItemsTest();
