...
- 调用getSystemSearchQueryTest验证返回 @1
- 第二次调用返回一致 @1
- 第三次调用返回一致 @1
- 第四次调用返回一致 @1
- 第五次调用返回一致 @1
...
$r1 = $test->getSystemSearchQueryTest(0);
$r2 = $test->getSystemSearchQueryTest(0);
$r3 = $test->getSystemSearchQueryTest(0);
$r4 = $test->getSystemSearchQueryTest(0);
$r5 = $test->getSystemSearchQueryTest(0);
