...
- 调用buildRepoSearchFormTest验证返回 @1
- 第二次调用返回一致 @1
- 第三次调用返回一致 @1
- 第四次调用返回一致 @1
- 第五次调用返回一致 @1
...
$r1 = $test->buildRepoSearchFormTest();
$r2 = $test->buildRepoSearchFormTest();
$r3 = $test->buildRepoSearchFormTest();
$r4 = $test->buildRepoSearchFormTest();
$r5 = $test->buildRepoSearchFormTest();
