...
$r1 = $test->checkDeleteErrorTest(1);
$r2 = $test->checkDeleteErrorTest(1);
$r3 = $test->checkDeleteErrorTest(1);
$r4 = $test->checkDeleteErrorTest(1);
$r5 = $test->checkDeleteErrorTest(1);
