...
- 调用getBranchAndTagOptionsTest验证返回 @1
- 第二次调用返回一致 @1
- 第三次调用返回一致 @1
- 第四次调用返回一致 @1
- 第五次调用返回一致 @1
...
$r1 = $test->getBranchAndTagOptionsTest(1);
$r2 = $test->getBranchAndTagOptionsTest(1);
$r3 = $test->getBranchAndTagOptionsTest(1);
$r4 = $test->getBranchAndTagOptionsTest(1);
$r5 = $test->getBranchAndTagOptionsTest(1);
