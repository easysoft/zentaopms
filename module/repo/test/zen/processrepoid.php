...
$r1 = $test->processRepoIDTest(1);
$r2 = $test->processRepoIDTest(1);
$r3 = $test->processRepoIDTest(1);
$r4 = $test->processRepoIDTest(1);
$r5 = $test->processRepoIDTest(1);
