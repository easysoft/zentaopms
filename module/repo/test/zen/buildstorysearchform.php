...
- 调用buildStorySearchFormTest验证返回 @1
- 第二次调用返回一致 @1
- 第三次调用返回一致 @1
- 第四次调用返回一致 @1
- 第五次调用返回一致 @1
...
$r1 = $test->buildStorySearchFormTest();
$r2 = $test->buildStorySearchFormTest();
$r3 = $test->buildStorySearchFormTest();
$r4 = $test->buildStorySearchFormTest();
$r5 = $test->buildStorySearchFormTest();
