...
$r1 = $test->buildImportFormTest(1);
$r2 = $test->buildImportFormTest(1);
$r3 = $test->buildImportFormTest(1);
$r4 = $test->buildImportFormTest(1);
$r5 = $test->buildImportFormTest(1);
