...
- 调用buildBugSearchFormTest验证返回 @1
- 第二次调用返回一致 @1
- 第三次调用返回一致 @1
- 第四次调用返回一致 @1
- 第五次调用返回一致 @1
...
$r1 = $test->buildBugSearchFormTest();
$r2 = $test->buildBugSearchFormTest();
$r3 = $test->buildBugSearchFormTest();
$r4 = $test->buildBugSearchFormTest();
$r5 = $test->buildBugSearchFormTest();
