...
$r1 = $test->getFilesInfoTest(1);
$r2 = $test->getFilesInfoTest(1);
$r3 = $test->getFilesInfoTest(1);
$r4 = $test->getFilesInfoTest(1);
$r5 = $test->getFilesInfoTest(1);
