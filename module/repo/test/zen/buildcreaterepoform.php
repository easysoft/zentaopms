...
- 调用buildCreateRepoFormTest验证返回 @1
- 第二次调用返回一致 @1
- 第三次调用返回一致 @1
- 第四次调用返回一致 @1
- 第五次调用返回一致 @1
...
$r1 = $test->buildCreateRepoFormTest();
$r2 = $test->buildCreateRepoFormTest();
$r3 = $test->buildCreateRepoFormTest();
$r4 = $test->buildCreateRepoFormTest();
$r5 = $test->buildCreateRepoFormTest();
