...
$lang->repo->webhook->customEventList['tag_updated']              = '标签更新';
...
$lang->repo->webhook->customEventList['pullreq_comment_created']  = '创建推送请求评论';
$lang->repo->webhook->customEventList['pullreq_merged']           = '合并推送请求';
$lang->repo->webhook->customEventList['pullreq_reviewer_created'] = '添加推送请求审阅者';
$lang->repo->webhook->customEventList['pullreq_reviewer_deleted'] = '删除推送请求审阅者';
$lang->repo->webhook->customEventList['pullreq_review_submitted'] = '提交推送请求审核';
