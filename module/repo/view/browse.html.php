...
<div id='mainMenu' class='clearfix'>
  ...
  <div class="btn-toolbar pull-right">
    ...
    <?php endif;?>
    <?php if(common::hasPriv('repo', 'create') && $currentProject && !$currentProject->hasProduct) echo html::a(helper::createLink('repo', 'create', "objectID=$objectID"), "<i class='icon icon-plus'></i> " . $this->lang->repo->createAction, '', "class='btn btn-primary'");?>
  </div>
</div>
