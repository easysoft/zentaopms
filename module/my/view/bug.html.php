    ...
    <table class="table has-sort-head table-fixed" id='bugList'>
      ...
      <thead>
        <tr>
          ...
          <th class='w-40px' title='<?php echo $lang->bug->severity;?>'> <?php common::printOrderLink('severity',   $orderBy, $vars, $lang->bug->severityAB);?></th>
          <th class='w-40px' title='<?php echo $lang->bug->pri;?>'> <?php common::printOrderLink('pri',        $orderBy, $vars, $lang->priAB);?></th>
