...
$config->my->ssh->dtable->fieldList['id']['name']  = 'id';
$config->my->ssh->dtable->fieldList['id']['title'] = $lang->idAB;
$config->my->ssh->dtable->fieldList['id']['type']  = 'id';

$config->my->ssh->dtable->fieldList['name']['name']  = 'title';
...
$config->my->ssh->dtable->fieldList['lastUsed']['name']  = 'lastUsed';
$config->my->ssh->dtable->fieldList['lastUsed']['title'] = $lang->my->lastUsed;
$config->my->ssh->dtable->fieldList['lastUsed']['type']  = 'text';

$config->my->doc->dtable->fieldList['actions']['name']     = 'actions';
$config->my->doc->dtable->fieldList['actions']['title']    = $lang->actions;
$config->my->doc->dtable->fieldList['actions']['type']     = 'actions';
$config->my->doc->dtable->fieldList['actions']['sortType'] = false;
$config->my->doc->dtable->fieldList['actions']['list']     = $config->my->ssh->actionList;
$config->my->doc->dtable->fieldList['actions']['menu']     = array('edit', 'delete');
