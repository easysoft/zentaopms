...
$config->my->testtask->dtable->fieldList['title']['link']  = helper::createLink('testcase', 'view', "taskID={id}");
...
$config->my->testtask->dtable->fieldList['build']['link']  = helper::createLink('build', 'view', "buildID={build}");
...
$config->my->bug->dtable->fieldList['title']['link']     = helper::createLink('bug', 'view', "bugID={id}");
...
$config->my->bug->dtable->fieldList['assignedTo']['assignLink'] = helper::createLink('bug', 'assignTo', 'bugID={id}');
...
$config->my->bug->dtable->fieldList['toTask']['link']   = helper::createLink('task', 'view', 'taskID={toTask}');
...
$config->my->bug->dtable->fieldList['story']['link']   = helper::createLink('story', 'view', 'storyID={story}');
...
$config->my->bug->dtable->fieldList['task']['link']   = helper::createLink('task', 'view', 'taskID={task}');
...
$config->my->doc->actionList['edit']['url']         = helper::createLink('doc', 'edit', "docID={id}&comment=false&from={$lang->navGroup->doc}");
...
$config->my->doc->actionList['delete']['url']  = helper::createLink('doc', 'delete', "docID={id}&confirm=no&from={$lang->navGroup->doc}");
