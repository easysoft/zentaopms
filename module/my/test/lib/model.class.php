...
class myModelTest extends baseTest
{
    ...
    {
        $objects = $this->instance->getProducts($type);
    ...
    {
        $objects = $this->instance->getDoingProjects();
    ...
    {
        $object = $this->instance->getOverview();
    ...
    {
        $objects = $this->instance->getContribute();
    ...
    {
        $objects = $this->instance->getActions();
    ...
    {
        $objects = $this->instance->getAssignedByMe($account, $pager, $orderBy, $objectType);
    ...
    {
        $objects = $this->instance->getTestcasesBySearch($queryID, $type, $orderBy, null);
    ...
    {
        $objects = $this->instance->getTasksBySearch($account, $limit, null);
    ...
    {
        $objects = $this->instance->getStoriesBySearch($queryID, $type, $orderBy, null);
    ...
    {
        $objects = $this->instance->getEpicsBySearch($queryID, $type, $orderBy);
    ...
    {
        $objects = $this->instance->getRequirementsBySearch($queryID, $type, $orderBy);
    ...
    {
        $flows = $this->instance->getFlowPairs();
    ...
    {
        $this->instance->buildTestcaseSearchForm($queryID, $actionURL);
    ...
    {
        return $this->instance->buildTaskSearchForm($queryID, $actionURL, $module, $cacheSearchFunc);
    }
    ...
    public function buildBugSearchFormTest(int $queryID, string $actionURL): array
    {
        ...
        $this->instance->buildBugSearchForm($queryID, $actionURL);
    ...
    {
        $this->instance->buildRiskSearchForm($queryID, $actionURL);
    ...
    {
        $this->instance->buildReviewissueSearchForm($queryID, $actionURL);
    ...
    {
        $objects = $this->instance->getRisksBySearch($queryID, $type, $orderBy , null);
    ...
    {
        $objects = $this->instance->getReviewissuesBySearch($queryID, $type, $orderBy , null);
    ...
    public function buildStorySearchFormTest(int $queryID, string $actionURL): array
    {
        ...
        $this->instance->buildStorySearchForm($queryID, $actionURL, 'story');
    ...
    public function buildRequirementSearchFormTest(int $queryID, string $actionURL): array
    {
        ...
        $this->instance->buildRequirementSearchForm($queryID, $actionURL);
    ...
    public function buildEpicSearchFormTest(int $queryID, string $actionURL): array
    {
        ...
        $this->instance->buildEpicSearchForm($queryID, $actionURL);
    ...
    public function buildTicketSearchFormTest(int $queryID, string $actionURL): bool
    {
        ...
        return $this->instance->buildTicketSearchForm($queryID, $actionURL);
    }
    ...
    {
        su($account);
        $return = $this->instance->getReviewingStories($orderBy, $checkExist);
    ...
    {
        su($account);
        $result = $this->instance->getReviewingMRs($orderBy);
        if(dao::isError()) return dao::getError();
    ...
    {
        su($account);
        $return = $this->instance->getReviewingCases($orderBy, $checkExist);
    ...
    {
        su($account);
        $return = $this->instance->getReviewingDemands($orderBy, $checkExist);
    ...
    {
        $return = $this->instance->getReviewingApprovals($orderBy, $checkExist);
    ...
    {
        $return = $this->instance->getReviewingFlows('all', $orderBy, $checkExist);
    ...
    {
        $return = $this->instance->getReviewingFeedbacks($orderBy, $checkExist);
    ...
    {
        $return = $this->instance->getReviewingOA($orderBy, $checkExist);
    ...
    {
        $return = $this->instance->getReviewedList($browseType, $orderBy);
    ...
    public function getReviewingTypeListTest(string $account): string|array
    {
        ...
        $menu = $this->instance->getReviewingTypeList();
    ...
    public function getReviewingListTest(string $account, string $browseType, string $orderBy, ?object $pager = null): string|array
    {
        ...
        $reviewList = $this->instance->getReviewingList($browseType, $orderBy, $pager);
    ...
    public function getProductRelatedDataTest(array $productKeys)
    {
        ...
        $result = $method->invokeArgs($this->instance, [$productKeys]);
        if(dao::isError()) return dao::getError();
    ...
    public function getTaskAssignedByMeTest(?object $pager = null, string $orderBy = 'id_desc', array $objectIdList = array())
    {
        ...
        $result = $method->invokeArgs($this->instance, [$pager, $orderBy, $objectIdList]);
        if(dao::isError()) return dao::getError();
    ...
    public function buildReviewedListTest(array $objectGroup, array $actions, array $flows)
    {
        ...
        $result = $method->invokeArgs($this->instance, [$objectGroup, $actions, $flows]);
        if(dao::isError()) return dao::getError();
