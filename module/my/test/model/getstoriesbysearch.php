...
- 测试获取 queryID 0 类型 contribute 排序 id_asc 的需求。 @1,13,17
...
r($my->getStoriesBySearchTest($queryID[0], $typeList[0], $orderBy[0])) && p() && e('17,13,1');   // 测试获取 queryID 0 类型 contribute 排序 id_desc 的需求。
r($my->getStoriesBySearchTest($queryID[0], $typeList[0], $orderBy[1])) && p() && e('1,13,17');   // 测试获取 queryID 0 类型 contribute 排序 id_asc 的需求。
