...
r(implode(',', $tasks3)) && p() && e('0');                  // 测试通过搜索获取用户 user1 的任务id
r(count($tasks3))        && p() && e('0');                  // 测试通过搜索获取用户 user1 的任务数量
r(implode(',', $tasks4)) && p() && e('0');                  // 测试通过搜索获取用户 user1 的任务id 限制5
r(count($tasks4))        && p() && e('0');                  // 测试通过搜索获取用户 user1 的任务数量 限制5
