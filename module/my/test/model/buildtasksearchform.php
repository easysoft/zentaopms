...
- module 为 workTask，缓存查询参数，打印 queryID 的值。属性queryID @~~
- module 为 workTask，缓存查询参数，打印 actionURL 的值。属性actionURL @~~
...
- module 为 contributeTask，缓存查询参数，打印 queryID 的值。属性queryID @~~
- module 为 contributeTask，缓存查询参数，打印 actionURL 的值。属性actionURL @~~
...
r($searchConfig)                                  && p('queryID')     && e('~~');          // module 为 workTask，缓存查询参数，打印 queryID 的值。
r($searchConfig)                                  && p('actionURL')   && e('~~');          // module 为 workTask，缓存查询参数，打印 actionURL 的值。
...
r($searchConfig['params']['module']['values'])    && p('0,1,2,3,4,5') && e('0,0,0,0,0,0'); // module 为 workTask，缓存查询参数，打印所属模块列表。
...
r($searchConfig['params']['module']['values'])    && p('0,1,2,3,4,5') && e('/,~~,/模块2,~~,~~,/模块5');      // module 为 workTask，不缓存查询参数，打印所属模块列表。
...
r($searchConfig)                                  && p('queryID')     && e('~~');          // module 为 contributeTask，缓存查询参数，打印 queryID 的值。
r($searchConfig)                                  && p('actionURL')   && e('~~');          // module 为 contributeTask，缓存查询参数，打印 actionURL 的值。
...
r($searchConfig['params']['module']['values'])    && p('0,1,2,3,4,5') && e('0,0,0,0,0,0'); // module 为 contributeTask，缓存查询参数，打印所属模块列表。
...
r($searchConfig['params']['module']['values'])    && p('0,1,2,3,4,5') && e('/,~~,/模块2,~~,~~,/模块5');      // 不缓存查询参数，module 为 contributeTask，打印所属模块列表。