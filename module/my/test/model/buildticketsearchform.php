...
r($my->buildTicketSearchFormTest($queryID[0], $actionURL[1])) && p() && e('0'); // 测试获取queryID 0 actionURL actionURL2 的搜索表单
r($my->buildTicketSearchFormTest($queryID[0], $actionURL[2])) && p() && e('0'); // 测试获取queryID 0 actionURL actionURL3 的搜索表单
r($my->buildTicketSearchFormTest($queryID[1], $actionURL[0])) && p() && e('0'); // 测试获取queryID 1 actionURL actionURL1 的搜索表单
r($my->buildTicketSearchFormTest($queryID[1], $actionURL[2])) && p() && e('0'); // 测试获取queryID 1 actionURL actionURL3 的搜索表单
