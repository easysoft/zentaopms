...
- 执行systemTest模块的deleteBackupTest方法，参数是$emptyInstance, 'test-backup-002'  @Array
- 执行systemTest模块的deleteBackupTest方法，参数是$validInstance, ''  @Array
...
r($systemTest->deleteBackupTest($emptyInstance, 'test-backup-002')) && p() && e('Array');
r($systemTest->deleteBackupTest($validInstance, '')) && p() && e('Array'); 
