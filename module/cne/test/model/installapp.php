...
- 执行cneTest模块的installAppWithDifferentChartTest方法 属性code @200
- 执行cneTest模块的installAppWithDifferentNamespaceTest方法 属性code @200
...
r($cneTest->installAppWithDifferentChartTest()) && p('code') && e('200');
r($cneTest->installAppWithDifferentNamespaceTest()) && p('code') && e('200');
