...
$lang->todo->create       = 'Add To-do';
$lang->todo->createCycle  = 'Add Recurring To-do';
$lang->todo->assignTo     = 'Assigned to';
$lang->todo->assignedDate = 'Assigned Date';
$lang->todo->assignAction = 'Assign To-do';
$lang->todo->start        = 'Start To-do';
$lang->todo->activate     = 'Activate To-do';
$lang->todo->batchCreate  = 'Batch Add ';
$lang->todo->edit         = 'Edit To-do';
$lang->todo->close        = 'Close To-do';
$lang->todo->batchClose   = 'Batch Close';
$lang->todo->batchEdit    = 'Batch Edit To-dos';
$lang->todo->view         = 'To-do Details';
$lang->todo->finish       = 'Complete To-do';
$lang->todo->batchFinish  = 'Batch Complete';
$lang->todo->export       = 'Export To-dos';
$lang->todo->delete       = 'Delete To-do';
...
$lang->todo->from         = 'From';
$lang->todo->generate     = 'Create To-do';
...
$lang->todo->beforeDays   = "<span class='input-group-addon'>Auto create the To-do</span>%s<span class='input-group-addon'>days in advance.</span>";
...
$lang->todo->confirmBug         = 'This To-do is linked to Bug #%s. Do you want to update it?';
$lang->todo->confirmTask        = 'This To-do is linked to Task #%s，Do you want to update it?';
$lang->todo->confirmStory       = 'This To-do is linked to Story #%s，Do you want to update it?';
$lang->todo->confirmEpic        = $lang->todo->confirmStory;
$lang->todo->confirmRequirement = $lang->todo->confirmStory;
$lang->todo->noOptions          = 'You have no %s To-do at the moment. Please reselect another To-do type.';
$lang->todo->summary            = 'Total To-dos: <strong>%s</strong>, Waiting: <strong>%s</strong>, Doing: <strong>%s</strong>.';
$lang->todo->checkedSummary     = 'Seleted To-dos: <strong>%total%</strong>, Waiting: <strong>%wait%</strong>, Doing: <strong>%doing%</strong>';
...
$lang->todo->confirmDelete  = 'Are you sure you want to delete this To-do?';
$lang->todo->thisIsPrivate  = 'This is a private To-do.';
$lang->todo->lblDisableDate = 'TBD';
$lang->todo->lblBeforeDays  = 'Create the To-do %s day(s) in advance.';
$lang->todo->lblClickCreate = 'Click to Add To-do';
$lang->todo->noTodo         = 'No To-dos available for this type.';
$lang->todo->noAssignedTo   = 'Assignee cannot be empty.';
$lang->todo->unfinishedTodo = 'To-do D%s is not completed and cannot be closed.';
$lang->todo->today          = 'To-do for Today';
$lang->todo->selectProduct  = "Please select a {$lang->productCommon}.";
$lang->todo->privateTip     = 'Only To-dos that I created and assigned to myself can be set as private. Once private, they are visible only to me.';
