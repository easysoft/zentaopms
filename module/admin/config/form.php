...
$defaultFeatures = array('myScore' => 0, 'productRoadmap' => 1, 'productTrack' => 1, 'productUR' => 1, 'otherDevops' => 1, 'otherKanban' => 1);
$config->admin->form->setmodule = array();
$config->admin->form->setmodule['module'] = array('type'=> 'array', 'required' => true, 'default' => $defaultFeatures);
