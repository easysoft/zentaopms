...
$lang->admin->register->registerTitle       = 'Join Us';
...
$lang->admin->register->uxPlanStatusTitle   = 'to help us improve. You can disable this in settings.';
$lang->admin->register->mobile              = 'phone number';
$lang->admin->register->smsCode             = 'Verification code';
$lang->admin->register->sendCode            = 'Get code';
...
$lang->admin->register->sure                = 'Confirm';
$lang->admin->register->unBindText          = 'Disconnect';
$lang->admin->register->welcome             = 'Welcome to the ZenTao community! Here you can explore:';
$lang->admin->register->welcomeForBound     = "You're joined the ZenTao community. Here you can access:";
$lang->admin->register->advantage1          = 'PM resources';
$lang->admin->register->advantage2          = 'Technical support';
$lang->admin->register->advantage3          = 'Demos';
$lang->admin->register->advantage4          = 'User manual';
$lang->admin->register->goCommunity         = 'Visit Community';
...
$lang->admin->register->unbindTitle         = 'Are you sure you want to disconnect from the ZenTao website?';
...
$lang->admin->register->unbindButton        = 'Disconnect';
