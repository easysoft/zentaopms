...
$config->company->user->dtable->fieldList['id']['sort']     = true;
...
$config->company->user->dtable->fieldList['realname']['sort']     = true;
$config->company->user->dtable->fieldList['realname']['group']    = '1';
...
$config->company->user->dtable->fieldList['account']['sort']     = true;
...
$config->company->user->dtable->fieldList['gender']['sort']     = true;
...
$config->company->user->dtable->fieldList['role']['sort']     = true;
...
$config->company->user->dtable->fieldList['phone']['sort']     = true;
...
if(!empty($this->config->isINT))
{
    ...
    $config->company->user->dtable->fieldList['skype']['sort']     = true;
...
else
{
    ...
    $config->company->user->dtable->fieldList['qq']['sort']     = true;
...
$config->company->user->dtable->fieldList['email']['sort']     = true;
...
$config->company->user->dtable->fieldList['last']['sort']     = 'date';
...
$config->company->user->dtable->fieldList['visits']['sort']     = 'number';
