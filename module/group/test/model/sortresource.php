...
- 测试步骤3：验证project模块方法的排序
 ...
 - 属性1 @browse
 - 属性2 @kanban
- 测试步骤4：验证排序后模块总数保持不变 @118
- 测试步骤5：验证product模块方法总数保持不变 @21
...
r(count((array)$resource)) && p() && e('118');                                             // 测试步骤4：验证排序后模块总数保持不变
r(count((array)$resource->product)) && p() && e('21');                                     // 测试步骤5：验证product模块方法总数保持不变