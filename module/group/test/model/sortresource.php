...
- 测试步骤3：验证project模块方法的排序
 ...
 - 属性1 @browse
 - 属性2 @kanban
- 测试步骤4：验证排序后模块总数与排序前一致 @1
- 测试步骤5：验证product模块方法总数与排序前一致 @1
...
$moduleCount  = count((array)$group->instance->lang->resource);
$productCount = count((array)$group->instance->lang->resource->product);
...
r(count((array)$resource) == $moduleCount) && p() && e('1');                               // 测试步骤4：验证排序后模块总数与排序前一致
r(count((array)$resource->product) == $productCount) && p() && e('1');                     // 测试步骤5：验证product模块方法总数与排序前一致
