...
<div id='mainMenu' class='clearfix'>
  ...
  <div class='btn-toolbar pull-right'>
    <?php if(common::hasPriv('group', 'permissionedit')) echo html::a($this->createLink('group', 'editManagePriv', '', '', false), '<i class="icon icon-backend muted" style="padding-right: 5px"></i>' . $lang->group->permissionedit, '', 'class="btn btn-link"');?>
