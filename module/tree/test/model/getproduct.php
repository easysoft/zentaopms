...
r($tree->getProductTest($moduleID[3])) && p('name') && e('正常产品1'); // 获取module 47 的产品
r($tree->getProductTest($moduleID[4])) && p('name') && e('0'); // 获取module 200 的产品