...
$lang->tree->manageProject      = "维护{$lang->executionCommon}视图模块";
...
$lang->tree->confirmRoot        = "模块的所属{$lang->productCommon}修改，会关联修改该模块下的{$lang->productSRCommon}、Bug、用例的所属{$lang->productCommon}，以及{$lang->executionCommon}和{$lang->productCommon}的关联关系。该操作比较危险，请谨慎操作。是否确认修改？";
...
$lang->tree->short      = '简称';
$lang->tree->all        = '所有模块';
$lang->tree->projectDoc = "{$lang->executionCommon}文档";
