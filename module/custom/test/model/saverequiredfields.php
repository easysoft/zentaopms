...
r($customTester->saveRequiredFieldsTest($moduleName[2], $requiredFields['executionFields1'], $fieldsType[0])) && p('value', ';') && e('name,code,begin,end');                              //测试moduleName为execution，requiredFields为空
r($customTester->saveRequiredFieldsTest($moduleName[2], $requiredFields['executionFields2'], $fieldsType[0])) && p('value', ';') && e('name,code,begin,end,desc');                         //测试moduleName为execution，requiredFields中的create存在一个值
r($customTester->saveRequiredFieldsTest($moduleName[2], $requiredFields['executionFields3'], $fieldsType[0])) && p('value', ';') && e('name,code,begin,end,desc,days');                    //测试moduleName为execution，requiredFields中的create存在多个值
r($customTester->saveRequiredFieldsTest($moduleName[2], $requiredFields['executionFields4'], $fieldsType[1])) && p('value', ';') && e('name,code,begin,end,desc');                         //测试moduleName为execution，requiredFields中的edit存在一个值
r($customTester->saveRequiredFieldsTest($moduleName[2], $requiredFields['executionFields5'], $fieldsType[1])) && p('value', ';') && e('name,code,begin,end,desc,days');                    //测试moduleName为execution，requiredFields中的edit存在多个值
r($customTester->saveRequiredFieldsTest($moduleName[2], $requiredFields['executionFields6'], $fieldsType[0])) && p('value', ';') && e('name,code,begin,end,desc,days');                    //测试moduleName为execution，requiredFields中的create,edit各存在多个值
...
r($customTester->saveRequiredFieldsTest($moduleName[4], $requiredFields['bugFields4'], $fieldsType[1]))       && p('value', ';') && e('title,plan');                                       //测试moduleName为bug，requiredFields中的edit存在一个值
r($customTester->saveRequiredFieldsTest($moduleName[4], $requiredFields['bugFields5'], $fieldsType[1]))       && p('value', ';') && e('title,plan,type');                                  //测试moduleName为bug，requiredFields中的edit存在多个值
