...
r($customTester->getFormFieldsTest($moduleName[2], $method[0]))   && p('desc')                     && e('描述');                                           // 测试moduleName值为productplan，method为空
r($customTester->getFormFieldsTest($moduleName[2], $method[1]))   && p('desc')                     && e('描述');                                           // 测试moduleName值为productplan，method为create
r($customTester->getFormFieldsTest($moduleName[2], $method[2]))   && p('desc')                     && e('描述');                                           // 测试moduleName值为productplan，method为edit
...
r($customTester->getFormFieldsTest($moduleName[6], $method[0]))   && p()                           && e('0');                                              // 测试moduleName值为build，method为空
...
r($customTester->getFormFieldsTest($moduleName[8], $method[1]))   && p('stage,pri')                && e('适用环节,优先级');                                // 测试moduleName值为testcase，method为create
r($customTester->getFormFieldsTest($moduleName[8], $method[2]))   && p('stage,pri')                && e('适用环节,优先级');                                // 测试moduleName值为testcase，method为edit
