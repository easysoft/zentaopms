  ...
  <form class="load-indicator main-form" method='post'>
    ...
    <table class='table table-form'>
      <tr>
        ...
        <td>
          <p>
            <label class="radio-inline"><input type="radio" name="mode" value="classic" <?php echo $mode == 'classic'? " checked='checked'" : ''?> id="modeclassic"><?php echo $lang->upgrade->to15Mode['classic'];?></label>
            <label class="radio-inline"><input type="radio" name="mode" value="new" <?php echo $mode == 'new'? " checked='checked'" : ''?> id="modenew"><?php echo $lang->upgrade->to15Mode['new'];?></label>
          </p>
