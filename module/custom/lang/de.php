...
1. For {$lang->productCommon}-based {$lang->projectCommon}s with {$lang->custom->executionCommon}: The following will not be editable under closed {$lang->projectCommon}s: {$lang->custom->executionCommon}, {$lang->SRCommon}s, design, reviews, review issues, baselines, documents, versions, releases, logs, testrequest, testreports, process trimming, research, estimation, issues, risks, opportunities, meetings, quality assurance plans, non-conformities, etc.<br/>
2. For {$lang->productCommon}-based {$lang->projectCommon}s without {$lang->custom->executionCommon}: The following will not be editable under closed {$lang->projectCommon}s: tasks, {$lang->SRCommon}s, versions, releases, logs, testrequest, testreports, documents, etc.<br/>
3. For non-{$lang->productCommon}-based {$lang->projectCommon}s with {$lang->custom->executionCommon} enabled: The following will not be editable under closed {$lang->projectCommon}s: {$lang->custom->executionCommon}, {$lang->SRCommon}s, design, reviews, review issues, baselines, bugs, testcases, testrequest, testreports, documents, versions, releases, logs, process trimming, research, estimation, issues, risks, opportunities, meetings, quality assurance plans, non-conformities, etc.<br/>
4. For non-{$lang->productCommon}-based {$lang->projectCommon}s without {$lang->custom->executionCommon} enabled: The following will not be editable under closed {$lang->projectCommon}s: tasks, {$lang->SRCommon}s, bugs, testcases, testrequest, testreports, documents, versions, releases, logs, etc.";
