...
$config->custom->canAdd['bug']         = 'priList,severityList,osList,browserList,typeList,resolutionList,subStatusList';
...
$config->custom->fieldList['productplan']            = 'desc';
...
$config->custom->fieldList['build']['create']        = 'scmPath,filePath,files,desc';
$config->custom->fieldList['build']['edit']          = 'scmPath,filePath,files,desc';
$config->custom->fieldList['bug']['create']          = 'module,plan,project,execution,assignedTo,deadline,type,subStatus,feedbackBy,os,browser,severity,pri,steps,keywords';
$config->custom->fieldList['bug']['edit']            = 'module,plan,project,execution,assignedTo,deadline,type,subStatus,feedbackBy,os,browser,severity,pri,steps,keywords';
