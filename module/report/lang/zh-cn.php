...
完成需求数：2024年创建的执行中研发需求个数求和，要求研发需求状态为已关闭、关闭原因为已完成，过滤已删除的研发需求。<br>
完成任务数：2024年创建的执行中任务个数求和，状态为已完成，过滤已删除的任务。<br>
修复Bug数：2024年创建的执行中状态为已关闭且解决方案为已解决的Bug数。';
$lang->report->tips->execution['dept'] = '
完成需求数：2024年创建的执行中研发需求个数求和，要求研发需求状态为已关闭、关闭原因为已完成，过滤已删除的研发需求，创建人为已选中的部门用户。<br>
完成任务数：2024年创建的执行中任务个数求和，状态为已完成，过滤已删除的任务，创建人为已选中的部门用户。<br>
修复Bug数：2024年创建的执行中状态为已关闭且解决方案为已解决的Bug数，创建人为已选中的部门用户。';
$lang->report->tips->execution['user'] = '
完成需求数：2024年创建的执行中研发需求个数求和，要求研发需求状态为已关闭、关闭原因为已完成，过滤已删除的研发需求，创建人为已选中的用户。<br>
完成任务数：2024年创建的执行中任务个数求和，状态为已完成，过滤已删除的任务，创建人为已选中的用户。<br>
修复Bug数：2024年创建的执行中状态为已关闭且解决方案为已解决的Bug数，创建人为已选中的用户。';
