...
验收通过的研发需求数：{year}年创建的执行中满足以下条件的研发需求个数求和，要求所处阶段为已验收、已发布或关闭原因为已完成的研发需求，过滤已删除的研发需求。<br>
完成任务数：{year}年创建的执行中任务个数求和，状态为已完成，过滤已删除的任务。<br>
修复Bug数：{year}年创建的执行，状态为已关闭且解决方案为已解决的Bug数。';
$lang->report->tips->execution['dept'] = '
验收通过的研发需求数：{year}年创建的执行中满足以下条件的研发需求个数求和，要求所处阶段为已验收、已发布或关闭原因为已完成的研发需求，过滤已删除的研发需求，创建人为已选中的部门用户。<br>
...
验收通过的研发需求数：{year}年创建的执行中满足以下条件的研发需求个数求和，要求所处阶段为已验收、已发布或关闭原因为已完成的研发需求，过滤已删除的研发需求，创建人为已选中的用户。<br>
