...
$config->report->annualData['radar']['project']['create']     = array('project');
$config->report->annualData['radar']['project']['edit']       = array('project');
$config->report->annualData['radar']['project']['start']      = array('project');
$config->report->annualData['radar']['project']['close']      = array('project');
$config->report->annualData['radar']['build']['create']       = array('project');
$config->report->annualData['radar']['task']['create']        = array('project', 'devel');
$config->report->annualData['radar']['task']['assign']        = array('project', 'devel');
$config->report->annualData['radar']['task']['close']         = array('project', 'devel');
$config->report->annualData['radar']['task']['activate']      = array('project');
