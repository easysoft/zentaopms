...
- 执行reportTest模块的getContributionCountTipsTest方法，参数是'invalid'  @全公司在已选年份的贡献数据，包含：<br>任务：创建、完成、关闭、取消、指派<br>研发需求：创建、评审、关闭、指派<br>用户需求：创建、评审、关闭、指派<br>业务需求：创建、评审、关闭、指派<br>Bug：创建、解决、关闭、指派<br>用例：创建<br>测试单：关闭<br>文档：创建、编辑<br>
- 执行reportTest模块的getContributionCountTipsTest方法，参数是null  @全公司在已选年份的贡献数据，包含：<br>任务：创建、完成、关闭、取消、指派<br>研发需求：创建、评审、关闭、指派<br>用户需求：创建、评审、关闭、指派<br>业务需求：创建、评审、关闭、指派<br>Bug：创建、解决、关闭、指派<br>用例：创建<br>测试单：关闭<br>文档：创建、编辑<br>
...
r($reportTest->getContributionCountTipsTest('invalid')) && p() && e('全公司在已选年份的贡献数据，包含：<br>任务：创建、完成、关闭、取消、指派<br>研发需求：创建、评审、关闭、指派<br>用户需求：创建、评审、关闭、指派<br>业务需求：创建、评审、关闭、指派<br>Bug：创建、解决、关闭、指派<br>用例：创建<br>测试单：关闭<br>文档：创建、编辑<br>');
r($reportTest->getContributionCountTipsTest(null)) && p() && e('全公司在已选年份的贡献数据，包含：<br>任务：创建、完成、关闭、取消、指派<br>研发需求：创建、评审、关闭、指派<br>用户需求：创建、评审、关闭、指派<br>业务需求：创建、评审、关闭、指派<br>Bug：创建、解决、关闭、指派<br>用例：创建<br>测试单：关闭<br>文档：创建、编辑<br>');