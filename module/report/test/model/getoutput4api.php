...
r($report->getOutput4APITest($account[0])) && p() && e('story:18;task:17;bug:7;case:9;');   // 测试获取 admin 的输出
r($report->getOutput4APITest($account[1])) && p() && e('task:8;bug:7;case:3;');             // 测试获取 dev17 的输出
r($report->getOutput4APITest($account[2])) && p() && e('story:9;task:8;bug:15;case:3;');    // 测试获取 test18 的输出
r($report->getOutput4APITest($account[3])) && p() && e('story:18;task:25;bug:14;case:12;'); // 测试获取 admin,dev17 的输出
r($report->getOutput4APITest($account[4])) && p() && e('story:27;task:25;bug:22;case:12;'); // 测试获取 admin,test18 的输出
r($report->getOutput4APITest($account[5])) && p() && e('story:27;task:33;bug:29;case:58;'); // 测试获取 所有用户 的输出
