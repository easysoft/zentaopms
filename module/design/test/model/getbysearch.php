...
- 测试projectID=11, productID=0, queryID=0时，按照id倒序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID=0时，按照id正序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID=0时，按照标题正序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID=0时，按照标题倒序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID=1时，按照id倒序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID=1时，按照id正序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID=1时，按照标题正序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID=1时，按照标题倒序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID不存在时，按照id倒序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID不存在时，按照id正序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID不存在时，按照标题正序排列的设计列表数据 @0
- 测试projectID=11, productID=0, queryID不存在时，按照标题倒序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID=0时，按照id倒序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID=0时，按照id正序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID=0时，按照标题正序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID=0时，按照标题倒序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID=1时，按照id倒序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID=1时，按照id正序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID=1时，按照标题正序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID=1时，按照标题倒序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID不存在时，按照id倒序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID不存在时，按照id正序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID不存在时，按照标题正序排列的设计列表数据 @0
- 测试projectID=11, productID=1, queryID不存在时，按照标题倒序排列的设计列表数据 @0
...
r($designTester->getBySearchTest($projects[1], $products[0], $queries[0], $sorts[0])) && p() && e('0'); // 测试projectID=11, productID=0, queryID=0时，按照id倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[0], $sorts[1])) && p() && e('0'); // 测试projectID=11, productID=0, queryID=0时，按照id正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[0], $sorts[2])) && p() && e('0'); // 测试projectID=11, productID=0, queryID=0时，按照标题正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[0], $sorts[3])) && p() && e('0'); // 测试projectID=11, productID=0, queryID=0时，按照标题倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[1], $sorts[0])) && p() && e('0'); // 测试projectID=11, productID=0, queryID=1时，按照id倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[1], $sorts[1])) && p() && e('0'); // 测试projectID=11, productID=0, queryID=1时，按照id正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[1], $sorts[2])) && p() && e('0'); // 测试projectID=11, productID=0, queryID=1时，按照标题正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[1], $sorts[3])) && p() && e('0'); // 测试projectID=11, productID=0, queryID=1时，按照标题倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[2], $sorts[0])) && p() && e('0'); // 测试projectID=11, productID=0, queryID不存在时，按照id倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[2], $sorts[1])) && p() && e('0'); // 测试projectID=11, productID=0, queryID不存在时，按照id正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[2], $sorts[2])) && p() && e('0'); // 测试projectID=11, productID=0, queryID不存在时，按照标题正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[0], $queries[2], $sorts[3])) && p() && e('0'); // 测试projectID=11, productID=0, queryID不存在时，按照标题倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[0], $sorts[0])) && p() && e('0'); // 测试projectID=11, productID=1, queryID=0时，按照id倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[0], $sorts[1])) && p() && e('0'); // 测试projectID=11, productID=1, queryID=0时，按照id正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[0], $sorts[2])) && p() && e('0'); // 测试projectID=11, productID=1, queryID=0时，按照标题正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[0], $sorts[3])) && p() && e('0'); // 测试projectID=11, productID=1, queryID=0时，按照标题倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[1], $sorts[0])) && p() && e('0'); // 测试projectID=11, productID=1, queryID=1时，按照id倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[1], $sorts[1])) && p() && e('0'); // 测试projectID=11, productID=1, queryID=1时，按照id正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[1], $sorts[2])) && p() && e('0'); // 测试projectID=11, productID=1, queryID=1时，按照标题正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[1], $sorts[3])) && p() && e('0'); // 测试projectID=11, productID=1, queryID=1时，按照标题倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[2], $sorts[0])) && p() && e('0'); // 测试projectID=11, productID=1, queryID不存在时，按照id倒序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[2], $sorts[1])) && p() && e('0'); // 测试projectID=11, productID=1, queryID不存在时，按照id正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[2], $sorts[2])) && p() && e('0'); // 测试projectID=11, productID=1, queryID不存在时，按照标题正序排列的设计列表数据
r($designTester->getBySearchTest($projects[1], $products[1], $queries[2], $sorts[3])) && p() && e('0'); // 测试projectID=11, productID=1, queryID不存在时，按照标题倒序排列的设计列表数据
