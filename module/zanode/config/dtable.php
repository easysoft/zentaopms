...
$config->zanode->snapshotDtable->fieldList['actions']['list']['restoreSnapshot']['class']        = 'ajax-submit';
...
$config->zanode->snapshotDtable->fieldList['actions']['list']['restoreSnapshot']['data-confirm'] = $lang->zanode->confirmRestore;
