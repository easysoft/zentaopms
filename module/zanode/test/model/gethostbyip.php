...
r($zanode->getHostByIP($ipList[0])) && p('id,type,extranet') && e('1,normal,10.0.0.1');     //判断ip为10.0.0.1的主机是否存在,并返回id,type,extranet
r($zanode->getHostByIP($ipList[1])) && p('id,type,extranet') && e('10,normal,10.0.0.10');   //判断ip为10.0.0.10的主机是否存在,并返回id,type,extranet
