...
$config->api->form->createLib['baseUrl']   = array('type' => 'string', 'required' => false, 'default' => 'open');
$config->api->form->createLib['acl']       = array('type' => 'string', 'required' => false, 'default' => '', 'control' => 'editor');
