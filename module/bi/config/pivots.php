...
EOT,
    ...
    'fields'    => array
    (
        'id'               => array('object' => 'story', 'field' => 'id', 'type' => 'number'),
        'vision'           => array('object' => 'project', 'field' => '', 'type' => 'string'),
        'parent'           => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'isParent'         => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'root'             => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'path'             => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'grade'            => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'product'          => array('object' => 'product', 'field' => 'name', 'type' => 'object'),
        'branch'           => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'module'           => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'plan'             => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'source'           => array('object' => 'story', 'field' => 'source', 'type' => 'option'),
        'sourceNote'       => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'fromBug'          => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'feedback'         => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'title'            => array('object' => 'story', 'field' => 'title', 'type' => 'string'),
        'keywords'         => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'type'             => array('object' => 'story', 'field' => 'type', 'type' => 'option'),
        'category'         => array('object' => 'story', 'field' => 'category', 'type' => 'option'),
        'pri'              => array('object' => 'story', 'field' => 'pri', 'type' => 'option'),
        'estimate'         => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'status'           => array('object' => 'story', 'field' => 'status', 'type' => 'option'),
        'subStatus'        => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'color'            => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'stage'            => array('object' => 'story', 'field' => 'stage', 'type' => 'option'),
        'stagedBy'         => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'mailto'           => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'lib'              => array('object' => 'project', 'field' => '', 'type' => 'object'),
        'fromStory'        => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'fromVersion'      => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'openedBy'         => array('object' => 'story', 'field' => 'openedBy', 'type' => 'user'),
        'openedDate'       => array('object' => 'story', 'field' => 'openedDate', 'type' => 'date'),
        'assignedTo'       => array('object' => 'story', 'field' => 'assignedTo', 'type' => 'user'),
        'assignedDate'     => array('object' => 'story', 'field' => '', 'type' => 'date'),
        'approvedDate'     => array('object' => 'project', 'field' => '', 'type' => 'date'),
        'lastEditedBy'     => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'lastEditedDate'   => array('object' => 'story', 'field' => '', 'type' => 'date'),
        'changedBy'        => array('object' => 'story', 'field' => 'changedBy', 'type' => 'user'),
        'changedDate'      => array('object' => 'story', 'field' => '', 'type' => 'date'),
        'reviewedBy'       => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'reviewedDate'     => array('object' => 'story', 'field' => '', 'type' => 'date'),
        'releasedDate'     => array('object' => 'project', 'field' => '', 'type' => 'date'),
        'closedBy'         => array('object' => 'story', 'field' => 'closedBy', 'type' => 'user'),
        'closedDate'       => array('object' => 'story', 'field' => 'closedDate', 'type' => 'date'),
        'closedReason'     => array('object' => 'story', 'field' => 'closedReason', 'type' => 'option'),
        'activatedDate'    => array('object' => 'story', 'field' => '', 'type' => 'date'),
        'toBug'            => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'linkStories'      => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'linkRequirements' => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'twins'            => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'duplicateStory'   => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'version'          => array('object' => 'story', 'field' => '', 'type' => 'number'),
        'parentVersion'    => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'demandVersion'    => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'storyChanged'     => array('object' => 'project', 'field' => '', 'type' => 'string'),
        'feedbackBy'       => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'notifyEmail'      => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'BSA'              => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'duration'         => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'demand'           => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'submitedBy'       => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'roadmap'          => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'URChanged'        => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'unlinkReason'     => array('object' => 'project', 'field' => '', 'type' => 'string'),
        'retractedReason'  => array('object' => 'project', 'field' => '', 'type' => 'string'),
        'retractedBy'      => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'retractedDate'    => array('object' => 'story', 'field' => '', 'type' => 'date'),
        'deleted'          => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'name'             => array('object' => 'product', 'field' => 'name', 'type' => 'string')
    ),
    'langs'     => array
    (
        'id'               => array('zh-cn' => 'id', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'vision'           => array('zh-cn' => 'vision', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'parent'           => array('zh-cn' => 'parent', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'isParent'         => array('zh-cn' => '是父需求', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'root'             => array('zh-cn' => 'root', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'path'             => array('zh-cn' => '路径', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'grade'            => array('zh-cn' => '需求层级', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'product'          => array('zh-cn' => '产品名称', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'branch'           => array('zh-cn' => 'branch', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'module'           => array('zh-cn' => 'module', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'plan'             => array('zh-cn' => 'plan', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'source'           => array('zh-cn' => 'source', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'sourceNote'       => array('zh-cn' => 'sourceNote', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'fromBug'          => array('zh-cn' => 'fromBug', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'feedback'         => array('zh-cn' => 'feedback', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'title'            => array('zh-cn' => 'title', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'keywords'         => array('zh-cn' => 'keywords', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'type'             => array('zh-cn' => 'type', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'category'         => array('zh-cn' => 'category', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'pri'              => array('zh-cn' => 'pri', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'estimate'         => array('zh-cn' => 'estimate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'status'           => array('zh-cn' => '不同状态需求', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'subStatus'        => array('zh-cn' => 'subStatus', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'color'            => array('zh-cn' => 'color', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'stage'            => array('zh-cn' => 'stage', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'stagedBy'         => array('zh-cn' => 'stagedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'mailto'           => array('zh-cn' => 'mailto', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'lib'              => array('zh-cn' => 'lib', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'fromStory'        => array('zh-cn' => 'fromStory', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'fromVersion'      => array('zh-cn' => 'fromVersion', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'openedBy'         => array('zh-cn' => 'openedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'openedDate'       => array('zh-cn' => 'openedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'assignedTo'       => array('zh-cn' => 'assignedTo', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'assignedDate'     => array('zh-cn' => 'assignedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'approvedDate'     => array('zh-cn' => 'approvedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'lastEditedBy'     => array('zh-cn' => 'lastEditedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'lastEditedDate'   => array('zh-cn' => 'lastEditedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'changedBy'        => array('zh-cn' => 'changedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'changedDate'      => array('zh-cn' => 'changedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'reviewedBy'       => array('zh-cn' => 'reviewedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'reviewedDate'     => array('zh-cn' => 'reviewedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'releasedDate'     => array('zh-cn' => 'releasedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'closedBy'         => array('zh-cn' => 'closedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'closedDate'       => array('zh-cn' => 'closedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'closedReason'     => array('zh-cn' => 'closedReason', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'activatedDate'    => array('zh-cn' => 'activatedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'toBug'            => array('zh-cn' => 'toBug', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'linkStories'      => array('zh-cn' => 'linkStories', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'linkRequirements' => array('zh-cn' => 'linkRequirements', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'twins'            => array('zh-cn' => 'twins', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'duplicateStory'   => array('zh-cn' => 'duplicateStory', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'version'          => array('zh-cn' => 'version', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'parentVersion'    => array('zh-cn' => '父版本', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'demandVersion'    => array('zh-cn' => 'demandVersion', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'storyChanged'     => array('zh-cn' => 'storyChanged', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'feedbackBy'       => array('zh-cn' => 'feedbackBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'notifyEmail'      => array('zh-cn' => 'notifyEmail', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'BSA'              => array('zh-cn' => 'BSA', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'duration'         => array('zh-cn' => '管理周期', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'demand'           => array('zh-cn' => 'demand', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'submitedBy'       => array('zh-cn' => '提交评审人', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'roadmap'          => array('zh-cn' => '所属路标', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'URChanged'        => array('zh-cn' => 'URChanged', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'unlinkReason'     => array('zh-cn' => 'unlinkReason', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'retractedReason'  => array('zh-cn' => 'retractedReason', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'retractedBy'      => array('zh-cn' => '由谁撤销', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'retractedDate'    => array('zh-cn' => '撤销时间', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'deleted'          => array('zh-cn' => 'deleted', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'name'             => array('zh-cn' => 'name', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => '')
    ),
    'vars'      => array(),
    'drills'    => array
...
EOT,
    ...
    (
        ...
        'stagedBy'         => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'mailto'           => array('object' => 'story', 'field' => '', 'type' => 'string'),
        'lib'              => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'fromStory'        => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'fromVersion'      => array('object' => 'project', 'field' => '', 'type' => 'number'),
        'openedBy'         => array('object' => 'story', 'field' => 'openedBy', 'type' => 'user'),
        'openedDate'       => array('object' => 'story', 'field' => 'openedDate', 'type' => 'date'),
    ...
    (
        ...
        'pri'              => array('zh-cn' => 'pri', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'estimate'         => array('zh-cn' => 'estimate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'status'           => array('zh-cn' => 'status', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'subStatus'        => array('zh-cn' => 'subStatus', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'color'            => array('zh-cn' => 'color', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
...
select
    ...
    (case when t4.multiple='1' then t1.id else '' end) as execution,
...
EOT,
    ...
    (
        ...
        'executionname' => array('object' => 'team', 'field' => '', 'type' => 'string'),
        'execution'     => array('object' => 'project', 'field' => 'name', 'type' => 'string'),
    ...
    (
        ...
        (
            'field'     => 'taskID',
            'object'    => 'task',
            'whereSql'  => "left join zt_project t2 on t1.execution=t2.id WHERE t1.deleted='0'  and (case when \$project='' then 1 else t1.project=\$project end)  and (case when \$status='' then 1 else t2.status=\$status end)  and (case when \$beginDate='' then 1 else t2.begin>=\$beginDate end)  and (case when \$endDate='' then 1 else t2.end<=\$endDate end)",
            'condition' => array
            (
                array('drillObject' => 'zt_task', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'execution'),
...
select
    ...
    (case when t5.multiple='1' then t1.id else '' end) as execution,
...
EOT,
    ...
    (
        ...
        (
            ...
            'condition' => array
            (
                array('drillObject' => 'zt_projectstory', 'drillAlias' => 't2', 'drillField' => 'project', 'queryField' => 'execution'),
                array('drillObject' => 'zt_story', 'drillAlias' => 't1', 'drillField' => 'status', 'queryField' => 'status')
            )
        )
    ),
...
select
    ...
    (case when t3.multiple='1' then t1.id else '' end) as executionID,
    t2.id as bugID,
    t2.status
from zt_project as t1
left join zt_bug as t2 on t1.id=t2.execution
...
EOT,
    ...
    (
        'id'          => array('object' => 'project', 'field' => 'id', 'type' => 'number'),
        'project'     => array('object' => 'project', 'field' => '', 'type' => 'string'),
        'projectID'   => array('object' => 'project', 'field' => 'name', 'type' => 'number'),
        'execution'   => array('object' => 'project', 'field' => '', 'type' => 'string'),
    ...
    (
        'id'          => array('zh-cn' => 'id', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'project'     => array('zh-cn' => '项目', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'projectID'   => array('zh-cn' => '项目名称', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'execution'   => array('zh-cn' => '执行', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'executionID' => array('zh-cn' => '执行名称', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'bugID'       => array('zh-cn' => 'bugID', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
    ...
    (
        ...
        (
            'field'     => 'status',
            'object'    => 'bug',
            'whereSql'  => "left join zt_project as t2 on t2.id=t1.execution  left join zt_project as t3 on t3.id=t1.project WHERE t1.deleted='0'  and (case when \$project='' then 1 else t3.id=\$project end)  and (case when \$execution='' then 1 else t1.id=\$execution end)",
            'condition' => array
            (
                array('drillObject' => 'zt_bug', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'executionID'),
...
EOT,
    ...
    (
        ...
        (
            'field'     => 'assignedTo',
            'object'    => 'bug',
            'whereSql'  => "left join zt_project as t2 on t1. project=t2.id left join zt_project as t3 on t1. execution=t3.id WHERE t1.deleted='0'  and (case when \$project='' then 1 else t2.id=\$project end)  and (case when \$execution='' then 1 else t3.id=\$execution end) ",
            'condition' => array
            (
                array('drillObject' => 'zt_bug', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'executionID'),
                array('drillObject' => 'zt_bug', 'drillAlias' => 't1', 'drillField' => 'assignedTo', 'queryField' => 'assignedTo'),
                array('drillObject' => 'zt_bug', 'drillAlias' => 't1', 'drillField' => 'project', 'queryField' => 'projectID')
            )
        ),
        array
        (
...
EOT,
    ...
    (
        ...
        (
            'field'     => 'doneStory',
            'object'    => 'story',
            'whereSql'  => "right join zt_projectstory as t2 on t2.story=t1.id left join zt_project as t3 on t2.project=t3.id  left join zt_project as t4 on t4.id=t3.project  where t3.deleted='0' and t3.type in ('sprint','stage') and t1.deleted='0' and t1.status='closed' and (case when \$project='' then 1 else t4.id=\$project end)  and (case when \$execution='' then 1 else t3.id=\$execution end)  and (case when \$status='' then 1 else t3.status=\$status end)",
            'condition' => array
            (
                array('drillObject' => 'zt_project', 'drillAlias' => 't3', 'drillField' => 'id', 'queryField' => 'execution')
            )
        ...
        (
            'field'     => 'number',
            'object'    => 'task',
            'whereSql'  => "left join zt_project as t2 on t1.execution = t2.id left join zt_project as t3 on t3.id=t2.project  where t2.deleted='0' and t1.deleted='0' and t2.type in ('sprint','stage')  and (case when \$project='' then 1 else t3.id=\$project end)  and (case when \$execution='' then 1 else t2.id=\$execution end)  and (case when \$status='' then 1 else t2.status=\$status end)",
            'condition' => array
            (
                array('drillObject' => 'zt_task', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'execution')
            )
        ...
        (
            'field'     => 'doneTask',
            'object'    => 'task',
            'whereSql'  => "left join zt_project as t2 on t1.execution = t2.id left join zt_project as t3 on t3.id=t2.project  where t2.deleted='0' and t1.deleted='0' and t1.status in ('closed','done') and t2.type in ('sprint','stage')  and (case when \$project='' then 1 else t3.id=\$project end)  and (case when \$execution='' then 1 else t2.id=\$execution end)  and (case when \$status='' then 1 else t2.status=\$status end)",
            'condition' => array
            (
                array('drillObject' => 'zt_task', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'execution')
            )
        ...
        (
            'field'     => 'bugs',
            'object'    => 'bug',
            'whereSql'  => "left join zt_project as t2 on t1.execution = t2.id left join zt_project as t3 on t3.id=t2.project  where t2.deleted='0' and t1.deleted='0' and (case when \$project='' then 1 else t3.id=\$project end)  and (case when \$execution='' then 1 else t2.id=\$execution end)  and (case when \$status='' then 1 else t2.status=\$status end)",
            'condition' => array
            (
                array('drillObject' => 'zt_bug', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'execution')
            )
        ...
        (
            'field'     => 'resolutions',
            'object'    => 'bug',
            'whereSql'  => "left join zt_project as t2 on t1.execution = t2.id left join zt_project as t3 on t3.id=t2.project  where t2.deleted='0' and t1.deleted='0' and t1.resolution !=' ' and (case when \$project='' then 1 else t3.id=\$project end)  and (case when \$execution='' then 1 else t2.id=\$execution end)  and (case when \$status='' then 1 else t2.status=\$status end)",
            'condition' => array
            (
                array('drillObject' => 'zt_bug', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'execution')
            )
        ...
        (
            'field'     => 'seriousBugs',
            'object'    => 'bug',
            'whereSql'  => "left join zt_project as t2 on t1.execution = t2.id left join zt_project as t3 on t3.id=t2.project  where t2.deleted='0' and t1.deleted='0' and t1.severity<='2' and (case when \$project='' then 1 else t3.id=\$project end)  and (case when \$execution='' then 1 else t2.id=\$execution end)  and (case when \$status='' then 1 else t2.status=\$status end)",
            'condition' => array
            (
                array('drillObject' => 'zt_bug', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'execution')
            )
...
EOT,
    ...
    (
        ...
        (
            ...
            'condition' => array
            (
                array('drillObject' => 'zt_story', 'drillAlias' => 't1', 'drillField' => 'product', 'queryField' => 'id')
            )
        ),
        array
        (
            'field'     => 'doneStory',
            'object'    => 'story',
            'whereSql'  => "where t1.deleted='0' and t1.status='closed'",
            'condition' => array
            (
                array('drillObject' => 'zt_story', 'drillAlias' => 't1', 'drillField' => 'product', 'queryField' => 'id')
            )
        ...
        (
            'field'     => 'seriousBugs',
            'object'    => 'bug',
            'whereSql'  => "where t1.deleted and t1.severity<='2'",
            'condition' => array
            (
                array('drillObject' => 'zt_bug', 'drillAlias' => 't1', 'drillField' => 'product', 'queryField' => 'id')
            )
...
EOT,
    ...
    'filters'   => array
    (
        array('from' => 'query', 'field' => 'startDate', 'name' => '起始时间', 'type' => 'date', 'typeOption' => '', 'default' => '2024-07-01'),
        array('from' => 'query', 'field' => 'endDate', 'name' => '结束时间', 'type' => 'date', 'typeOption' => '', 'default' => '2024-07-30')
    ),
    'fields'    => array
    (
    ...
    (
        ...
        'day'   => array('name' => 'day', 'zh-cn' => 'day', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => '')
    ),
    'vars'      => array
    (
...
EOT,
    ...
    (
        ...
        'dept'     => array('name' => 'dept', 'zh-cn' => 'dept', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => '')
    ),
    'vars'      => array
    (
    ...
    (
        ...
        (
            'field'     => 'consumed',
            'object'    => 'effort',
            'whereSql'  => "left join zt_user as t2 on t1.account = t2.account left join zt_dept as t3 on t2.dept = t3.id where t1.`deleted` = '0' and (case when \$startDate='' then 1 else cast(t1.`date` as date) >= cast(\$startDate as date) end) and (case when \$endDate='' then 1 else cast(t1.`date` as date) <= cast(\$endDate as date) end) and (case when \$dept='' then 1 else t3.path like concat((select path from zt_dept where id=coalesce(cast(nullif(\$dept, '') as integer), 0)), '%') end) order by t1.`date` asc",
            'condition' => array
            (
...
EOT,
    ...
    'fields'    => array
    (
        'id'             => array('object' => 'bug', 'field' => 'id', 'type' => 'number'),
        'project'        => array('object' => 'bug', 'field' => 'project', 'type' => 'string'),
        'product'        => array('object' => 'bug', 'field' => 'product', 'type' => 'string'),
        'injection'      => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'identify'       => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'branch'         => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'module'         => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'execution'      => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'plan'           => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'story'          => array('object' => 'bug', 'field' => 'story', 'type' => 'string'),
        'storyVersion'   => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'task'           => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'toTask'         => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'toStory'        => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'title'          => array('object' => 'bug', 'field' => 'title', 'type' => 'string'),
        'keywords'       => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'severity'       => array('object' => 'bug', 'field' => 'severity', 'type' => 'option'),
        'pri'            => array('object' => 'bug', 'field' => 'pri', 'type' => 'option'),
        'type'           => array('object' => 'bug', 'field' => 'type', 'type' => 'option'),
        'os'             => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'browser'        => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'hardware'       => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'found'          => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'steps'          => array('object' => 'bug', 'field' => 'steps', 'type' => 'text'),
        'status'         => array('object' => 'bug', 'field' => 'status', 'type' => 'option'),
        'subStatus'      => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'color'          => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'confirmed'      => array('object' => 'bug', 'field' => 'confirmed', 'type' => 'option'),
        'activatedCount' => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'activatedDate'  => array('object' => 'bug', 'field' => '', 'type' => 'date'),
        'feedbackBy'     => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'notifyEmail'    => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'mailto'         => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'openedBy'       => array('object' => 'bug', 'field' => 'openedBy', 'type' => 'user'),
        'openedDate'     => array('object' => 'bug', 'field' => 'openedDate', 'type' => 'date'),
        'openedBuild'    => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'assignedTo'     => array('object' => 'bug', 'field' => 'assignedTo', 'type' => 'user'),
        'assignedDate'   => array('object' => 'bug', 'field' => 'assignedDate', 'type' => 'date'),
        'deadline'       => array('object' => 'bug', 'field' => '', 'type' => 'date'),
        'resolvedBy'     => array('object' => 'bug', 'field' => 'resolvedBy', 'type' => 'user'),
        'resolution'     => array('object' => 'bug', 'field' => 'resolution', 'type' => 'option'),
        'resolvedBuild'  => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'resolvedDate'   => array('object' => 'bug', 'field' => 'resolvedDate', 'type' => 'date'),
        'closedBy'       => array('object' => 'bug', 'field' => 'closedBy', 'type' => 'user'),
        'closedDate'     => array('object' => 'bug', 'field' => 'closedDate', 'type' => 'date'),
        'duplicateBug'   => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'relatedBug'     => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'case'           => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'caseVersion'    => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'feedback'       => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'result'         => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'repo'           => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'mr'             => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'entry'          => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'lines'          => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'v1'             => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'v2'             => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'repoType'       => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'issueKey'       => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'testtask'       => array('object' => 'bug', 'field' => '', 'type' => 'number'),
        'lastEditedBy'   => array('object' => 'bug', 'field' => '', 'type' => 'string'),
        'lastEditedDate' => array('object' => 'bug', 'field' => '', 'type' => 'date'),
        'deleted'        => array('object' => 'bug', 'field' => '', 'type' => 'string')
    ),
    'langs'     => array
    (
        'id'             => array('zh-cn' => ' bugID', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'project'        => array('zh-cn' => 'project', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'product'        => array('zh-cn' => 'product', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'injection'      => array('zh-cn' => 'injection', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'identify'       => array('zh-cn' => 'identify', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'branch'         => array('zh-cn' => 'branch', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'module'         => array('zh-cn' => 'module', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'execution'      => array('zh-cn' => 'execution', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'plan'           => array('zh-cn' => 'plan', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'story'          => array('zh-cn' => 'story', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'storyVersion'   => array('zh-cn' => 'storyVersion', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'task'           => array('zh-cn' => 'task', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'toTask'         => array('zh-cn' => 'toTask', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'toStory'        => array('zh-cn' => 'toStory', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'title'          => array('zh-cn' => 'title', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'keywords'       => array('zh-cn' => 'keywords', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'severity'       => array('zh-cn' => 'severity', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'pri'            => array('zh-cn' => 'pri', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'type'           => array('zh-cn' => 'type', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'os'             => array('zh-cn' => 'os', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'browser'        => array('zh-cn' => 'browser', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'hardware'       => array('zh-cn' => 'hardware', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'found'          => array('zh-cn' => 'found', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'steps'          => array('zh-cn' => 'steps', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'status'         => array('zh-cn' => 'status', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'subStatus'      => array('zh-cn' => 'subStatus', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'color'          => array('zh-cn' => 'color', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'confirmed'      => array('zh-cn' => 'confirmed', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'activatedCount' => array('zh-cn' => 'activatedCount', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'activatedDate'  => array('zh-cn' => 'activatedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'feedbackBy'     => array('zh-cn' => 'feedbackBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'notifyEmail'    => array('zh-cn' => 'notifyEmail', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'mailto'         => array('zh-cn' => 'mailto', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'openedBy'       => array('zh-cn' => 'openedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'openedDate'     => array('zh-cn' => 'openedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'openedBuild'    => array('zh-cn' => 'openedBuild', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'assignedTo'     => array('zh-cn' => 'assignedTo', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'assignedDate'   => array('zh-cn' => 'assignedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'deadline'       => array('zh-cn' => 'deadline', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'resolvedBy'     => array('zh-cn' => '解决者', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'resolution'     => array('zh-cn' => '不同解决方案的Bug', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'resolvedBuild'  => array('zh-cn' => 'resolvedBuild', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'resolvedDate'   => array('zh-cn' => 'resolvedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'closedBy'       => array('zh-cn' => 'closedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'closedDate'     => array('zh-cn' => 'closedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'duplicateBug'   => array('zh-cn' => 'duplicateBug', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'relatedBug'     => array('zh-cn' => '相关Bug', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'case'           => array('zh-cn' => 'case', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'caseVersion'    => array('zh-cn' => 'caseVersion', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'feedback'       => array('zh-cn' => 'feedback', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'result'         => array('zh-cn' => 'result', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'repo'           => array('zh-cn' => 'repo', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'mr'             => array('zh-cn' => 'mr', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'entry'          => array('zh-cn' => 'entry', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'lines'          => array('zh-cn' => 'lines', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'v1'             => array('zh-cn' => 'v1', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'v2'             => array('zh-cn' => 'v2', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'repoType'       => array('zh-cn' => 'repoType', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'issueKey'       => array('zh-cn' => 'issueKey', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'testtask'       => array('zh-cn' => 'testtask', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'lastEditedBy'   => array('zh-cn' => 'lastEditedBy', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'lastEditedDate' => array('zh-cn' => 'lastEditedDate', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => ''),
        'deleted'        => array('zh-cn' => 'deleted', 'zh-tw' => '', 'en' => '', 'de' => '', 'fr' => '')
    ),
...
EOT,
    ...
    (
        ...
        (
            'field'     => 'undoneStory',
            'object'    => 'story',
            'whereSql'  => "right join zt_projectstory as t2 on t2.story=t1.id left join zt_project as t3 on t2.project=t3.id  left join zt_project as t4 on t4.id=t3.project  where t3.deleted='0' and t3.type in ('sprint','stage')  and t1.status !='closed' and t1.deleted='0' and (case when \$project='' then 1 else t4.id=\$project end)  and (case when \$execution='' then 1 else t3.id=\$execution end)  and (case when \$status='' then 1 else t3.status=\$status end)",
            'condition' => array
            (
                array('drillObject' => 'zt_project', 'drillAlias' => 't3', 'drillField' => 'id', 'queryField' => 'execution')
            )
        ...
        (
            'field'     => 'undoneTask',
            'object'    => 'task',
            'whereSql'  => "left join zt_project as t2 on t1.execution = t2.id left join zt_project as t3 on t3.id=t2.project  where t2.deleted='0' and t1.deleted='0' and t2.type in ('sprint','stage') and t1.status not in ('closed','done') and (case when \$project='' then 1 else t3.id=\$project end)  and (case when \$execution='' then 1 else t2.id=\$execution end)  and (case when \$status='' then 1 else t2.status=\$status end)",
            'condition' => array
            (
                array('drillObject' => 'zt_task', 'drillAlias' => 't1', 'drillField' => 'execution', 'queryField' => 'execution')
            )
