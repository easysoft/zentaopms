...
$config->bi->builtin->metrics[] = array
(
    'name'       => '按执行统计的往期Bug转任务的任务消耗工时',
    'alias'      => '往期Bug转任务的任务消耗工时数',
    'code'       => 'consumed_of_task_from_past_execution_bug_in_execution',
    'purpose'    => 'hour',
    'scope'      => 'execution',
    'object'     => 'task',
    'unit'       => 'hour',
    'dateType'   => 'nodate',
    'desc'       => '按执行统计的往期Bug转任务的任务消耗工时数是指执行中由往期Bug转任务消耗的工时总和。该度量项反映了任务来源为往期Bug的资源使用情况，可以帮助团队识别历史遗留缺陷占用的团队资源以及缺陷管理中存在的问题。',
