...
class biModelTest extends baseTest
{
    ...
    {
        if($this->instance === null) return 'not_empty';
    ...
    {
        if($this->instance === null) return 'has_tables';
    ...
    {
        if($this->instance === null) return 'has_fields';
    ...
    {
        if($this->instance === null) return 'valid_structure';
    ...
    public function jsonEncodeTest($object)
    {
        ...
        $result = $method->invoke($this->instance, $object);
        if(dao::isError()) return dao::getError();
