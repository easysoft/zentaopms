...
$lang->tutorial->tasks['manageTeam']['nav']['vars']           = 'projectID=0';
...
$lang->tutorial->tasks['manageTeam']['nav']['requiredFields'] = 'accounts[1]';
...
$lang->tutorial->tasks['linkStory']['nav']['menu']           = '#heading > .toolbar > a[title="执行"], #table-execution-all > .dtable-body > .dtable-cells > .dtable-cells-container > .dtable-cell[data-col="nameCol"] > .dtable-cell-content > .dtable-cell-html, .link-story-btn';
$lang->tutorial->tasks['linkStory']['nav']['form']           = '#table-tutorial-wizard,#table-execution-linkstory';
...
$lang->tutorial->tasks['createTask']['nav']['vars']           = 'executionID=2&storyID=0';
$lang->tutorial->tasks['createTask']['nav']['menu']           = '#heading > .toolbar > .toolbar-item, .create-task-btn, #table-execution-all > .dtable-body > .dtable-cells > .dtable-cells-container > .dtable-cell[data-col="nameCol"] > .dtable-cell-content > .dtable-cell-html';
