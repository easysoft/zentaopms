...
- 测试 user1 登录时是否能拿到 browseType 空 数据
 ...
 - 第0条的left属性 @0
 - 第0条的teamCount属性 @1
- 测试 user1 登录时是否能拿到 browseType 空 数据 teamMembers第0[teamMembers]条的0属性 @admin
- 测试 user1 登录时是否能拿到 browseType all 数据
 - 第0条的id属性 @3
 - 第0条的name属性 @Test execution
 - 第0条的left属性 @0
 - 第0条的teamCount属性 @1
- 测试 user1 登录时是否能拿到 browseType all 数据 teamMembers第0[teamMembers]条的0属性 @admin
- 测试 user1 登录时是否能拿到 browseType noclosed 数据
 - 第0条的id属性 @3
 - 第0条的name属性 @Test execution-noclosed
 - 第0条的left属性 @0
 - 第0条的teamCount属性 @1
- 测试 user1 登录时是否能拿到 browseType noclosed 数据 teamMembers第0[teamMembers]条的0属性 @admin
...
r($tutorial->getExecutionStatsTest($browseType['0'])) && p('0[teamMembers]:0')         && e('admin');                         // 测试 user1 登录时是否能拿到 browseType 空 数据 teamMembers
...
r($tutorial->getExecutionStatsTest($browseType['1'])) && p('0[teamMembers]:0')         && e('admin');                         // 测试 user1 登录时是否能拿到 browseType all 数据 teamMembers
...
r($tutorial->getExecutionStatsTest($browseType['2'])) && p('0[teamMembers]:0')         && e('admin');                         // 测试 user1 登录时是否能拿到 browseType noclosed 数据 teamMembers