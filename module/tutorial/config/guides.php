...
$manageAccount->tasks['manageDepts']['steps'][] = array('type' => 'clickNavbar', 'page' => 'admin-index', 'target' => 'dept', 'title' => '点击部门', 'desc' => '您可以在这里进行部门维护。');
$manageAccount->tasks['manageDepts']['steps'][] = array('type' => 'form', 'page' => 'dept-browse', 'target' => '#mainContentCell', 'title' => '点击保存', 'desc' => '保存后可以在左侧目录中看到。');
...
$manageAccount->tasks['addUser']['steps'][]  = array('type' => 'click', 'page' => 'admin-dept', 'target' => '#deptTree .dept-item[data-id="compoany"]', 'title' => '点击公司', 'desc' => '您可以在这里查看公司的人员。');
$manageAccount->tasks['addUser']['steps'][]  = array('type' => 'clickNavbar', 'page' => 'admin-dept', 'target' => 'browseUser', 'title' => '点击用户', 'desc' => '你可以在这里添加公司人员。');
...
$manageAccount->tasks['addUser']['steps'][]  = array('type' => 'form', 'page' => 'company-create', 'title' => '输入人员信息', 'desc' => '保存后可以在人员列表中查看。');
