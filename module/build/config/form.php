...
$config->build->form->edit['parent']  = array('type' => 'int',       'required' => false, 'default' => 0);
$config->build->form->edit['branch']  = array('type' => 'array',     'required' => false, 'default' => array(), 'filter' => 'join');
$config->build->form->edit['title']   = array('type' => 'string',    'required' => true,  'default' => '', 'filter' => 'trim');
$config->build->form->edit['begin']   = array('type' => 'date',      'required' => false, 'default' => null);
$config->build->form->edit['end']     = array('type' => 'date',      'required' => false, 'default' => null);
...
$config->build->form->edit['status']  = array('type' => 'string',    'required' => false, 'default' => '');
