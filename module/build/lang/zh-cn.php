...
$lang->build->delete           = "删除构建";
$lang->build->deleted          = "已删除";
$lang->build->view             = "构建详情";
...
$lang->build->integrated     = '集成构建';
$lang->build->singled        = '单一构建';
$lang->build->builds         = '包含构建';
...
$lang->build->noProduct      = " <span id='noProduct' style='color:red'>该{$lang->executionCommon}没有关联{$lang->productCommon}，无法创建构建，请先<a data-url='%s' data-app='%s' data-toggle='modal' class='cursor-pointer'>关联{$lang->productCommon}</a></span>";
$lang->build->noBuild        = '暂时没有构建。';
...
$lang->build->notice->changeBuilds    = "提交测试单的构建，不能修改关联的构建";
$lang->build->notice->autoRelation    = "相关构建下完成的需求、解决的Bug、产生的Bug将会自动关联到{$lang->projectCommon}构建中";
$lang->build->notice->createTest      = "该构建所属执行已删除，不能提交测试";

$lang->build->confirmChangeBuild = "%s『%s』解除关联后，%s下 %s个{$lang->SRCommon}和%s个Bug将同步从构建移除，是否解除？";
...
$lang->build->placeholder->filePath       = ' 该构建软件包下载存储地址';
$lang->build->placeholder->multipleSelect = "构建支持多选";

$lang->build->action = new stdclass();
$lang->build->action->buildopened = '$date, 由 <strong>$actor</strong> 创建构建 <strong>$extra</strong>。' . "\n";
