...
- 执行$result1
 - 结果是否等于 1,2,3 @1
- 执行$result2
 - 结果是否等于 1,2,19,20,22,23 @1
- 执行$result3
 - 结果是否等于 25,26 @1
- 执行$result4
 - 结果是否等于 10,11,12 @1
- 执行$result5
 - 结果是否等于 25,26,2,4,6,8 @1
...
r($result2->allBugs === '1,2,19,20,22,23') && p() && e('1');
...
r($result4->allBugs === '10,11,12') && p() && e('1');
...
r($result5->allStories === '25,26,2,4,6,8') && p() && e('1');
