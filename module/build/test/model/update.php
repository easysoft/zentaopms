...
- 修改重复名称第name条的0属性 @『名称编号』已经有『修改版本一』这条记录了。如果您确定该记录已删除，请到后台-系统设置-回收站还原。
...
r($buildTester->updateTest($buildIDList[1], $normalExecution)) && p('name:0')          && e('『名称编号』已经有『修改版本一』这条记录了。如果您确定该记录已删除，请到后台-系统设置-回收站还原。'); // 修改重复名称
