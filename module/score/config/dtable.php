...
$config->score->dtable->fieldList['method']['type']  = 'category';
...
$config->score->dtable->fieldList['times']['type']     = 'number';
...
$config->score->dtable->fieldList['hour']['type']     = 'number';
...
$config->score->dtable->fieldList['score']['type']     = 'number';
