...
$lang->score->resetTips    = '重置积分将对所有用户积分清零,执行时间可能会比较长.<br/><strong>请勿在未完成前关闭窗口</strong>';
$lang->score->resetStart   = '开始重置所有积分';
$lang->score->resetLoading = '积分重置中...';
...
$lang->score->methods['ajax']['quickDump']           = '使用快速跳转';
