...
$lang->score->extended->userchangePassword = '密碼強度中的，額外獲得#strength,1#個積分，強的，額外獲得#strength,2#個積分。';
$lang->score->extended->projectclose       = '項目經理增加#manager,close#個積分，項目成員增加#member,close#個積分。按期或者提前完成，項目經理額外增加#manager,in#個積分，項目成員額外增加#member,in#個積分。';
$lang->score->extended->bugresolve         = 'Bug解決後，額外增加嚴重程度積分：s1 + #severity,3#, s2 + #severity,2#, s3 + #severity,1#。';
$lang->score->extended->bugconfirmBug      = 'Bug確認後，額外增加嚴重程度積分：s1 + #severity,3#, s2 + #severity,2#, s3 + #severity,1#。';
$lang->score->extended->taskfinish         = '額外增加工時積分 round(工時 /10 * 預計 / 消耗) + 優先順序積分(p1 #pri,1#, p2, #pri,2#)。';
$lang->score->extended->storyclose         = '需求的創建者額外增加#createID#分';