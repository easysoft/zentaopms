...
/**
 * The privbygroup view file of space module of ZenTaoPMS.
...
if($group->role == 'limited')
{
    ...
    (
        ...
        (
            ...
            btn(set(array('text' => $lang->goback, 'url' => createLink('space', 'group', "spaceID={$spaceID}"), 'back' => true)))
        )
    );
}
else
{
    $params = "spaceID={$spaceID}&groupID=$groupID&type=byGroup";
            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        set::href(inlink('managePriv', "spaceID=$spaceID&groupID=$groupID&type=byPackage")),
                        html("<i class='icon-has-authority-pack'></i>")
                    ),
                    a
                    (
                        setClass('btn switchBtn text-primary'),
                        set::href(inlink('managePriv', "spaceID=$spaceID&groupID=$groupID&type=byGroup")),
