...
r($spaceTester->deleteSpaceSuccessTest($spaceID1))    && p() && e('1');                          // 删除真实空间返回成功
r($spaceTester->deleteSpaceHasActionTest($spaceID2))   && p() && e('1');                          // 删除真实空间后生成删除动作
r($spaceTester->deleteSpaceSuccessTest($spaceID3))    && p() && e('1');                          // 删除另一个真实空间返回成功
