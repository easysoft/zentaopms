...
- 执行processTaskRecordTest($record4)模块的url方法  @1
- 执行searchTest模块的processTaskRecordTest方法，参数是$record5  @1
...
$task->project->range('1{2},2{2},3{2},4{2},5{2}');
...
$project->multiple->range('1{2},0{3}');
$project->gen(5);
...
r(isset($searchTest->processTaskRecordTest($record4)->url)) && p() && e('1');
r(is_object($searchTest->processTaskRecordTest($record5))) && p() && e('1');