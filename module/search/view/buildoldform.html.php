...
<?php endif;?>
<form method='post' action='<?php echo $this->createLink('search', 'buildOldQuery');?>' target='hiddenwin' id='<?php echo $formId;?>' class='search-form no-stash<?php if($style == 'simple') echo ' search-form-simple';?>'>
<div class='hidden'>
<?php
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan='3' class='text-center form-actions'>
        ...
        if($style != 'simple' and common::hasPriv('search', 'saveQuery')) echo html::a($this->createLink('search', 'saveOldQuery', "module=$module&onMenuBar=$onMenuBar"), '<span class="text"><i class="icon-bug-confirm icon-save"></i> ' . $lang->search->saveCondition . '</span>', '', "class='btn-save-form btn btn-link btn-active-text text iframe' id='save-query'");
