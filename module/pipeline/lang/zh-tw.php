...
$lang->job->importAction  = '導入流水線';
$lang->job->cancelBtn     = '取消';
$lang->job->pipelineName  = '流水線名稱';
$lang->job->noProvider    = '沒有可用的服務器';
$lang->job->importFailed  = '導入失敗';
$lang->job->nameExist     = '流水線名稱"%s"已存在';
$lang->job->edit          = '編輯流水線';
$lang->job->exec          = '執行構建';
