...
$lang->testtask->batchConfirmCaseChange = '批量确认用例变动';
$lang->testtask->batchIgnoreCaseChange  = '批量忽略用例变动';
...
$lang->testtask->createdBy         = '由谁创建';
$lang->testtask->createdDate       = '创建时间';
