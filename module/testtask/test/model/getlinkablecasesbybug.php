...
r($testtask->getLinkableCasesByBug(0, $task4)) && p() && e(0); // 产品 0 测试单 4 可关联的用例数为 0。
r($testtask->getLinkableCasesByBug(2, $task4)) && p() && e(0); // 产品 2 测试单 4 可关联的用例数为 0。
r($testtask->getLinkableCasesByBug(1, $task1)) && p() && e(0); // 产品 1 测试单 1 可关联的用例数为 0。
r($testtask->getLinkableCasesByBug(1, $task2)) && p() && e(0); // 产品 1 测试单 2 可关联的用例数为 0。
r($testtask->getLinkableCasesByBug(1, $task3)) && p() && e(0); // 产品 1 测试单 3 可关联的用例数为 0。
