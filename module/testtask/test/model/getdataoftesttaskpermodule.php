...
$result1 = $testtask->getDataOfTestTaskPerModule(0, '1=1', 0);
$result2 = $testtask->getDataOfTestTaskPerModule(1, '1=1', 0);
$result3 = $testtask->getDataOfTestTaskPerModule(2, '1=1', 0);
