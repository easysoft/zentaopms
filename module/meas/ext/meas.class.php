...
/**
 * 度量项定义基类。
 * Base class of measurement defination.
 *
...
class measBase
{
     ...
     * 收集方式。
     * 可选项：实时更新 | 定时任务 | 动作触发
     * Collection methods of measurement.
     * Options: realTime | timedTask | actionTrigger
     *
     * @var string
     * @access public
     */
    ...
    /**
     * 范围。
     * 可选项：全局 | 项目集 | 项目 | 执行 | 产品 | 个人 | 团队
     * Range of measurement.
     * Options: glob | prog | proj | exec | prod | user | dept
     *
     * @var string
     * @access public
     */
    ...
    /**
     * 目的。
     * 可选项：规模估算 | 质量控制 | 工时统计 | 成本计算 | 效率提升 | 工期控制
     * Purpose of measurement.
     * Options: scale | qc | hour | cost | rate | time
     *
     * @var string
     * @access public
     */
    ...
    /**
     * 根据主表和连接表构建的sql字符串，生成MD5值(16位)，用作当前度量项的特征值，目的是为了归类度量项
     *
     * @access public
     * @return void
     */
    public function getHash()
    {
         ...
         * left join subTable1 t2 on t2.id = t1.field1
         * left join subTable2 t3 on t3.id = t1.field2
         * left join subTable3 t4 on t4.id = t1.field3
         * ····
         */
     ...
     * @return void
     */
    public function getSql($selectFields)
    {
    }
