...
- 测试外网IP是否可以ping通第extranet条的0属性 @无法连接到宿主机，请检查网络后重试。
- 测试外网IP不能为空第extranet条的1属性 @『外网IP』不能为空。
...
r($zahost->createTest($hostInfo)) && p('extranet:0') && e('无法连接到宿主机，请检查网络后重试。'); //测试外网IP是否可以ping通
r($zahost->createTest($hostInfo)) && p('extranet:1') && e('『外网IP』不能为空。');                 //测试外网IP不能为空
