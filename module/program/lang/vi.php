...
$lang->program->beginLessThanParent     = "Parent begin date: %s, begin date should be >                  = parent begin date.";
$lang->program->endGreatThanParent      = "Parent end date: %s, end date should be <                      = parent end date.";
$lang->program->beginGreatEqualChild    = "Child earliest begin: %s, parent begin date <                  = child earliest begin date.";
$lang->program->endLessThanChild        = "Child latest end: %s, parent end date >                        = child latest end date.";
