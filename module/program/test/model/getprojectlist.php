...
$involvedProjects         = $programTester->getProjectList(0, 'undone', 0, 'id_desc', 'end', true);
$queryAllProjects         = $programTester->getProjectList(0, 'undone', 0, 'id_desc', 'end', true, true);
