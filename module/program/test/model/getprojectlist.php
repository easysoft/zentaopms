...
$withProgramProjects      = $programTester->getProjectList(0, 'undone', 0, 'begin_desc', null, 'end');
$withBaseProgramProjects  = $programTester->getProjectList(0, 'undone', 0, 'begin_desc', null, 'base');
$involvedProjects         = $programTester->getProjectList(0, 'undone', 0, 'id_desc', null, 'end', true);
$queryAllProjects         = $programTester->getProjectList(0, 'undone', 0, 'id_desc', null, 'end', true, true);
