...
class programModel extends model
{
    ...
    public function PGMCreate()
    {
        $program = fixer::input('post')
            ...
            ->setIF($this->post->budget != 0, 'budget', number_format((float)$this->post->budget, 2))
            ->add('type', 'program')
            ->join('whitelist', ',')
    ...
    public function getPGMSwitcher($programID = 0, $active = false)
    {
        ...
        $output  = "<div class='btn-group header-angle-btn2 $active' id='swapper'><div class='btn btn-span'>{$this->lang->program->common}</div><button data-toggle='dropdown' type='button' class='btn' id='currentItem' title='{$currentProgramName}'><span class='text'>{$currentProgramName}</span> <span class='caret'></span></button><div id='dropMenu' class='dropdown-menu search-list' data-ride='searchList' data-url='$dropMenuLink'>";
    ...
    public function getPRJSwitcher($projectID, $currentModule, $currentMethod)
    {
        ...
        $output  = "<div class='btn-group header-angle-btn active' id='swapper'><div class='btn btn-span'>{$this->lang->program->project}</div><button data-toggle='dropdown' type='button' class='btn' id='currentItem' title='{$currentProjectName}'><span class='text'>{$currentProjectName}</span> <span class='caret'></span></button><div id='dropMenu' class='dropdown-menu search-list' data-ride='searchList' data-url='$dropMenuLink'>";
