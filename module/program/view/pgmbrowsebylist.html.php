  ...
  <table class='table has-sort-head table-fixed table-nested' id='programList'>
    ...
    <tbody id='programTableList'>
      ...
      <tr <?php echo $trAttrs;?>>
        ...
        <td class='text-left'><?php echo $program->budget != 0 ? $program->budget . ' ' . zget($lang->program->unitList, $program->budgetUnit) : $lang->program->future;?></td>
        ...
        <td class='c-actions'>
          ...
          <?php common::printIcon('program', 'PRJEdit',          "projectID=$program->id&programID=0&from=program", $program, 'list', 'edit', '', '', '', "data-group='program'");?>
