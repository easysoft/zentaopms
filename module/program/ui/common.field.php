...
$fields->field('budget')
    ...
    ->control('inputControl', array('control' => 'input', 'name' => 'budget', 'value' => (data('program.budget') !== null && data('program.budget') != 0 ? data('program.budget') : ''), 'prefix' => array('control' => 'dropdown', 'name' => 'budgetUnit', 'items' => $budgetItemList, 'widget' => true, 'text' => zget($lang->project->currencySymbol, $currency), 'className' => 'ghost', 'disabled' => $budgetUnitDisabled), 'prefixWidth' => 34, 'disabled' => $budgetDisabled));
