...
$lang->mail->statusList['sending'] = '发送中';
...
$lang->mail->sendmailTips   = '系统不会为当前操作者发信。';
...
<p>您好：</p>
<p>您正在申请重置禅道密码，重置链接三分钟内有效且只能使用一次，过期请重新申请。</p>
