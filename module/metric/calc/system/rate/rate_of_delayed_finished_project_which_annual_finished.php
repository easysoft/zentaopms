 ...
 * 单位：个
 * 描述：按系统统计的年度完成项目中项目的延期完成率是指按全局统计的年度完成项目中延期完成项目数与关闭项目数之比。这个度量项可以帮助团队评估某年度项目按期关闭的能力和效果，并作为项目管理的绩效指标之一。较高的延期完成率可能需要团队关注项目计划和资源安排的问题。
 * 定义：复用：;按全局统计的年度关闭项目数;按全局统计的年度延期关闭项目数;公式：;按全局统计的年度项目延期关闭率=按全局统计的年度延期关闭项目数/按全局统计的年度关闭项目数;
 *
