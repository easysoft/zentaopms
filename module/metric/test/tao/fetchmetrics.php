...
r($metric->fetchMetrics('project', 'all')) && p('0:id,purpose,code') && e('276,scale,count_of_annual_finished_execution_in_project');             // 查询项目范围的第一个度量项
...
r($metric->fetchMetrics('product', 'all', 'story', 'scale', '', 'id_asc')) && p('0:id,purpose,code') && e('149,scale,count_of_story_in_product'); // 查询产品范围内对象为需求，目的为规模估算的id正数第一个度量项
r($metric->fetchMetrics('project', 'all', 'task', 'rate')) && p('0:id,purpose,code') && e('232,rate,cv_weekly_in_waterfall');                     // 查询项目范围内对象为任务，目的为效率提升的第一个度量项