...
- 执行metric模块的fetchMetricsWithFilter方法，参数是$filters1  @25
...
- 执行metric模块的fetchMetricsWithFilter方法，参数是$filters3  @25
...
r(count($metric->fetchMetricsWithFilter($filters1))) && p() && e(25);
r($metric->fetchMetricsWithFilter($filters2)) && p('0:id,purpose,code;1:id,purpose,code') && e('243,scale,count_of_story_in_execution;244,scale,count_of_finished_story_in_execution');
r(count($metric->fetchMetricsWithFilter($filters2))) && p() && e(34);
...
r(count($metric->fetchMetricsWithFilter($filters3))) && p() && e(25);
...
r(count($metric->fetchMetricsWithFilter($filters4))) && p() && e(24);
