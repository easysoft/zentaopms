...
r($metric->fetchMetricsWithFilter($filters2)) && p('0:id,purpose,code;1:id,purpose,code') && e('242,scale,count_of_story_in_execution;243,scale,count_of_finished_story_in_execution');
