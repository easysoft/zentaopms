...
r($metric->isDateMetric($header1))  && p() && e('0'); // 测试header1是否有时间概念
r($metric->isDateMetric($header2))  && p() && e('1'); // 测试header2是否有时间概念
r($metric->isDateMetric($header3))  && p() && e('0'); // 测试header3是否有时间概念
r($metric->isDateMetric($header4))  && p() && e('0'); // 测试header4是否有时间概念
