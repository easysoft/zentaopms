...
r($metric->getList('system', 'all')) && p('0:code') && e('count_of_annual_finished_execution');                        // 获取系统范围内的所有度量项
r($metric->getList('system', 'wait')) && p('') && e('0');                                                              // 获取系统范围内未发布的度量项
r($metric->getList('system', 'released')) && p('1:code') && e('count_of_pending_deployment');                          // 获取系统范围内发布的度量项
r($metric->getList('project', 'all', 'id_desc')) && p('0:code') && e('count_of_annual_finished_execution_in_project'); // 获取项目范围内所有的，以id_desc的度量项
