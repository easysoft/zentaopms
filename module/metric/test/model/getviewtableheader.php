...
r($metric->getViewTableHeader($metricList[0])) && p('0:name,title;1:name,title')                           && e('date,日期,value,数值');                                  // 测试度量项count_of_bug
...
r($metric->getViewTableHeader($metricList[4])) && p('0:name,title;1:name,title;2:name,title')              && e('scope,产品名称,date,日期,value,数值');                   // 测试度量项count_of_case_in_product
