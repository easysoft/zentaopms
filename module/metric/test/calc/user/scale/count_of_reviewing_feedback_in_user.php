...
r($calc->getResult(array('user' => 'admin')))    && p('0:value') && e('3');  // 测试用户admin
r($calc->getResult(array('user' => 'user')))     && p('0:value') && e('3');  // 测试用户user
r($calc->getResult(array('user' => 'dev')))      && p('0:value') && e('10'); // 测试用户dev
