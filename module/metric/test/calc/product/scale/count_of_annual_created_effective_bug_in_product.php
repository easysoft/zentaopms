...
- 测试有效bug按产品分组数。 @17
- 测试产品1有效的bug数。第0条的value属性 @12
- 测试产品3有效的bug数。第0条的value属性 @7
...
r(count($calc->getResult()))                   && p('')        && e('17'); // 测试有效bug按产品分组数。
r($calc->getResult(array('product' => '1')))   && p('0:value') && e('12'); // 测试产品1有效的bug数。
r($calc->getResult(array('product' => '3')))   && p('0:value') && e('7');  // 测试产品3有效的bug数。
