...
- 测试按产品的月度完成需求分组数。 @10
- 测试2019年完成的需求数。第0条的value属性 @0.3
- 测试2019年完成的需求数。第0条的value属性 @0.3
- 测试2020年完成的需求数。第0条的value属性 @0.33
- 测试2020年完成的需求数。第0条的value属性 @0.33
- 测试不存在的产品的需求数。 @0
...
r($calc->getResult(array('year' => '2019'))) && p('0:value') && e('0.3');  // 测试2019年完成的需求数。
r($calc->getResult(array('year' => '2019'))) && p('0:value') && e('0.3');  // 测试2019年完成的需求数。
r($calc->getResult(array('year' => '2020'))) && p('0:value') && e('0.33'); // 测试2020年完成的需求数。
r($calc->getResult(array('year' => '2020'))) && p('0:value') && e('0.33'); // 测试2020年完成的需求数。
