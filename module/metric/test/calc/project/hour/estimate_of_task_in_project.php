...
- 测试分组数。 @75
- 测试项目11的任务预计工时数。第0条的value属性 @7
- 测试项目12的任务预计工时数。第0条的value属性 @9
- 测试项目13的任务预计工时数。第0条的value属性 @5
- 测试不存在项目的任务预计工时数。 @0
...
r($calc->getResult(array('project' => 11))) && p('0:value') && e('7'); // 测试项目11的任务预计工时数。
r($calc->getResult(array('project' => 12))) && p('0:value') && e('9'); // 测试项目12的任务预计工时数。
