...
- 测试分组数。 @75
- 测试项目11的任务剩余工时数。第0条的value属性 @7
- 测试项目12的任务剩余工时数。第0条的value属性 @9
...
r($calc->getResult(array('project' => 11))) && p('0:value') && e('7'); // 测试项目11的任务剩余工时数。
r($calc->getResult(array('project' => 12))) && p('0:value') && e('9'); // 测试项目12的任务剩余工时数。
