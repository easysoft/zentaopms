...
title=count_of_finished_test_task_in_execution_when_closing
timeout=0
cid=1

- 测试分组数。 @1
- 测试执行11开始时的测试任务数。第0条的value属性 @0
- 测试执行12开始时的测试任务数。第0条的value属性 @1
...
r($calc->getResult(array('execution' => 12)))  && p('0:value') && e('1'); // 测试执行12开始时的测试任务数。
