...
- 测试分组数。 @10
- 测试执行11的测试任务数。第0条的value属性 @2
- 测试执行12的测试任务数。第0条的value属性 @2
- 测试执行13的测试任务数。第0条的value属性 @2
- 测试不存在执行的测试任务数。 @0
...
r($calc->getResult(array('execution' => 11)))  && p('0:value') && e('2'); // 测试执行11的测试任务数。
r($calc->getResult(array('execution' => 12)))  && p('0:value') && e('2'); // 测试执行12的测试任务数。
r($calc->getResult(array('execution' => 13)))  && p('0:value') && e('2'); // 测试执行13的测试任务数。
