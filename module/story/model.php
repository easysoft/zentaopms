...
class storyModel extends model
{
    ...
    public static function isClickable(object $story, string $action): bool
    {
        ...
        $isSuperReviewer  = strpos(',' . trim(zget($config->{$story->type}, 'superReviewers', ''), ',') . ',', ',' . $app->user->account . ',');
    ...
    public function replaceURLang(string $type): void
    {
        ...
        $storyLang->skipStory                = str_replace($SRCommon, $replacement, $storyLang->skipStory);
