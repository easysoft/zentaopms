...
- 步骤3：QA标签下的批量编辑导航设置 @qa_menu_set
- 步骤4：我的工作标签下的批量编辑导航设置 @my_work_menu_set
- 步骤5：项目标签下的批量编辑导航设置 @project_menu_set
...
// 5. 🔴 强制要求：必须包含至少5个测试步骤
r($storyTest->setMenuForBatchEditTest(1, 0, 'story', '')) && p() && e('product_menu_set'); // 步骤1：产品标签下的批量编辑导航设置
r($storyTest->setMenuForBatchEditTest(1, 6, 'story', '')) && p() && e('execution_menu_set'); // 步骤2：执行标签下的批量编辑导航设置
r($storyTest->setMenuForBatchEditTest(1, 7, 'story', '')) && p() && e('qa_menu_set'); // 步骤3：QA标签下的批量编辑导航设置
r($storyTest->setMenuForBatchEditTest(1, 8, 'story', 'work')) && p() && e('my_work_menu_set'); // 步骤4：我的工作标签下的批量编辑导航设置
r($storyTest->setMenuForBatchEditTest(1, 9, 'story', '')) && p() && e('project_menu_set'); // 步骤5：项目标签下的批量编辑导航设置