...
$_SESSION['storyList'] = '';
r($storyTest->getAfterCreateLocationTest(1, '0', 0, 1, 'story', 1, '')) && p() && e('getaftercreatelocation.php?m=product&f=browse&productID=1&branch=0&browseType=&param=0&storyType=story&orderBy=id_desc');
$_SESSION['storyList'] = 'story-browse-1.html';
r($storyTest->getAfterCreateLocationTest(1, '0', 0, 1, 'story', 2, '')) && p() && e('story-browse-1.html');
$_SESSION['storyList'] = '';
...
r($storyTest->getAfterCreateLocationTest(1, '1', 0, 1, 'story', 6, '')) && p() && e('getaftercreatelocation.php?m=product&f=browse&productID=1&branch=all&browseType=&param=0&storyType=story');
$_POST['branches'] = array();
$_SESSION['storyList'] = '';
$app->tab = 'project';
r($storyTest->getAfterCreateLocationTest(1, '0', 11, 1, 'story', 7, '')) && p() && e('getaftercreatelocation.php?m=execution&f=story&t=&objectID=11');
