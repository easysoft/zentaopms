...
r($requirementOperateMenu1) && p('0:name,hint,disabled')   && e('change,只有激活状态的软需，才能进行变更,1');                 //查看用户需求列表操作菜单第一个链接
...
r($storyOperateMenu1)       && p('1:name,hint,disabled')    && e('review,该软需已是激活状态，无需评审,1');                    //查看软件需求详情操作菜单第二个链接
