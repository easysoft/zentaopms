...
class storyModelTest extends baseTest
{
    ...
    {
        $result = $this->instance->getReviewerPairs($storyID, $version);
    ...
    {
        $result = $this->instance->getStoriesReviewer($productID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getLastReviewer($storyID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getDataOfStoriesPerAssignedTo($storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getDataOfStoriesPerChange($storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getDataOfStoriesPerProduct($storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getDataOfStoriesPerModule($storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getDataOfStoriesPerEstimate($storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $story = $this->instance->getById($storyID, $version);
    ...
    {
        $stories = $this->instance->getByList($storyIdList, $mode);
    ...
    {
        $result = $this->instance->getGradeOptions($story, $storyType, $appendList);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getGradeList($type);
        if(dao::isError()) return dao::getError();
    ...
    {
        $oldStories = $this->instance->getByList($storyIdList);
        ...
        if($parentIdList)
        {
            $parents = $this->instance->dao->select('id, grade, type')->from(TABLE_STORY)->where('id')->in($parentIdList)->fetchAll('id');
        }
    ...
    {
        $objects = $this->instance->getTestStories($storyIdList, $executionID);
    ...
    {
        $objects = $this->instance->getStorySpecs($storyIdList);
    ...
    public function getAffectedScopeTest($storyID)
    {
        ...
        $scope = $this->instance->getAffectedScope($story);
    ...
    {
        $result = $this->instance->getDataOfStoriesPerOpenedBy($storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $requirements = $this->instance->getRequirements($productID);
    ...
    public function createTest(object $story, int $executionID = 0, int $bugID = 0, string $extra = ''): object|array
    {
        ...
        if($executionID) $story->linkedProjects = $this->instance->dao->select('*')->from(TABLE_PROJECTSTORY)->where('project')->eq($executionID)->fetchAll();
        if($bugID)       $story->linkedBug      = $this->instance->dao->select('*')->from(TABLE_BUG)->where('id')->eq($bugID)->fetch();
        return $story;
    }
    ...
    {
        $storyID = $this->instance->createStoryFromGitlabIssue($story, $executionID);

        if(dao::isError()) return dao::getError();

        return $this->instance->fetchById($storyID);
    }
    ...
    public function batchCreateTest(int $productID = 0, int $branch = 0, string $type = 'story', array $params = array()): array
    {
        ...
        $storyIdList = $this->instance->batchCreate($stories, $productID, $branch, $type);
        if(dao::isError()) return dao::getError();

        $stories = $this->instance->getByList($storyIdList);
        return $stories;
    }
    ...
    {
        $this->instance->change($storyID, $params);
        if(dao::isError()) return dao::getError();
    ...
    {
        $data          = $this->instance->getByID($storyID);
        ...
        $this->instance->update($storyID, $story);
        if(dao::isError()) return dao::getError();
    ...
    {
        $this->instance->updateStoryOrderOfPlan($storyID, $planIDList, $oldPlanIDList);
    ...
    {
        $oldStory = $this->instance->getByID($storyID);
        if(empty($oldStory)) return array();

        $this->instance->computeEstimate($storyID);

        if(dao::isError()) return dao::getError();

        $newStory = $this->instance->getByID($storyID);
    ...
    {
        $this->instance->batchUpdate($stories);
        if(dao::isError()) return dao::getError();

        return $this->instance->dao->select('*')->from(TABLE_STORY)->where('id')->in(array_keys($stories))->fetchAll('id');
    }
    ...
    public function reviewTest($storyID, $data): object
    {
        global $app;
        $app->rawModule = 'story';
        $this->instance->review($storyID, $data);
        return $this->instance->getByID($storyID);
    }
    ...
    public function batchReviewTest(array $storyIdList, string $result, string $reason = ''): array
    {
        global $app;
        $app->rawModule = 'story';
        $this->instance->batchReview($storyIdList, $result, $reason);
        return $this->instance->getByList($storyIdList);
    }
    ...
    {
        $this->instance->subdivide($storyID, $stories);

        if(dao::isError()) return dao::getError();

        $story = $this->instance->getById($storyID);
        $story->children = $this->instance->dao->select('*')->from(TABLE_STORY)->where('parent')->eq($storyID)->fetchAll();
        return $story;
    }
    ...
    public function closeTest(int $storyID, object $postData)
    {
        ...
        $this->instance->close($storyID, $postData);
    ...
    {
        $this->instance->batchClose($stories);
        if(dao::isError()) return dao::getError();
    ...
    {
        $changes = $this->instance->batchChangeModule($storyIdList, $moduleID);

        if(dao::isError()) return dao::getError();

        return $this->instance->dao->select('*')->from(TABLE_STORY)->where('id')->in($storyIdList)->fetchAll('id');
    }
    ...
    {
        $changes = $this->instance->batchChangePlan($storyIdList, $planID, $oldPlanID);
    ...
    {
        $changes = $this->instance->batchChangeBranch($storyIdList, $branchID, $confirm, $plans);

        if(dao::isError()) return dao::getError();

        $storyIdList = array_keys($changes);
        return $this->instance->dao->select('*')->from(TABLE_STORY)->where('id')->in($storyIdList)->fetchAll('id', false);
    }
    ...
    {
        $this->instance->batchChangeStage($storyIdList, $stage);

        if(dao::isError()) return dao::getError();

        return $this->instance->dao->select('*')->from(TABLE_STORY)->where('id')->in($storyIdList)->fetchAll();
    }
    ...
    public function batchToTaskTest(): array
    {
        ...
        $tasks[1]->name  = '软件需求2';
        $tasks[1]->story = 3;
        $taskIdList = $this->instance->batchToTask($task->execution, $tasks);

        if(dao::isError()) return dao::getError();

        return $this->instance->dao->select('*')->from(TABLE_TASK)->where('id')->in($taskIdList)->orderBy('id')->fetchAll();
    }
    ...
    public function assignTest($storyID, $assignedTo)
    {
        ...
        $this->instance->assign($storyID, (object)$_POST);
        unset($_POST);
    ...
    {
        $changes = $this->instance->batchAssignTo($storyIdList, $assignedTo);
        if(dao::isError()) return dao::getError();
    ...
    {
        global $tester;
        $stories = $this->instance->getByAssignedBy($productID, $branch, $modules = array(), $account = $tester->app->user->account, $type = 'story', $orderBy = '', $pager = null);
    ...
    public function fetchExecutionStoriesTest(int $executionID, int $productID, object|null $pager = null): array
    {
        ...
        return $this->instance->fetchExecutionStories($storyDAO, $productID, 'byBranch', '', 'id_desc', $pager);
    }
    ...
    {
        $this->instance->doUpdateReviewer($storyID, (object)$reviewer);
        return $this->instance->dao->select('*')->from(TABLE_STORYREVIEW)->where('story')->eq($storyID)->fetchAll();
    }
    ...
    {
        $this->instance->doUpdateSpec($storyID, $story, $oldStory);
    ...
    {
        $this->instance->setStage($storyID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $this->instance->linkStory($executionID, $productID, $storyID);
    ...
    {
        $this->instance->syncTwins($storyID, $twins, $changes, 'changed');
        return $this->instance->dao->select('*')->from(TABLE_STORY)->where('id')->in($twins)->orderBy('id')->fetchAll();
    }
    ...
    {
        $oldStory = $this->instance->getByID(1);
        $actionID = $this->instance->recordReviewAction($oldStory, $story);
        return $this->instance->dao->select('*')->from(TABLE_ACTION)->where('id')->in($actionID)->fetch();
    }
    ...
    {
        $this->instance->closeAllChildren($storyID, $closedReason);

        return $this->instance->dao->select('*')->from(TABLE_STORY)->where('parent')->eq($storyID)->limit(1)->fetch();
    }
    ...
    {
        $result = $this->instance->getPairsByList($storyIdList);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->relieveTwins($productID, $storyID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->batchChangeParent($storyIdList, $parentID, $storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getAllChildId($storyID, $includeSelf, $sameType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getByAssignedTo($productID, $branch, $modules, $account, $type, $orderBy, $pager);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getByOpenedBy($productID, $branch, $modules, $account, $type, $orderBy, $pager);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getByReviewedBy($productID, $branch, $modules, $account, $type, $orderBy, $pager);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getByReviewBy($productID, $branch, $modules, $account, $type, $orderBy, $pager);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getByClosedBy($productID, $branch, $modules, $account, $type, $orderBy, $pager);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getByStatus($productID, $branch, $modules, $status, $type, $orderBy, $pager);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getRequirementParents($productID, $appendedStories, $storyType, $storyID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getEpicParents($productID, $appendedStories, $storyType, $storyID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getDataOfStoriesPerGrade($storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->appendChildren($productID, $stories, $storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getMergeTrackCells($tracks, $showCols);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getStatusList($status);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getGradeGroup();
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getGradePairs($type, $status, $appendList);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getGradeMenu($storyType, $project);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getMaxGradeGroup($status);
        if(dao::isError()) return dao::getError();
    ...
    public function getDefaultShowGradesTest(array $gradeMenu): string
    {
        ...
        {
            $result = $this->instance->getDefaultShowGrades($gradeMenu);
            if(dao::isError()) return dao::getError();
            return $result;
        }
    ...
    {
        $result = $this->instance->checkGrade($story, $oldStory, $mode);
        if(dao::isError()) return dao::getError();
    ...
    public function syncGradeTest(object $oldStory, object $story)
    {
        ...
        $childIdList = $this->instance->getAllChildId($oldStory->id, false);
        if(empty($childIdList)) return 'no_children';

        // 执行同步操作前记录原始数据
        $oldChildren = $this->instance->getByList($childIdList);
        ...
        foreach($childIdList as $childID)
        {
            ...
            $this->instance->dao->update(TABLE_STORY)->set('grade')->eq($grade)->where('id')->eq($child->id)->exec();
        }

        if(dao::isError()) return dao::getError();

        // 获取同步后的数据
        $newChildren = $this->instance->getByList($childIdList);
        $result = array();
    ...
    {
        $result = $this->instance->updateLinkedCommits($storyID, $repoID, $revisions);
        if(dao::isError()) return dao::getError();
    ...
    public function setViewVarsForKanbanTest(int $objectID, array $kanbanSetting, string $storyType = 'story'): array
    {
        ...
        $execution = $this->instance->dao->findById($objectID)->from(TABLE_EXECUTION)->fetch();
    ...
    private function mockBuildStoryForReview(int $storyID, array $postData): mixed
    {
        ...
        // 获取故事数据
        $oldStory = $this->instance->dao->select('*')->from(TABLE_STORY)->where('id')->eq($storyID)->fetch();
    ...
    public function getLinkedObjectsTest(object $story)
    {
        try {
            ...
            // 模拟获取关联的bugs
            $bugs = $this->instance->dao->select('id,title,status,pri,severity')
                ->from(TABLE_BUG)
            ...
            {
                $fromBug = $this->instance->dao->select('id,title')
                    ->from(TABLE_BUG)
            ...
            // 模拟获取关联的cases
            $cases = $this->instance->dao->select('id,title,status,pri')
                ->from(TABLE_CASE)
                ->where('story')->eq($story->id)
                ->andWhere('deleted')->eq(0)
                ->fetchAll();
            ...
            {
                $module = $this->instance->dao->select('*')
                    ->from(TABLE_MODULE)
            ...
            if(isset($story->module) && $story->module)
            {
                $storyModule = $this->instance->dao->select('*')
                    ->from(TABLE_MODULE)
                    ->where('id')->eq($story->module)
                    ->fetch();
            }
            ...
            {
                $storyProducts = $this->instance->dao->select('id,product')
                    ->from(TABLE_STORY)
    ...
    {
        $result = $this->instance->checkNeedConfirm($data);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->extractAccountsFromList($stories);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->extractAccountsFromSingle($story);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->get2BeClosed($productID, $branch, $modules, $type, $orderBy, $pager);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getBySQL($productID, $sql, $orderBy, $pager, $type);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getEstimateInfo($storyID, $round);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getEstimateRounds($storyID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getIdListWithTask($executionID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getParentStoryPairs($productID, $appendedStories, $storyType, $storyID);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getPlanStories($planID, $status, $orderBy, $pager);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getStoriesCountByProductID($productID, $storyType);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->submitReview($storyID, $storyData);
        if(dao::isError()) return dao::getError();
    ...
    {
        $result = $this->instance->getTracksByStories($stories, $storyType);
        if(dao::isError()) return dao::getError();
    ...
    public function doSaveUploadImageTest(int $storyID, string $fileName, string $testType): object
    {
        ...
        // 确保file save路径存在
        $this->instance->loadModel('file');
        if(!is_dir($this->instance->file->savePath)) mkdir($this->instance->file->savePath, 0777, true);
