...
- 获取执行11下的需求数量 @50
- 获取执行11下的需求详情属性8 @8:软件需求8 (优先级:2,预计工时:1.00)
- 获取执行11、产品91下的需求数量 @0
- 获取执行11、产品1下的需求数量 @25
- 获取执行11、产品1下的需求详情属性3 @3:用户需求3 (优先级:2,预计工时:3.00)
...
r($stories1)        && p('8', '|') && e('8:软件需求8 (优先级:2,预计工时:1.00)'); // 获取执行11下的需求详情
r(count($stories2)) && p()         && e('0');                                 // 获取执行11、产品91下的需求数量
r(count($stories3)) && p()         && e('25');                                // 获取执行11、产品1下的需求数量
r($stories3)        && p('3', '|') && e('3:用户需求3 (优先级:2,预计工时:3.00)'); // 获取执行11、产品1下的需求详情