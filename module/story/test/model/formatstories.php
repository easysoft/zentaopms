...
- 获取处理title之后的需求列表数量 @2
- 获取处理title之后的需求title属性2 @2:软件需求2 (优先级:2,预计工时:2.00)
- 获取处理title之后的需求title属性6 @6:软件需求6 (优先级:2,预计工时:2.00)
...
r($formatStories1)        && p('2', '|')  && e('2:软件需求2 (优先级:2,预计工时:2.00)'); // 获取处理title之后的需求title
r($formatStories2)        && p('6', '|')  && e('6:软件需求6 (优先级:2,预计工时:2.00)'); // 获取处理title之后的需求title
