...
$lang->story->report->charts['storiesPerProduct']      = 'nach ' . $lang->productCommon;
$lang->story->report->charts['storiesPerModule']       = 'nach Modul';
$lang->story->report->charts['storiesPerSource']       = 'nach Source';
$lang->story->report->charts['storiesPerPlan']         = 'nach Plan';
$lang->story->report->charts['storiesPerStatus']       = 'nach Status';
$lang->story->report->charts['storiesPerStage']        = 'nach Phase';
$lang->story->report->charts['storiesPerPri']          = 'nach Priorität';
$lang->story->report->charts['storiesPerEstimate']     = 'nach Stunden';
$lang->story->report->charts['storiesPerOpenedBy']     = 'nach Ersteller';
$lang->story->report->charts['storiesPerAssignedTo']   = 'nach Zuständiger';
$lang->story->report->charts['storiesPerClosedReason'] = 'nach Grund';
$lang->story->report->charts['storiesPerChange']       = 'nach Änderungszeit';
...
$lang->story->report->storiesPerModule->item       = 'Modul';
...
$lang->story->report->storiesPerPri->item          = 'Priorität';
$lang->story->report->storiesPerOpenedBy->item     = 'Konto';
$lang->story->report->storiesPerAssignedTo->item   = 'Benutzer';
$lang->story->report->storiesPerClosedReason->item = 'Grund';
$lang->story->report->storiesPerEstimate->item     = 'Stunden';
$lang->story->report->storiesPerChange->item       = 'Änderung';
...
$lang->story->report->storiesPerModule->graph->xAxisName       = 'Modul';
...
$lang->story->report->storiesPerPri->graph->xAxisName          = 'Priorität';
$lang->story->report->storiesPerOpenedBy->graph->xAxisName     = 'Ersteller';
$lang->story->report->storiesPerAssignedTo->graph->xAxisName   = 'Zuständiger';
$lang->story->report->storiesPerClosedReason->graph->xAxisName = 'Grund';
$lang->story->report->storiesPerEstimate->graph->xAxisName     = 'Stunden ';
$lang->story->report->storiesPerChange->graph->xAxisName       = 'Änderung';
