...
$lang->story->plan           = "所屬{$lang->planCommon}";
...
$lang->story->action->linked2plan         = array('main' => '$date, 由 <strong>$actor</strong> 關聯到' . $lang->planCommon . ' <strong>$extra</strong>。');
$lang->story->action->unlinkedfromplan    = array('main' => '$date, 由 <strong>$actor</strong> 從' . $lang->planCommon . ' <strong>$extra</strong> 移除。');
...
$lang->story->report->charts['storysPerPlan']           = "按{$lang->planCommon}進行統計";
