...
$lang->story->action->passreviewed          = array('main' => '$date, 由 <strong>系統</strong> 判定，結果為 <strong>評審通過</strong>。');
...
$lang->story->action->reviewclosed          = array('main' => '$date, 由 <strong>系統</strong> 關閉，原因為 <strong>評審不通過</strong>。');
