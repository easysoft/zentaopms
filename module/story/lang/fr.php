...
$lang->story->changeTips           = "The {$lang->SRCommon} associated with the {$lang->URCommon} to change, click 'Cancel' ignore this change, click 'Confirm' to change the {$lang->SRCommon}.";
...
$lang->story->report->charts['storysPerProduct']      = 'Regroupé par ' . $lang->productCommon . ' Story';
$lang->story->report->charts['storysPerModule']       = 'Regroupé par Module Story';
$lang->story->report->charts['storysPerSource']       = 'Regroupé par Source';
$lang->story->report->charts['storysPerPlan']         = 'Regroupé par Plan';
$lang->story->report->charts['storysPerStatus']       = 'Regroupé par Statut';
$lang->story->report->charts['storysPerStage']        = 'Regroupé par Phase';
$lang->story->report->charts['storysPerPri']          = 'Regroupé par Priorité';
$lang->story->report->charts['storysPerEstimate']     = 'Regroupé par Estimés';
$lang->story->report->charts['storysPerOpenedBy']     = 'Regroupé par Créateur';
$lang->story->report->charts['storysPerAssignedTo']   = 'Regroupé par Détenteur';
$lang->story->report->charts['storysPerClosedReason'] = 'Par Raison de Fermeture';
$lang->story->report->charts['storysPerChange']       = 'Regroupé par Modif de Story';
...
$lang->story->report->storysPerStatus->item       = 'Statut';
$lang->story->report->storysPerStage->item        = 'Phase';
$lang->story->report->storysPerPri->item          = 'Priorité';
$lang->story->report->storysPerOpenedBy->item     = 'Créateur';
$lang->story->report->storysPerAssignedTo->item   = 'Détenteur';
$lang->story->report->storysPerClosedReason->item = 'Raison';
$lang->story->report->storysPerEstimate->item     = 'Estimation';
$lang->story->report->storysPerChange->item       = 'Chang. Story';
...
$lang->story->report->storysPerStatus->graph->xAxisName       = 'Statut';
$lang->story->report->storysPerStage->graph->xAxisName        = 'Phase';
$lang->story->report->storysPerPri->graph->xAxisName          = 'Priorité';
$lang->story->report->storysPerOpenedBy->graph->xAxisName     = 'Créateur';
$lang->story->report->storysPerAssignedTo->graph->xAxisName   = 'Détenteur';
$lang->story->report->storysPerClosedReason->graph->xAxisName = 'Raison Fermeture';
$lang->story->report->storysPerEstimate->graph->xAxisName     = 'Estimattion ';
