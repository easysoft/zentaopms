...
$config->story->form->batchCreate['pri']        = array('ditto' => false, 'type' => 'int',    'control' => 'priPicker', 'required' => false, 'width' => '92px',  'default' => (string)$config->story->defaultPriority, 'options' => $lang->story->priList);
...
$config->story->form->batchEdit['status']       = array('type' => 'string', 'width' => '80px',  'control' => 'static', 'required' => false, 'default' => '',  'options' => array_filter($lang->story->statusList));
...
$config->story->form->batchSubmitReview['id']            = array('type' => 'int',    'control' => 'hidden',    'required' => true,  'default' => '', 'base' => true);
$config->story->form->batchSubmitReview['reviewer']      = array('type' => 'array',  'control' => 'picker',    'required' => false, 'default' => '', 'filter' => 'join');
$config->story->form->batchSubmitReview['needNotReview'] = array('type' => 'int',    'control' => 'checkbox',  'required' => false, 'default' => 0);
$config->story->form->batchSubmitReview['status']        = array('type' => 'string', 'control' => 'hidden',    'required' => false, 'default' => 'active');
