...
$config->story->dtable->fieldList['reviewedBy']['name']       = 'reviewedBy';
$config->story->dtable->fieldList['reviewedBy']['title']      = $lang->story->reviewedBy;
...
$config->story->dtable->fieldList['reviewedBy']['show']       = true;
...
$config->story->dtable->fieldList['needReview']['name']  = 'needReview';
$config->story->dtable->fieldList['needReview']['title'] = $lang->story->needReview;
$config->story->dtable->fieldList['needReview']['type']  = 'text';
$config->story->dtable->fieldList['needReview']['map']   = $lang->story->reviewList;
