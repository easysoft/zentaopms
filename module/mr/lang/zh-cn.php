...
$lang->mr->hasConflict       = '是否有代码冲突';
$lang->mr->request           = '要求';
$lang->mr->AIReview          = 'AI评审';
$lang->mr->AICodeScore       = '代码评分';
$lang->mr->AISevereIssue     = '高危问题';
$lang->mr->AIOrdinaryIssue   = '一般问题';
$lang->mr->manualReview      = '人工评审';
$lang->mr->approvalReviewer  = '评审人数';
$lang->mr->doneReviewer      = '已完成评审数量';
$lang->mr->codeScan          = '代码扫描';
$lang->mr->scanSevereIssue   = '高危问题';
$lang->mr->scanOrdinaryIssue = '一般问题';
$lang->mr->scanPassRate      = '安全门禁通过率';
$lang->mr->runResult         = '执行结果';
...
$lang->mr->approvalResultList['approved'] = '通过';
$lang->mr->approvalResultList['rejected'] = '拒绝';
...
$lang->mr->draftTips          = '合并请求处于草稿状态，不可合并。';
...
$lang->mr->checkSourceBranch    = '源分支规则限制当前评审';
$lang->mr->checkTargetBranch    = '目标分支规则限制当前评审';
$lang->mr->checkConflicts       = '检测到代码冲突，请先在本地解决冲突后再创建合并请求。';
$lang->mr->checkReviewers       = '评审人必须包含%s';
$lang->mr->sourceBranchNotExist = '源分支不存在';
$lang->mr->targetBranchNotExist = '目标分支不存在';
...
$lang->mr->pipelineStatus['success']  = "成功";
$lang->mr->pipelineStatus['failed']   = "失败";
$lang->mr->pipelineStatus['canceled'] = "取消";
...
$lang->mr->checkSuccess      = '检查已通过，此分支允许合并';
$lang->mr->checkFailed       = '检查未通过，此分支无法合并';
$lang->mr->MRHistory         = "本次合并是由 <strong>%s</strong> 于 <strong>%s</strong> 创建，将 <label class='label primary size-sm px-2 cursor-pointer' data-on='click' data-call='copy' data-params='event'>%s<icon class='icon-copy ml-1'/></label> 的 <strong>%s</strong> 次提交，合并到 <label class='label primary size-sm px-2 cursor-pointer' data-on='click' data-call='copy' data-params='event'>%s<icon class='icon-copy ml-1'/></label> 。";

$lang->mr->checkStatusList = array();
$lang->mr->checkStatusList['fail']    = '未通过';
$lang->mr->checkStatusList['success'] = '已通过';
$lang->mr->checkStatusList['wait']    = '待确认';

$lang->mr->hasConflictList['yes'] = '是';
$lang->mr->hasConflictList['no']  = '否';
