...
r($mrModel->apiGetMRCommitsTester($hostID['gitlab'], $projectID['gitlab'], $mrID['gitlab'])) && p('short_id,author_name,message') && e('cedfe9a5,Administrator,Update README.md');        // 正确的Gitlab合并请求
