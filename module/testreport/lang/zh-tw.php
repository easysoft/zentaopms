...
$lang->testreport->bugSummary    = '共產生<strong>%s</strong>個Bug，遺留<strong>%s</strong>個Bug。有效Bug率（方案為已解決或延期 / 狀態為已解決或已關閉）：<strong>%s</strong>，用例發現Bug率（用例創建的Bug / 時間區間中新增的Bug）：<strong>%s</strong>';
