...
class deliverableModel extends model
{
     ...
     * @return array
     */
    public function getList(string $browseType = '', int $queryID = 0, string $orderBy = 'id_desc', object $pager = null): array
    {
     ...
     * @return bool
     */
    public function create(object $deliverable): bool
    {
     ...
     * @return array
     */
    public function buildModelList(string $type = 'all'): array
    {
