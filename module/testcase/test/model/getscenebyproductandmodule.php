...
r($testcase->getSceneByProductAndModuleTest($productIdList[1], $moduleIdList[0])) && p() && e('sceneMaps:1 2 3 4;topScenes:1 2 3;'); // 获取产品 1 模块 0 的场景信息
...
r($testcase->getSceneByProductAndModuleTest($productIdList[2], $moduleIdList[0])) && p() && e('sceneMaps:5 6 7 8;');                 // 获取产品 2 模块 0 的场景信息
r($testcase->getSceneByProductAndModuleTest($productIdList[2], $moduleIdList[1])) && p() && e('0');                                  // 获取产品 2 模块 1821 的场景信息
r($testcase->getSceneByProductAndModuleTest($productIdList[2], $moduleIdList[2])) && p() && e('sceneMaps:5;');                       // 获取产品 2 模块 1825 的场景信息
r($testcase->getSceneByProductAndModuleTest($productIdList[2], $moduleIdList[3])) && p() && e('0');                                  // 获取产品 2 模块 1829 的场景信息
r($testcase->getSceneByProductAndModuleTest($productIdList[3], $moduleIdList[0])) && p() && e('sceneMaps:9 10 11 12;');              // 获取产品 3 模块 0 的场景信息
...
r($testcase->getSceneByProductAndModuleTest($productIdList[3], $moduleIdList[3])) && p() && e('sceneMaps:10;');                      // 获取产品 3 模块 1829 的场景信息
