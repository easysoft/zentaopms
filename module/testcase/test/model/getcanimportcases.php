...
r(implode(',', array_keys($tester->testcase->getCanImportCases($productIdList[0], $libIdList[0], $branchList[0], $orderByList[0], null, $browseTypeList[1], $queryIdList[0])))) && p() && e('29,27,25,23,21');                // 测试获取产品 1 所有分支 用例库 0 分支 all 排序 id_desc browseType bysearch queryID 0 testsuiteQuery false 可以导入的用例
$tester->session->set('testsuiteQuery', $testsuiteQuery[0]);
r(implode(',', array_keys($tester->testcase->getCanImportCases($productIdList[0], $libIdList[0], $branchList[0], $orderByList[0], null, $browseTypeList[1], $queryIdList[1])))) && p() && e('0');                             // 测试获取产品 1 所有分支 用例库 0 分支 all 排序 id_desc browseType bysearch queryID 1 testsuiteQuery false 可以导入的用例
$tester->session->set('testsuiteQuery', $testsuiteQuery[1]);
r(implode(',', array_keys($tester->testcase->getCanImportCases($productIdList[0], $libIdList[0], $branchList[0], $orderByList[0], null, $browseTypeList[1], $queryIdList[0])))) && p() && e('30,29,28,27,26,25,24,23,22,21'); // 测试获取产品 1 所有分支 用例库 0 分支 all 排序 id_desc browseType bysearch queryID 0 testsuiteQuery "`lib` = 'all'" 可以导入的用例
$tester->session->set('testsuiteQuery', $testsuiteQuery[1]);
r(implode(',', array_keys($tester->testcase->getCanImportCases($productIdList[0], $libIdList[0], $branchList[0], $orderByList[0], null, $browseTypeList[1], $queryIdList[1])))) && p() && e('0');                             // 测试获取产品 1 所有分支 用例库 0 分支 all 排序 id_desc browseType bysearch queryID 1 testsuiteQuery "`lib` = 'all'" 可以导入的用例

$tester->session->set('testsuiteQuery', $testsuiteQuery[0]);
r(implode(',', array_keys($tester->testcase->getCanImportCases($productIdList[0], $libIdList[0], $branchList[1], $orderByList[0], null, $browseTypeList[1], $queryIdList[0])))) && p() && e('29,27,25,23,21');                // 测试获取产品 1 分支1 用例库 0 分支 all 排序 id_desc browseType bysearch queryID 0 testsuiteQuery false 可以导入的用例
$tester->session->set('testsuiteQuery', $testsuiteQuery[0]);
r(implode(',', array_keys($tester->testcase->getCanImportCases($productIdList[0], $libIdList[0], $branchList[1], $orderByList[0], null, $browseTypeList[1], $queryIdList[1])))) && p() && e('0');                             // 测试获取产品 1 分支1 用例库 0 分支 all 排序 id_desc browseType bysearch queryID 1 testsuiteQuery false 可以导入的用例
$tester->session->set('testsuiteQuery', $testsuiteQuery[1]);
r(implode(',', array_keys($tester->testcase->getCanImportCases($productIdList[0], $libIdList[0], $branchList[1], $orderByList[0], null, $browseTypeList[1], $queryIdList[0])))) && p() && e('30,29,28,27,26,25,24,23,22,21'); // 测试获取产品 1 分支1 用例库 0 分支 all 排序 id_desc browseType bysearch queryID 0 testsuiteQuery "`lib` = 'all'" 可以导入的用例
$tester->session->set('testsuiteQuery', $testsuiteQuery[1]);
r(implode(',', array_keys($tester->testcase->getCanImportCases($productIdList[0], $libIdList[0], $branchList[1], $orderByList[0], null, $browseTypeList[1], $queryIdList[1])))) && p() && e('0');                             // 测试获取产品 1 分支1 用例库 0 分支 all 排序 id_desc browseType bysearch queryID 1 testsuiteQuery "`lib` = 'all'" 可以导入的用例
