...
- 测试获取产品 1 模块 1 起始场景 0 分支 all 当前场景 0 无空值 的场景数组 @/,/场景6,/场景6/场景7,/场景6/场景7/场景8,/场景9,/场景10

- 测试获取产品 1 模块 0 起始场景 6 分支 all 当前场景 0 无空值 的场景数组 @/,/场景6,/场景6/场景7,/场景6/场景7/场景8

- 测试获取产品 1 模块 0 起始场景 0 分支 '0' 当前场景 0 无空值 的场景数组 @/,/场景1,/场景1/场景2,/场景3,/场景4,/场景5,/场景6,/场景6/场景7,/场景6/场景7/场景8,/场景9,/场景10

- 测试获取产品 1 模块 0 起始场景 0 分支 1 当前场景 0 无空值 的场景数组 @/,/场景1,/场景1/场景2,/场景3,/场景4,/场景5,/场景6,/场景6/场景7,/场景6/场景7/场景8,/场景9,/场景10

- 测试获取产品 1 模块 0 起始场景 0 分支 all 当前场景 6 无空值 的场景数组 @/,/场景1,/场景1/场景2,/场景3,/场景4,/场景5,/场景9,/场景10

- 测试获取产品 1 模块 0 起始场景 0 分支 all 当前场景 0 有空值 的场景数组 @/,/场景1,/场景1/场景2,/场景3,/场景4,/场景5,/场景6,/场景6/场景7,/场景6/场景7/场景8,/场景9,/场景10,空

- 测试获取产品 1 模块 1 起始场景 6 分支 '0' 当前场景 6 无空值 的场景数组 @/
- 测试获取产品 1 模块 1 起始场景 6 分支 '0' 当前场景 6 有空值 的场景数组 @/
- 测试获取产品 41 模块 0 起始场景 0 分支 all 当前场景 0 无空值 的场景数组 @/,/场景11,/场景11/场景12,/场景11/场景12/场景13,/场景11/场景12/场景13/场景14,/场景11/场景15,/场景16,/场景16/场景17,/场景18,/场景18/场景19,/场景18/场景19/场景20

- 测试获取产品 41 模块 2 起始场景 0 分支 all 当前场景 0 无空值 的场景数组 @/,/场景16,/场景16/场景17,/场景18,/场景18/场景19,/场景18/场景19/场景20

- 测试获取产品 41 模块 0 起始场景 6 分支 all 当前场景 0 无空值 的场景数组 @/,/场景16,/场景16/场景17

- 测试获取产品 41 模块 0 起始场景 0 分支 '0' 当前场景 0 无空值 的场景数组 @/,/分支1/场景16,/分支1/场景16/场景17,/分支1/场景18,/分支1/场景18/场景19,/分支1/场景18/场景19/场景20

- 测试获取产品 41 模块 0 起始场景 0 分支 1 当前场景 0 无空值 的åº景数组 @/,/分支1/场景16,/分支1/场景16/场景17,/分支1/场景18,/分支1/场景18/场景19,/分支1/场景18/场景19/场景20

- 测试获取产品 41 模块 0 起始场景 0 分支 all 当前场景 6 无空值 的场景数组 @/,/场景11,/场景11/场景12,/场景11/场景12/场景13,/场景11/场景12/场景13/场景14,/场景11/场景15,/场景18,/场景18/场景19,/场景18/场景19/场景20

- 测试获取产品 41 模块 0 起始场景 0 分支 all 当前场景 0 有空值 的场景数组 @/,/场景11,/场景11/场景12,/场景11/场景12/场景13,/场景11/场景12/场景13/场景14,/场景11/场景15,/场景16,/场景16/场景17,/场景18,/场景18/场景19,/场景18/场景19/场景20,空

- 测试获取产品 41 模块 2 起始场景 6 分支 '0' 当前场景 6 无空值 的场景数组 @/
- 测试获取产品 41 模块 2 起始场景 6 分支 '0' 当前场景 6 有空值 的场景数组 @/
...
r($testcase->getSceneMenuTest($productIdList[0], $moduleIdList[1], $sceneIdList[1], $branchIdList[1], $currentScene[1], $emptyMenu[0])) && p() && e('/');                                                                                                   // 测试获取产品 1 模块 1 起始场景 6 分支 '0' 当前场景 6 无空值 的场景数组
r($testcase->getSceneMenuTest($productIdList[0], $moduleIdList[1], $sceneIdList[1], $branchIdList[1], $currentScene[1], $emptyMenu[1])) && p() && e('/,空');                                                                                               // 测试获取产品 1 模块 1 起始场景 6 分支 '0' 当前场景 6 有空值 的场景数组
...
r($testcase->getSceneMenuTest($productIdList[1], $moduleIdList[0], $sceneIdList[0], $branchIdList[1], $currentScene[0], $emptyMenu[0])) && p() && e('/,/主干/场景11,/主干/场景11/场景12,/主干/场景11/场景12/场景13,/主干/场景11/场景12/场景13/场景14,/主干/场景11/场景15');                                                                     // 测试获取产品 41 模块 0 起始场景 0 分支 '0' 当前场景 0 无空值 的场景数组
...
r($testcase->getSceneMenuTest($productIdList[1], $moduleIdList[2], $sceneIdList[2], $branchIdList[1], $currentScene[2], $emptyMenu[0])) && p() && e('/');                                                                                                                                                                 // 测试获取产品 41 模块 2 起始场景 6 分支 '0' 当前场景 6 无空值 的场景数组
r($testcase->getSceneMenuTest($productIdList[1], $moduleIdList[2], $sceneIdList[2], $branchIdList[1], $currentScene[2], $emptyMenu[1])) && p() && e('/,空');                                                                                                                                                             // 测试获取产品 41 模块 2 起始场景 6 分支 '0' 当前场景 6 有空值 的场景数组
