...
- 测试插入用例 4 的用例步骤 @13,14,15,16,17,18,19
...
$steps4     = array('1' => 'group1', '1.1' => 'group1.1', '1.1.1' => 'item1.1.1', '2' => 'group2', '2.1' => 'item2.1', '2.1.1' => 'item2.1.1', '3' => 'step3');
$expects4   = array('1.1.1' => 'expect1.1.1', '2.1' => 'expect2.1', '2.1.1' => 'expect2.1.1', '3' => 'expect3');
$stepTypes4 = array('1' => 'group', '1.1' => 'group', '1.1.1' => 'item','2' => 'group', '2.1' => 'item', '2.1.1' => 'item', '3' => 'step');
...
r($testcase->insertStepsTest($caseIdList[3], $steps4, $expects4, $stepTypes4)) && p() && e('13,14,15,16,17,18,19'); // 测试插入用例 4 的用例步骤