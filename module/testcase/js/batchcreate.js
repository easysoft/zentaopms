$(document).ready(function()
{
    ...
    $(document).on('mouseup', '.chosen-with-drop', function()
    {
        ...
        if(id.indexOf('story') != -1)
        {
            ...
            link = createLink('story', 'ajaxGetProductStories', 'productID=' + productID + '&branch=' + branch + '&moduleID=' + module + '&storyID='+ $(select).val() + '&onlyOption=true&status=noclosed&limit=0&type=null');
