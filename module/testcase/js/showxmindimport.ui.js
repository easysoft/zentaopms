...
$(document).ready(function()
{
    ...
    $(document).on('click', '#xmindmapSave', function(e)
    {
...
{
    var parentNode = this.wraper.findParentNode(data);
    if(parentNode.$.type == "scene" && (data.$.type != "testcase" && data.$.type != "scene")) return [{action:"addTestcase", label:jsLng.set2Testcase}];
