...
{
<<<<<<<< HEAD:module/ppm/test/lib/mr.unittest.class.php
    public function __construct()
    {
        global $tester;
        $this->objectModel = $tester->loadModel('ppm');
        $this->objectTao   = $tester->loadTao('ppm');
    }
========
    protected $moduleName = 'mr';
    protected $className  = 'tao';
>>>>>>>> release/22.0.beta:module/ppm/test/lib/tao.class.php
