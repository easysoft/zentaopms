...
/**
 * The linktask file of ppm module of ZenTaoPMS.
...
jsVar('sortLink', createLink($moduleName, 'linkTask', "id=$id&repoID=$repoID&browseType=$browseType&param=$param&orderBy={orderBy}&recTotal={$pager->recTotal}&recPerPage={$pager->recPerPage}&pageID={$pager->pageID}"));
...
$footToolbar = array(
    ...
    (
        array(
            ...
            'data-app'  => $app->tab,
            'data-url'  => createLink($moduleName, 'linkTask', "id=$id&repoID=$repoID&browseType=$browseType&param=$param&orderBy=$orderBy")
        )
    ),
...
(
    ...
    set::footer(array('checkbox', 'toolbar', array('html' => html::a(inlink('link', "id=$id&type=task"), $lang->goback, '', "class='btn size-sm'")), 'flex', 'pager')),
