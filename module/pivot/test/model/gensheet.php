...
r($array) && p('0:self_bydesign_slice_resolution0,bydesign_slice_resolution0,self_duplicate_slice_resolution0,duplicate_slice_resolution0,willnotfix_slice_resolution0,self_willnotfix_slice_resolution0') && e('2,22.22,1,11.11,11.11,1');   //查看id为1025的透视表生成的切片数据是否正确。
