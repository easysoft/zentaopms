...
$config->stakeholder->dtable->fieldList['phone']['group'] = 3;
...
$config->stakeholder->dtable->fieldList['qq']['group'] = 4;
...
$config->stakeholder->dtable->fieldList['weixin']['group'] = 5;
...
$config->stakeholder->dtable->fieldList['email']['group'] = 6;
...
$config->stakeholder->dtable->fieldList['actions']['group']    = 7;
