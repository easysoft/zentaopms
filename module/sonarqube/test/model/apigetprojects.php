...
$keyword = 'special.key:test-123';
$projectKey = 'unittest-project';
$emptyKeyword = '';

// 测试步骤1：正常sonarqubeID获取项目列表
r(count($sonarqube->apiGetProjectsTest($validSonarqubeID)) > 0) && p() && e('1'); // 步骤1：正常情况
...
r(count($sonarqube->apiGetProjectsTest($validSonarqubeID, $emptyKeyword)) > 0) && p() && e('1'); // 步骤7：空关键字
