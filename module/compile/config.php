...
$config->compile->search['fields']['repo']        = $lang->pipeline->repo;
$config->compile->search['fields']['engine']      = $lang->compile->buildType;
$config->compile->search['fields']['triggerType'] = $lang->pipeline->triggerType;
...
$config->compile->search['params']['engine']      = array('operator' => '=',       'control' => 'select', 'values' => $lang->pipeline->engineList);
$config->compile->search['params']['triggerType'] = array('operator' => 'include', 'control' => 'select', 'values' => $lang->pipeline->triggerTypeList);
