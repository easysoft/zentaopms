...
检测token为空时获取的信息 >> pms.cc.cc/job/11/build/api/json
检测jenkins为空时获取的信息 >> /job//build/api/json
检测jenkins为空时获取的信息 >> :
...
r($compile->getBuildUrlTest($jenkins2)) && p('url')     && e('pms.cc.cc/job/11/build/api/json'); //检测token为空时获取的信息
