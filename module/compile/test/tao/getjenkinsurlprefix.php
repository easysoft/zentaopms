...
r($compile->getJenkinsUrlPrefix($urlList[0], $pipelineList[2])) && p() && e('http://www.baidu.com/test3/job/Job3/');   //测试当url为http://www.baidu.com, pipeline包含/job/且在开头的情况，生成的url链接是否正确。
r($compile->getJenkinsUrlPrefix($urlList[1], $pipelineList[2])) && p() && e('http://www.google.com/test3/job/Job3/');  //测试当url为http://www.google.com, pipeline不包含/job/的情况，生成的url链接是否正确。
