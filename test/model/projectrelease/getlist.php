...
查询projectID正常存在,type为all的发布 >> 产品发布9,normal
查询projectID正常存在,type为normal的发布 >> 产品发布9,normal
查询projectID正常存在,type为terminate的发布 >> 0
查询projectID正常存在,type为''的发布 >> 0
查询projectID正常存在的发布 >> 产品发布9,normal
...
r($projectrelease->getListTest($projectID[0], $type[0])) && p('0:name,status') && e('产品发布9,normal');    //查询projectID正常存在,type为all的发布
r($projectrelease->getListTest($projectID[0], $type[1])) && p('0:name,status') && e('产品发布9,normal');    //查询projectID正常存在,type为normal的发布
...
r($projectrelease->getListTest($projectID[0]))           && p('0:name,status') && e('产品发布9,normal');    //查询projectID正常存在的发布
