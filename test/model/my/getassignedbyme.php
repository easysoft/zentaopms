...
当插入一条action为admin指派了需求的动态时，查询结果为1条数据 >> 0
...
r($my->getAssignedByMeTest($story[0], $story[1], $story[2], $story[3], $story[4], $story[5])) && p() && e('1'); // 当插入一条action为admin指派了需求的动态时，查询结果为0条数据
