...
r($product->getStoriesTest($productIDList[1], $branch, $browseType[5], $queryID, $moduleID))  && p() && e('0');  // 测试获取产品2 browseType为reviewedbyme的需求数量
...
r($product->getStoriesTest($productIDList[2], $branch, $browseType[9], $queryID, $moduleID))  && p() && e('2');  // 测试获取产品3 browseType为activestory的需求数量
...
r($product->getStoriesTest($productIDList[2], $branch, $browseType[11], $queryID, $moduleID)) && p() && e('0');  // 测试获取产品3 browseType为willclose的需求数量
