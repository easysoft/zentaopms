...
测试获取产品1下的发布roadmap >> 产品1正常的发布1;产品1正常的发布3;产品1正常的里程碑发布5;产品1停止维护的里程碑发布6
测试获取产品2下的发布roadmap >> 产品2发布!@#$%^&*()测试发布的名称到底可以有多长asdlfkjla8
...
r($product->processRoadmapTest($productIDList[0])) && p('0:name;1:name;2:name;3:name') && e('产品1正常的发布1;产品1正常的发布3;产品1正常的里程碑发布5;产品1停止维护的里程碑发布6');   // 测试获取产品1下的发布roadmap
r($product->processRoadmapTest($productIDList[1])) && p('0:name')                      && e('产品2发布!@#$$%^&*()测试发布的名称到底可以有多长asdlfkjla8');                            // 测试获取产品2下的发布roadmap
