...
测试获取统计数据集中产品1的stats信息 >> 正常产品1,0,4,9
...
测试获取统计数据集中产品2的stats信息 >> 正常产品2,0,1,4
...
测试获取统计数据集中产品9的stats信息 >> 正常产品9,1,0,4
...
r($product->statisticProgramTest($productStats, '0')) && p('1:name,plans,releases,bugs')   && e('正常产品1,0,4,9');     // 测试获取统计数据集中产品1的stats信息
...
r($product->statisticProgramTest($productStats, '1')) && p('2:name,plans,releases,bugs')   && e('正常产品2,0,1,4');     // 测试获取统计数据集中产品2的stats信息
...
r($product->statisticProgramTest($productStats, '8')) && p('9:name,plans,releases,bugs')   && e('正常产品9,1,0,4');     // 测试获取统计数据集中产品9的stats信息