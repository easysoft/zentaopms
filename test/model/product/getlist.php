...
r($product->getAllProductsCount($t_numproject[1]))      && p() && e('9');   // 返回项目集1下的产品数量
r($product->getAllProductsCount($t_numproject[0]))      && p() && e('100'); // 测试传入programID=0的情况
...
r($product->getNoclosedProductsCount($t_numproject[0])) && p() && e('60');  // 获取所有的未关闭的产品数量
...
r($product->countProductsByLine($t_numproject[1], $t_numproject[1]))   && p() && e('9');   // 返回项目集1下产品线1的产品数量
