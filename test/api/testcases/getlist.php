...
$existProductCases = $rest->get('/products/2/testcases?page=1&limit=100&order=id_asc', $token);
$noProductCases    = $rest->get('/products/1000/testcases?page=1&limit=10&order=id_asc', $token);
