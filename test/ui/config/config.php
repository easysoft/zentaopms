...
/* 项目配置 */
$config->zentaopms = new stdclass;
$config->zentaopms->defaultAccount  = 'admin';
$config->zentaopms->defaultPassword = '123Qwe!@#';

$config->zentaopms->db = new stdclass;
$config->zentaopms->db->host     = 'localhost';
$config->zentaopms->db->port     = '3306';
$config->zentaopms->db->name     = 'ta' . time();
$config->zentaopms->db->password = '123456';
