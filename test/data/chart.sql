...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1001, '年度总结-登录次数', 1, 'card', '0', '', '{"value": {"type": "agg", "field": "login", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1002, '年度总结-操作次数', 1, 'card', '0', '', '{"value": {"type": "agg", "field": "allAction", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
WHERE t1.deleted = \'0\'
GROUP BY `year`, account, realname', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1003, '年度总结-消耗工时', 1, 'card', '0', '', '{"value": {"type": "agg", "field": "consumed", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1004, '年度总结-待办数', 1, 'card', '0', '', '{"value": {"type": "agg", "field": "todo", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1005, '年度总结-贡献数', 1, 'card', '0', '', '{"value": {"type": "agg", "field": "num", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1006, '年度总结-贡献数据', 1, 'bar', '0', '', '{
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1007, '年度总结-能力雷达图', 1, 'radar', '0', '', '{
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1008, '年度总结-迭代数据', 1, 'table', '0', '', '{"group":[],"column":[
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1009, '年度总结-产品数据', 1, 'table', '0', '', '{"group":[],"column":[
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1010, '年度总结-任务状态分布', 1, 'pie', '0', '', '{"group":[{"field":"status","name":"状态"}],"metric":[{"type":"agg","field":"id","agg":"count","name":"任务数","valOrAgg":"count"}]}', '[]', 0, '', null, 'SELECT
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1011, '年度总结-每月任务操作情况', 1, 'bar', '0', '', '{
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1012, '年度总结-需求状态分布', 1, 'pie', '0', '', '{"group":[{"field":"status","name":"状态"}],"metric":[{"type":"agg","field":"id","agg":"count","name":"需求数","valOrAgg":"count"}]}', '[]', 0, '', null, 'SELECT
YEAR(t1.date) AS `year`,
t3.account,
t3.realname,
CASE t2.status
...
and t2.deleted = \'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1013, '年度总结-每月需求操作情况', 1, 'bar', '0', '', '{
  "xaxis":[{"field":"actionDate","name":"日期","group":"value"}],
...
GROUP BY t2.actionDate,deptName,t1.account,realname
', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1014, '年度总结-Bug状态分布', 1, 'pie', '0', '', '{"group":[{"field":"status","name":"状态"}],"metric":[{"type":"agg","field":"id","agg":"count","name":"Bug数","valOrAgg":"count"}]}', '[]', 0, '', null, 'SELECT
...
and t2.deleted = \'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1015, '年度总结-每月Bug操作情况', 1, 'bar', '0', '', '{
  "xaxis":[{"field":"actionDate","name":"日期","group":"value"}],
  "yaxis":[{"type":"value","field":"opened","agg":"value","name":"创建","valOrAgg":"value"},
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1017, '年度总结-每月用例操作情况', 1, 'bar', '0', '', '{
  "xaxis":[{"field":"actionDate","name":"日期","group":"value"}],
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1018, '宏观数据-一级项目集个数', 1, 'card', '45', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1019, '宏观数据-项目个数', 1, 'card', '46', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1020, '宏观数据-产品个数', 1, 'card', '47', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1021, '宏观数据-计划个数', 1, 'card', '48', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', null, 'SELECT id FROM zt_productplan WHERE deleted=\'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1022, '宏观数据-执行个数', 1, 'card', '49', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1023, '宏观数据-发布个数', 1, 'card', '50', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', null, 'SELECT id FROM zt_release WHERE deleted=\'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1024, '宏观数据-需求个数', 1, 'card', '51', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', null, 'SELECT id FROM zt_story WHERE deleted=\'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1025, '宏观数据-任务个数', 1, 'card', '52', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', null, 'SELECT id FROM zt_task WHERE deleted=\'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1026, '宏观数据-缺陷个数', 1, 'card', '53', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', null, 'SELECT id FROM zt_bug WHERE deleted=\'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1027, '宏观数据-文档个数', 1, 'card', '54', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', null, 'SELECT id FROM zt_doc WHERE deleted=\'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1028, '宏观数据-现有人员个数', 1, 'card', '55', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', null, 'SELECT id FROM zt_user WHERE deleted=\'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1029, '宏观数据-累计消耗工时', 1, 'card', '55', '', '{"value": {"type": "agg", "field": "consumed", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', null, 'SELECT consumed FROM zt_effort WHERE deleted=\'0\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1030, '宏观数据-禅道使用时长', 1, 'card', '58', '', '{"value": {"type": "value", "field": "period", "agg": "value"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1033, '宏观数据-未完成的一级项目集个数', 1, 'card', '45', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1034, '宏观数据-未完成的需求', 1, 'card', '51', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1035, '宏观数据-未完成的产品', 1, 'card', '47', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1036, '宏观数据-未完成的项目', 1, 'card', '46', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1037, '宏观数据-未完成的计划', 1, 'card', '48', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1038, '宏观数据-未完成的执行', 1, 'card', '49', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1039, '宏观数据-未完成的缺陷', 1, 'card', '53', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1040, '宏观数据-未完成的任务', 1, 'card', '52', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1041, '宏观数据-项目集数据概览', 1, 'table', '64', '', '{"group":[],"column":[
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1045, '宏观数据-产品数据概览', 1, 'table', '63', '', '{"group":[],"column":[
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1055, '年度新增-一级项目集个数', 1, 'card', '45', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1056, '年度新增-产品个数', 1, 'card', '47', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1057, '年度新增-需求个数', 1, 'card', '51', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1058, '年度新增-Bug个数', 1, 'card', '53', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1059, '年度新增-计划个数', 1, 'card', '48', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1060, '年度新增-项目个数', 1, 'card', '46', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1061, '年度新增-执行个数', 1, 'card', '49', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
...
WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1062, '年度新增-任务数', 1, 'card', '52', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1063, '年度新增-文档个数', 1, 'card', '54', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1064, '年度新增-发布个数', 1, 'card', '50', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1065, '年度新增-人员个数', 1, 'card', '56', '', '{"value": {"type": "agg", "field": "account", "agg": "count"}, "title": {"type": "text", "realname": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.account,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1066, '年度新增-完成项目数', 1, 'card', '46', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
t1.`year`,
t2.id,
...
AND deleted = \'0\'
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1067, '年度新增-完成执行数', 1, 'card', '49', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT t1.`year`, t2.id, t2.name
FROM (SELECT DISTINCT YEAR(date) AS "year" FROM zt_action) AS t1
...
WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1068, '年度新增-完成发布数', 1, 'card', '50', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
	...
	LEFT JOIN ( SELECT id, name, YEAR ( `date` ) AS `year` FROM zt_release WHERE deleted = \'0\') AS t2 ON t1.`year` = t2.`year`
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1069, '年度新增-完成需求数', 1, 'card', '51', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1070, '年度新增-解决Bug数', 1, 'card', '53', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1071, '年度新增-完成任务数', 1, 'card', '52', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
	t2.id,
...
FROM
 ...
 WHERE t2.id IS NOT NULL', 'published', 1, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1072, '年度新增-投入工时数', 1, 'card', '57', '', '{"value": {"type": "value", "field": "consumed", "agg": "value"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '', 0, null, null, 'SELECT
	t1.`year`,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1073, '年度新增-项目集年度新增数据汇总表', 1, 'table', '64', '', '{"group":[],"column":[
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1074, '年度新增-项目集年度完成数据概览', 1, 'table', '64', '', '{"group":[],"column":[
{"field":"topProgram","valOrAgg":"value","name":"一级项目集"},
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1075, '年度新增-产品年度新增数据汇总表', 1, 'table', '63', '', '{"group":[],"column":[
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1076, '年度新增-产品年度完成数据汇总表', 1, 'table', '63', '', '{"group":[],"column":[
{"field":"name","valOrAgg":"value","name":"产品"},
{"field":"story","valOrAgg":"value","name":"需求数"},
{"field":"bug","valOrAgg":"value","name":"Bug数"},
{"field":"plan","valOrAgg":"value","name":"计划数"},
...
ORDER BY `year`, t1.month', 'published', 0, '', 'system', null, '', null, 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (1083, '年度新增-年度投入产出比', 1, 'line', '45', '', '{
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10000, '年度完成项目-完成项目数', 2, 'card', '72', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10001, '年度完成项目-按时完成项目数', 2, 'card', '72', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10002, '年度完成项目-延期完成项目数', 2, 'card', '72', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', '', 'SELECT COUNT(1) AS number,YEAR(`closedDate`) AS \'year\' FROM (SELECT id, begin, end, IF(left(realEnd, 4) = \'0000\', LEFT(closedDate,10), realEnd) AS realEnd,closedDate FROM zt_project WHERE deleted=\'0\' AND type=\'project\' AND status=\'closed\') t1 WHERE t1.realEnd>end GROUP BY `year`', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10003, '年度完成项目-完成需求条目数', 2, 'card', '75', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10004, '年度完成项目-完成需求规模数', 2, 'card', '75', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10005, '年度完成项目-完成发布数', 2, 'card', '74', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10006, '年度完成项目-解决bug数', 2, 'card', '77', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10007, '年度完成项目-完成执行数', 2, 'card', '73', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10008, '年度完成项目-按时完成执行数', 2, 'card', '73', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', '', 'SELECT COUNT(1) AS number,YEAR(`closedDate`) AS \'year\' FROM (SELECT id, begin, end, IF(LEFT(realEnd,4) = \'0000\', LEFT(closedDate,10), realEnd) AS realEnd,closedDate FROM zt_project WHERE deleted=\'0\' AND type=\'sprint\' AND status=\'closed\') t1 WHERE t1.realEnd<=end GROUP BY `year`', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10009, '年度完成项目-延期完成执行数', 2, 'card', '73', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
}', '[]', 0, '', '', 'SELECT COUNT(1) AS number,YEAR(`closedDate`) AS \'year\' FROM (SELECT id, begin, end, IF(LEFT(realEnd, 4) = \'0000\', LEFT(closedDate,10), realEnd) AS realEnd, closedDate FROM zt_project WHERE deleted=\'0\' AND type=\'sprint\' AND status=\'closed\') t1 WHERE t1.realEnd>end GROUP BY `year`', 'published', 1, '', 'system', '2022-12-07 14:59:41', '', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10010, '年度完成项目-完成任务条目数', 2, 'card', '76', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10011, '年度完成项目-完成任务预计工时数', 2, 'card', '78', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10012, '年度完成项目-完成任务消耗工时数', 2, 'card', '78', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10013, '年度完成项目-投入的总人天', 2, 'card', '78', '', '{"value": {"type": "agg", "field": "number", "agg": "sum"}, "title": {"type": "text", "name": ""},
"type": "value"
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10104, '年度进行中项目-进展顺利迭代数', 2, 'card', '73', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', '', 'SELECT id, prograss, planPrograss, `end`
FROM (
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10106, '年度进行中项目-进度滞后迭代数', 2, 'card', '73', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', '', 'SELECT id, prograss, planPrograss
FROM (
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10110, '年度进行中项目-未完成任务数', 2, 'card', '76', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', '', 'SELECT DISTINCT t2.id
FROM zt_project AS t1
LEFT JOIN zt_task AS t2 ON t1.id = t2.execution
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10111, '年度进行中项目-未完成需求规模数', 2, 'card', '75', '', '{"value": {"type": "agg", "field": "estimate", "agg": "sum"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', '', 'SELECT DISTINCT t3.id, t3.estimate
FROM zt_project AS t1
LEFT JOIN zt_projectstory AS t2 ON t1.id = t2.project
LEFT JOIN zt_story AS t3 ON t2.story = t3.id
WHERE t1.deleted = \'0\' AND t1.status = \'doing\' AND t1.type = \'project\'
AND t3.deleted = \'0\' AND t3.stage NOT IN (\'verified\', \'released\', \'closed\')', 'published', 1, '', 'system', '2022-12-07 14:59:41', 'admin', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10112, '年度进行中项目-剩余工时数', 2, 'card', '78', '', '{"value": {"type": "agg", "field": "taskleft", "agg": "sum"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', '', 'SELECT t1.id, t1.name, `taskleft`
FROM zt_project AS t1
LEFT JOIN (
    SELECT t22.project,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10113, '年度进行中项目-投入总人次', 2, 'card', '78', '', '{"value": {"type": "agg", "field": "id", "agg": "count"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', '', 'SELECT t1.id,t1.type,t1.account
FROM zt_team AS t1
...
AND t1.status = \'doing\'
AND t1.type = \'project\'', 'published', 1, '', 'system', '2022-12-07 14:59:41', 'admin', '2022-12-07 14:59:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10117, '年度进行中项目-迭代进度透视表', 2, 'table', '84', '', '{"group":[],"column":[{"field":"project","valOrAgg":"value","name":"项目"},{"field":"name","valOrAgg":"value","name":"迭代"},{"field":"begin","valOrAgg":"value","name":"计划开始日期"},{"field":"end","valOrAgg":"value","name":"计划完成日期"},{"field":"planDuration","valOrAgg":"value","name":"计划工期"},{"field":"realBegan","valOrAgg":"value","name":"实际开始日期"},{"field":"realDuration","valOrAgg":"value","name":"剩余工期天数"},{"field":"prograss","valOrAgg":"value","name":"工期进度"},{"field":"status","valOrAgg":"value","name":"进度状态"}],"filter":[]}', '[]', 0, '', '', 'SELECT id, name,project,`begin`, `end`, planDuration, IF(LEFT(realBegan, 4) = \'0000\', \'/\', realBegan) as realBegan, realDuration, CONCAT(prograss, \'%\') as prograss,
IF(
    DATEDIFF(`end`, NOW()) < 0,
    "延期",
    (IF(
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10118, '年度进行中项目-项目剩余工作量透视表', 2, 'table', '83', '', '{"group":[],"column":[{"field":"program","valOrAgg":"value","name":"一级项目集"},{"field":"project","valOrAgg":"value","name":"项目"},{"field":"story","valOrAgg":"value","name":"剩余需求数"},{"field":"estimate","valOrAgg":"value","name":"剩余需求规模数"},{"field":"execution","valOrAgg":"value","name":"剩余执行数"},{"field":"workhour","valOrAgg":"value","name":"剩余工时"}],"filter":[]}', '[]', 0, '', '', 'SELECT
  t1.id,
  t1.name AS project,
  IFNULL(t2.name, \'/\') AS program,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10119, '年度进行中项目-迭代剩余工作量透视表', 2, 'table', '83', '', '{"group":[],"column":[{"field":"project","valOrAgg":"value","name":"项目"},{"field":"execution","valOrAgg":"value","name":"迭代"},{"field":"story","valOrAgg":"value","name":"剩余需求数"},{"field":"estimate","valOrAgg":"value","name":"剩余需求规模数"},{"field":"task","valOrAgg":"value","name":"剩余任务数"},{"field":"workhour","valOrAgg":"value","name":"剩余工时"}],"filter":[]}', '[]', 0, '', '', 'SELECT
  t1.id,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (10212, '质量数据-有效Bug率年度趋势图', 3, 'line', '91', '', '[{"type":"line","xaxis":[{"field":"year","name":"year","group":""}],"yaxis":[{"field":"effectiveBugRate","name":"effectiveBugRate","valOrAgg":"sum"}]}]', '[{"field":"year","type":"select","name":"\\u5e74\\u4efd"}]', 4, '{"year":{"name":"year","object":"bug","field":"year","type":"string"},"totalBugCount":{"name":"totalBugCount","object":"bug","field":"totalBugCount","type":"string"},"effectiveBugCount":{"name":"effectiveBugCount","object":"bug","field":"effectiveBugCount","type":"number"},"effectiveBugRate":{"name":"effectiveBugRate","object":"bug","field":"effectiveBugRate","type":"number"}}', '{"year":{"zh-cn":"\\u5e74\\u4efd","zh-tw":"","en":"Year","de":"","fr":""},"totalBugCount":{"zh-cn":"Bug\\u603b\\u6570","zh-tw":"","en":"Total Bug Count","de":"","fr":""},"effectiveBugCount":{"zh-cn":"\\u6709\\u6548Bug\\u6570","zh-tw":"","en":"Effective Bug Count","de":"","fr":""},"effectiveBugRate":{"zh-cn":"\\u6709\\u6548Bug\\u7387","zh-tw":"","en":"Effective Bug Rate","de":"","fr":""}}', 'select
year,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20003, '活跃账号情况-公司账号日活跃度趋势', 1, 'line', '56', '', '{
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20004, '应用数据-活跃产品数', 1, 'card', '47', '', '{"value": {"type": "value", "field": "count", "agg": "value"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', null, 'select count(distinct REPLACE(product, \',\', \'\')) as count, year(date) as year, month(date) as month
from zt_action
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20005, '应用数据-本月新增产品数', 1, 'card', '47', '', '{"value": {"type": "value", "field": "count", "agg": "value"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', null, 'SELECT DISTINCT YEAR(createdDate) AS year, MONTH(createdDate) AS month, count(id) as count FROM zt_product
WHERE deleted = \'0\' AND shadow = \'0\'
GROUP BY YEAR(createdDate), MONTH(createdDate)', 'published', 1, '', 'system', '2023-08-16 13:37:24', 'admin', '2023-08-16 13:37:24', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20006, '应用数据-本月新增产品名', 1, 'card', '47', '', '{"value": {"type": "text", "field": "name", "agg": "value"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', null, 'SELECT DISTINCT GROUP_CONCAT(name) AS name, YEAR(createdDate) AS year, MONTH(createdDate) AS month FROM zt_product
WHERE deleted = \'0\' AND shadow = \'0\'
GROUP BY YEAR(createdDate), MONTH(createdDate)
', 'published', 1, '', 'system', '2023-08-16 13:37:24', 'admin', '2023-08-16 13:37:24', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20007, '应用数据-活跃项目数', 1, 'card', '46', '', '{"value": {"type": "value", "field": "count", "agg": "value"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', null, 'select year(date) as year, month(date) as month, count(distinct project) as count
from zt_action
where project != 0
group by year(date), month(date)', 'published', 1, '', 'system', '2023-08-16 13:37:24', 'admin', '2023-08-16 13:37:24', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20008, '应用数据-本月新增项目数', 1, 'card', '46', '', '{"value": {"type": "value", "field": "count", "agg": "value"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', null, 'SELECT COUNT(id) as count, YEAR(openedDate) AS year, MONTH(openedDate) AS month FROM zt_project
WHERE deleted = \'0\' AND type = \'project\'
GROUP BY YEAR(openedDate), MONTH(openedDate)', 'published', 1, '', 'system', '2023-08-16 13:37:24', 'admin', '2023-08-16 13:37:24', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20009, '应用数据-本月新增项目名 ', 1, 'card', '46', '', '{"value": {"type": "text", "field": "name", "agg": "value"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', null, 'SELECT DISTINCT GROUP_CONCAT(name) AS name, YEAR(openedDate) AS year, MONTH(openedDate) AS month FROM zt_project
WHERE deleted = \'0\' AND type = \'project\'
GROUP BY YEAR(openedDate), MONTH(openedDate)
', 'published', 1, '', 'system', '2023-08-16 13:37:24', 'admin', '2023-08-16 13:37:24', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20010, '应用数据-项目任务概况表', 1, 'table', '39', '', '{"group":[],"column":[{"field":"name","valOrAgg":"value","name":"项目"},{"field":"createdTasks","valOrAgg":"value","name":"新增任务数"},{"field":"contributors","valOrAgg":"value","name":"新增任务人数"},{"field":"finishedTasks","valOrAgg":"value","name":"完成任务数"}],"filter":[]}', '[]', 0, '', null, 'SELECT
	t1.name,
	t4.year,
	t4.month,
	t1.createdTasks,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20011, '应用数据-产品测试表', 1, 'table', '44', '', '{"group":[],"column":[{"field":"name","valOrAgg":"value","name":"产品"},{"field":"createdCases","valOrAgg":"value","name":"新增用例数"},{"field":"avgBugsOfCase","valOrAgg":"value","name":"用例平均Bug数"},
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20012, '应用数据-产品需求概况表', 1, 'table', '36', '', '{"group":[],"column":[{"field":"name","valOrAgg":"value","name":"产品"},{"field":"createdStories","valOrAgg":"value","name":"新增研发需求数"},{"field":"deliveredStories","valOrAgg":"value","name":"交付需求数"}],"filter":[]}', '[]', 0, '', null, 'SELECT * FROM
(
SELECT
	t1.id,
	t1.name,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20013, '应用数据-项目需求概况表', 1, 'table', '43', '', '{"group":[],"column":[{"field":"name","valOrAgg":"value","name":"项目"},{"field":"createdStories","valOrAgg":"value","name":"新增研发需求数"},{"field":"deliveredStories","valOrAgg":"value","name":"交付需求数"}],"filter":[]}', '[]', 0, '', null, 'SELECT * FROM (
SELECT
	t1.id,
	t1.name,
	t3.year,
...
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20014, '使用数据分析-当前版本', 1, 'card', '58', '', '{"value": {"type": "value", "field": "version", "agg": "value"}, "title": {"type": "text", "name": ""}, "type": "value"}', '', 0, '', null, 'SELECT REPLACE(REPLACE(REPLACE(value, \'max\', \'旗舰版\'), \'biz\', \'企业版\'), \'pro\', \'专业版\') as version FROM zt_config WHERE owner = \'system\' AND module = \'common\' AND section = \'global\' AND `key` = \'version\'', 'published', 1, '', 'system', '2023-08-16 15:28:35', 'admin', '2023-08-16 15:28:41', 0);
INSERT INTO zt_chart (id, name, dimension, type, `group`, `desc`, settings, filters, step, fields, langs, `sql`, stage, builtin, objects, createdBy, createdDate, editedBy, editedDate, deleted) VALUES (20015, '使用数据分析-上线时间', 1, 'card', '58', '', '{"value": {"type": "value", "field": "date", "agg": "value"}, "title": {"type": "text", "name": ""}, "type": "value"}', '[]', 0, '', null, 'select `value` as date from zt_config where `owner` = \'system\' and `key` = \'installedDate\'', 'published', 1, '', 'system', '2023-08-16 15:32:10', 'admin', '2023-08-16 15:32:17', 0);
