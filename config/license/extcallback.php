...
function ioncube_event_handler($err_code, $params)
{
    ...
    $expired = "
        ...
        <div style='text-align:center; margin: 13px 0px;'>
            ...
            <a href='{$extensionLink}' target='_top' class='btn btn-wide btn-default'>卸载插件</a>
            <a href='{$homePageLink}' target='_blank' class='btn btn-wide primary' style='margin-left: 20px;'>返回首页</a>
        </div>
        <br /> <br /> <br />
        ...
        <div style='text-align:left; margin: 0px 20%;'>
         ...
         <div style='text-align:center; margin: 13px 0px;'>
            ...
            <a href='{$extensionLink}' target='_top' class='btn item btn-wide btn-default'>Delete Plugin</a>
