...
function ioncube_event_handler($err_code, $params)
{
    ...
    $expired = "
        ...
        <a href='https://www.zentao.net/extension-browse.html' target='_blank' class='btn' style='margin-right: 20px;'>下载更新</a>
        <a href='{$extensionLink}' target='_top' class='btn' style='background-color: #fff; border-color: #d6dae3; color: #3c4353;'>卸载插件</a>
        </p>
        <br /> <br /> <br />
        ...
        <p style='text-align:center'>
        <a href='https://www.zentao.net/extension-browse.html' target='_blank' class='btn' style='margin-right: 20px;'>Download Update</a>
        <a href='{$extensionLink}' target='_top' class='btn' style='background-color: #fff; border-color: #d6dae3; color: #3c4353;'>Delete Plugin</a>
        </p>
        </body>
        </html>
        ";
    $server = "
        ...
        <p style='text-align:center'>
        <a href='https://www.zentao.net/extension-browse.html' target='_blank' class='btn' style='margin-right: 20px;'>Download Update</a>
        <a href='{$extensionLink}' target='_top' class='btn' style='background-color: #fff; border-color: #d6dae3; color: #3c4353;' data-app='execution'>Delete Plugin</a>
        </p>
        </body>
        </html>
        ";
