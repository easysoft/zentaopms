...
$config->programPriv->noSprint      = array('task', 'story', 'requirement', 'epic', 'productplan', 'tree', 'project', 'execution', 'projectbuild', 'bug', 'testcase', 'testtask', 'testreport', 'doc', 'repo', 'stakeholder', 'projectrelease', 'issue', 'risk', 'opportunity', 'meeting', 'pssp', 'auditplan', 'nc', 'review', 'reviewissue', 'weekly', 'projectdeliverable', 'build', 'testcase');
$config->programPriv->scrum         = array('task', 'story', 'requirement', 'epic', 'productplan', 'tree', 'projectplan', 'projectstory', 'projectrelease', 'project', 'execution', 'projectbuild', 'bug', 'testcase', 'testreport', 'doc', 'repo', 'meeting', 'stakeholder', 'testtask', 'issue', 'risk', 'opportunity', 'weekly', 'review', 'reviewissue', 'report', 'mr', 'projectdeliverable', 'build', 'testcase');
...
$config->hasDropmenuApps        = array('program', 'project', 'product', 'execution', 'qa', 'admin', 'bi', 'feedback', 'demandpool', 'devops');
...
$config->excludeDropmenuModules = array('reporttemplate', 'space');
