...
禅道首次创造性的将产品、项目、测试这三者的概念明确分开，互相配合，又互相制约，通过需求、任务、BUG来进行交相互动，终通过项目拿到合格的产品。在此基础上，又融入了国内研发现状的很多需求，比如BUG管理、测试用例管理、发布管理和文档管理等。

企业级项目管理：组织级、团队级、执行级；其中团队级项目管理方式使用 Scrum模型、CMMI和看板模型；执行级以产品需求为核心，关联bug、用例、任务等，涵盖项目的全生命周期管理。

在数据可视化、度量、DevOPS、文档资产管理、自动化测试等模块的加持下，禅道软件形成了项目流程管理、DevOps一体化、自动化测试三大解决方案助力企业项目落地和效能提升。
