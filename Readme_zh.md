...
禅道首次创造性的将产品、项目、测试这三者的概念明确分开，互相配合，又互相制约，通过需求、任务、BUG 来进行交相互动，终通过项目拿到合格的产品。

在此基础上，又融入了国内研发现状的很多需求，比如 BUG 管理、测试用例管理、发布管理和文档管理等。

企业级项目管理：组织级、团队级、执行级：

其中团队级项目管理方式使用 Scrum 模型、CMMI 和看板模型；执行级以产品需求为核心，关联 BUG、用例、任务等，涵盖项目的全生命周期管理。
