<?php
$config->chat->mimes['default'] = 'application/octet-stream';
$config->chat->mimes['txt']     = 'text/plain';
$config->chat->mimes['jpg']     = 'image/jpeg';
$config->chat->mimes['jpeg']    = 'image/jpeg';
$config->chat->mimes['gif']     = 'image/gif';
$config->chat->mimes['png']     = 'image/png';
