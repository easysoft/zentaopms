        ...
        <tr>
          ...
          <td colspan='2'>
            ...
            <?php else:?>
              ...
              <?php echo html::a(helper::createLink('setting', 'downloadXXD', 'type=package'), $lang->chat->downloadXXD, 'hiddenwin', "class='btn btn-primary download download-package $disabled'");?>
              <?php echo html::a(helper::createLink('setting', 'downloadXXD', 'type=config'), $lang->chat->downloadConfig, 'hiddenwin', "class='btn btn-primary download $disabled'");?>
