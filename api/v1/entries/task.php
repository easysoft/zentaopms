...
class taskEntry extends Entry
{
    ...
    public function put($taskID)
    {
        ...
        /* Set $_POST variables. */
        $fields = 'name,type,desc,assignedTo,pri,estimate,left,consumed,story,parent,execution,module,closedReason,status,estStarted,deadline,team,teamEstimate,multiple';
