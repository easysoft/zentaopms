...
INSERT INTO `zt_grouppriv` (`group`, `module`, `method`) SELECT `group`, 'doc', 'createSpace' FROM `zt_grouppriv` WHERE `module` = 'doc' AND `method` = 'createLib';
INSERT INTO `zt_grouppriv` (`group`, `module`, `method`) SELECT `group`, 'doc', 'editSpace' FROM `zt_grouppriv` WHERE `module` = 'doc' AND `method` = 'editLib';
INSERT INTO `zt_grouppriv` (`group`, `module`, `method`) SELECT `group`, 'doc', 'deleteSpace' FROM `zt_grouppriv` WHERE `module` = 'doc' AND `method` = 'deleteLib';
