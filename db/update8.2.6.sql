...
ADD `groups` varchar(255) NOT NULL AFTER `name`,
...
ADD `users` text NOT NULL AFTER `groups`;
ALTER TABLE `zt_doclib` ADD `acl` varchar(10) NOT NULL DEFAULT 'open' AFTER `name`;
ALTER TABLE `zt_doc` ADD `acl` varchar(10) NOT NULL DEFAULT 'open' AFTER `editedDate`;
ALTER TABLE `zt_doclib` ADD `main` enum('0','1') NOT NULL DEFAULT '0' AFTER `users`;
