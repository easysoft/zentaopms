...
CREATE OR REPLACE FUNCTION MYSQL_YEAR(date) RETURNS bigint
LANGUAGE sql IMMUTABLE AS $$SELECT EXTRACT(YEAR FROM $1)::bigint$$;

--

CREATE OR REPLACE FUNCTION MYSQL_YEAR(timestamp) RETURNS bigint
LANGUAGE sql IMMUTABLE AS $$SELECT EXTRACT(YEAR FROM $1)::bigint$$;

--

CREATE OR REPLACE FUNCTION MYSQL_YEAR(timestamptz) RETURNS bigint
LANGUAGE sql IMMUTABLE AS $$SELECT EXTRACT(YEAR FROM $1)::bigint$$;
