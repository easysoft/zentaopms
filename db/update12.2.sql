ALTER TABLE `zt_job` ADD `frame` varchar(20) NOT NULL AFTER `repo`;
...
ALTER TABLE `zt_case` ADD `auto` varchar(10) NOT NULL DEFAULT 'no' AFTER `type`;
ALTER TABLE `zt_case` ADD `frame` varchar(10) NOT NULL AFTER `auto`;
...
ALTER TABLE `zt_testtask` ADD `auto` varchar(10) NOT NULL DEFAULT 'no' AFTER `status`;
