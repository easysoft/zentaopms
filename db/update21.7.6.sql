...
UPDATE `zt_ai_miniprogram` SET `model` = '' WHERE `model` = '0' OR `model` = 'default';
UPDATE `zt_ai_prompt` SET `model` = '' WHERE `model` = '0' OR `model` = 'default';
UPDATE `zt_ai_promptrole` SET `model` = '' WHERE `model` = '0' OR `model` = 'default';
