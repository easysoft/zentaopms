ALTER TABLE `zt_action` CHANGE `extra` `extra` text NOT NULL AFTER `comment`;
ALTER TABLE `zt_release` ADD `leftBugs` text NOT NULL AFTER `bugs`;
ALTER TABLE `zt_release` ADD `status` varchar(20) NOT NULL DEFAULT 'normal' AFTER `desc`;
ALTER TABLE `zt_product` ADD `type` varchar(30) NOT NULL DEFAULT 'normal' AFTER `code`;
...
ALTER TABLE `zt_user` ADD `ranzhi` char(30) NOT NULL DEFAULT '' AFTER `locked`;
