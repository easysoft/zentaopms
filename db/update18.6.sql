...
REPLACE INTO
    `zt_priv` (`id`, `module`, `method`, `parent`, `edition`, `vision`, `system`, `order`)
VALUES
    (2117, 'ai', 'models', 653, ',open,biz,max,ipd,', ',rnd,', '1', 5),
    (2118, 'ai', 'editModel', 653, ',open,biz,max,ipd,', ',rnd,', '1', 10),
    (2119, 'ai', 'testConnection', 653, ',open,biz,max,ipd,', ',rnd,', '1', 15),
    (2120, 'ai', 'createPrompt', 655, ',biz,max,ipd', ',rnd,', '1', 20),
    (2121, 'ai', 'promptEdit', 655, ',biz,max,ipd', ',rnd,', '1', 25),
    (2122, 'ai', 'promptDelete', 657, ',biz,max,ipd', ',rnd,', '1', 30),
    (2123, 'ai', 'promptAssignRole', 655, ',biz,max,ipd', ',rnd,', '1', 35),
    (2124, 'ai', 'promptSelectDataSource', 655, ',biz,max,ipd', ',rnd,', '1', 40),
    (2125, 'ai', 'promptSetPurpose', 655, ',biz,max,ipd', ',rnd,', '1', 45),
    (2126, 'ai', 'promptSetTargetForm', 655, ',biz,max,ipd', ',rnd,', '1', 50),
    (2127, 'ai', 'promptFinalize', 655, ',biz,max,ipd', ',rnd,', '1', 55),
    (2128, 'ai', 'promptAudit', 655, ',biz,max,ipd', ',rnd,', '1', 60),
    (2129, 'ai', 'promptPublish', 656, ',open,biz,max,ipd,', ',rnd,', '1', 65),
    (2130, 'ai', 'promptUnpublish', 656, ',open,biz,max,ipd,', ',rnd,', '1', 70),
    (2131, 'ai', 'prompts', 654, ',open,biz,max,ipd,', ',rnd,', '1', 75),
    (2132, 'ai', 'promptView', 654, ',open,biz,max,ipd,', ',rnd,', '1', 80),
    (2133, 'ai', 'promptExecute', 652, ',open,biz,max,ipd,', ',rnd,', '1', 85),
    (2134, 'ai', 'roleTemplates', 655, ',biz,max,ipd', ',rnd,', '1', 90),
    (2135, 'ai', 'promptExecutionReset', 652, ',open,biz,max,ipd,', ',rnd,', '1', 95);

REPLACE INTO
    `zt_privmanager` (`id`, `parent`, `code`, `type`, `edition`, `vision`, `order`)
VALUES
    (651, 457, 'ai', 'module', ',open,biz,max,ipd,', ',rnd,', 2020),
    (652, 651, '', 'package', ',open,biz,max,ipd,', ',rnd,', 2040),
    (653, 651, '', 'package', ',open,biz,max,ipd,', ',rnd,', 2060),
    (654, 651, '', 'package', ',open,biz,max,ipd,', ',rnd,', 2080),
    (655, 651, '', 'package', ',biz,max,ipd', ',rnd,', 2100),
    (656, 651, '', 'package', ',open,biz,max,ipd,', ',rnd,', 2120),
    (657, 651, '', 'package', ',biz,max,ipd', ',rnd,', 2140);
...
INSERT INTO `zt_prompt` (`name`, `model`, `module`, `source`, `targetForm`, `purpose`, `elaboration`, `role`, `characterization`, `createdBy`, `createdDate`) VALUES ('文档润色', 0, 'doc', ',doc.content,doc.title,', 'doc.edit', '我希望你能帮我润色标题和文档正文。', '要求语句要通顺，逻辑要清晰，没有错别字且更具结构化。', '你是一名文章写得很好的文案编辑。', '文笔流畅、条理清晰。精通广告文案写作和编辑，擅长创意思维和品牌策略，能够进行市场调研和竞品分析，具有敏锐的审美和语言表达能力，能够协调多部门合作和项目管理，具有良好的沟通和协调能力。', 'system', '2023-08-31 15:54:57');
