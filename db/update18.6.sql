...
VALUES
    ('ai-modelEdit', 'depend', 'ai-modelBrowse'), ('ai-modelEdit', 'depend', 'ai-modelTestConnection'),
    ('ai-modelTestConnection', 'depend', 'ai-modelBrowse'), ('ai-modelTestConnection', 'depend', 'ai-modelEdit'),
    ('ai-promptView', 'depend', 'ai-promptBrowse'),
    ('ai-promptCreate', 'depend', 'ai-promptBrowse'), ('ai-promptCreate', 'depend', 'ai-promptView'),
    ('ai-promptEdit', 'depend', 'ai-promptBrowse'), ('ai-promptEdit', 'depend', 'ai-promptView'),
    ('ai-promptDelete', 'depend', 'ai-promptBrowse'), ('ai-promptDelete', 'depend', 'ai-promptView'),
    ('ai-promptAssignRole', 'depend', 'ai-promptBrowse'), ('ai-promptAssignRole', 'depend', 'ai-promptView'),
    ('ai-promptSelectDataSource', 'depend', 'ai-promptBrowse'), ('ai-promptSelectDataSource', 'depend', 'ai-promptView'),
    ('ai-promptSetPurpose', 'depend', 'ai-promptBrowse'), ('ai-promptSetPurpose', 'depend', 'ai-promptView'),
    ('ai-promptSetTargetForm', 'depend', 'ai-promptBrowse'), ('ai-promptSetTargetForm', 'depend', 'ai-promptView'),
    ('ai-promptFinalize', 'depend', 'ai-promptBrowse'), ('ai-promptFinalize', 'depend', 'ai-promptView'),
    ('ai-promptAudit', 'depend', 'ai-promptBrowse'), ('ai-promptAudit', 'depend', 'ai-promptView'),
    ('ai-promptPublish', 'depend', 'ai-promptBrowse'), ('ai-promptPublish', 'depend', 'ai-promptView'),
    ('ai-promptUnpublish', 'depend', 'ai-promptBrowse'), ('ai-promptUnpublish', 'depend', 'ai-promptView'),
    ('ai-promptEdit', 'depend', 'ai-promptCreate'), ('ai-promptAssignRole', 'depend', 'ai-promptCreate'), ('ai-promptSelectDataSource', 'depend', 'ai-promptCreate'), ('ai-promptSetPurpose', 'depend', 'ai-promptCreate'), ('ai-promptSetTargetForm', 'depend', 'ai-promptCreate'), ('ai-promptFinalize', 'depend', 'ai-promptCreate'), ('ai-promptAudit', 'depend', 'ai-promptCreate'),
    ('ai-promptCreate', 'recommend', 'ai-promptEdit'),
    ('ai-promptCreate', 'recommend', 'ai-promptDelete'),
    ('ai-promptCreate', 'recommend', 'ai-promptAssignRole'), ('ai-promptCreate', 'recommend', 'ai-promptSelectDataSource'), ('ai-promptCreate', 'recommend', 'ai-promptSetPurpose'), ('ai-promptCreate', 'recommend', 'ai-promptSetTargetForm'), ('ai-promptCreate', 'recommend', 'ai-promptFinalize'), ('ai-promptCreate', 'recommend', 'ai-promptAudit'),
