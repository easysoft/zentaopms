...
(8, '旅行天数', 'text', '请输入天数', NULL, '1'),
(8, '旅行人数', 'text', '请输入人数', NULL, '1'),
(8, '目标城市', 'text', '请输入目标城市', NULL, '1'),
(8, '交通方式', 'checkbox', NULL, '飞机,火车,汽车,客车,船舶,自行车', '0'),
(8, '住宿类型', 'checkbox', NULL, '酒店,度假村,民宿,客栈,青旅,租赁住宿', '0'),
(8, '景点活动', 'textarea', '请输入你想参观的景点及活动', NULL, '0'),
(8, '预算成本', 'textarea', '请输入预算成本金额', NULL, '0'),
...
(10, '产品名称', 'text', '请输入产品名称', NULL, '1'),
(10, '产品定位', 'textarea', '请概述产品定位', NULL, '1'),
(10, '目标受众', 'textarea', '请概述目标受众', NULL, '1'),
(10, '营销渠道', 'checkbox', NULL, '社交媒体,广告,公关活动,内容营销,搜索引擎营销,口碑营销,事件营销', '0'),
(10, '补充信息', 'textarea', '请输入更多补充信息', NULL, '0'),
(11, '简历内容', 'textarea', '您的简历具体内容', NULL, '1'),
(11, '目标职位', 'text', '目标职位及该职位需要的特定要求', NULL, '1'),
(11, '工作经验', 'textarea', '在工作/项目经历中需要详细描述的成就或经验', NULL, '0'),
(11, '简历格式', 'textarea', '您所需要的简历章节格式内容', NULL, '0'),
(11, '补充信息', 'textarea', '请输入更多补充信息', NULL, '0'),
(12, '居住城市', 'text', '请输入城市', NULL, '0'),
(12, '房屋面积', 'text', '请输入房屋面积', NULL, '0'),
(12, '房屋户型', 'text', '请输入房间户型', NULL, '0'),
(12, '风格偏好', 'textarea', '期望的风格偏好和喜欢的设计元素', NULL, '0'),
