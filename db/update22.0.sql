...
ALTER TABLE `zt_story`   ADD `frozen` char(30) NOT NULL DEFAULT '' AFTER `verifiedDate` COMMENT '冻结状态';
ALTER TABLE `zt_design`  ADD `frozen` char(30) NOT NULL DEFAULT '' AFTER `desc` COMMENT '冻结状态';
ALTER TABLE `zt_project` ADD `frozen` char(30) NOT NULL DEFAULT '' AFTER `vision` COMMENT '冻结状态';
ALTER TABLE `zt_doc`     ADD `frozen` char(30) NOT NULL DEFAULT '' AFTER `builtIn` COMMENT '冻结状态';
ALTER TABLE `zt_projectdeliverable` ADD `frozen` char(30) NOT NULL DEFAULT '' AFTER `version` COMMENT '冻结状态';