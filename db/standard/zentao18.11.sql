...
CREATE TABLE `zt_chart` (
  ...
  `deleted` tinyint(4) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20016 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TABLE `zt_pivot` (
  ...
  KEY `group` (`group`)
) ENGINE=InnoDB AUTO_INCREMENT=1028 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
