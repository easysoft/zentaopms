...
(1, 'productplan', 'view'),
(1, 'program', 'createGuide'),
(1, 'program', 'PGMBrowse'),
(1, 'program', 'PGMProduct'),
(1, 'program', 'PGMCreate'),
(1, 'program', 'PGMEdit'),
(1, 'program', 'PGMStart'),
(1, 'program', 'PGMSuspend'),
(1, 'program', 'PGMActivate'),
(1, 'program', 'PGMClose'),
(1, 'program', 'PGMDelete'),
(1, 'program', 'PGMProject'),
...
(4, 'productplan', 'view'),
(4, 'program', 'createGuide'),
(4, 'program', 'PGMBrowse'),
(4, 'program', 'PGMProduct'),
(4, 'program', 'PGMCreate'),
(4, 'program', 'PGMEdit'),
(4, 'program', 'PGMStart'),
(4, 'program', 'PGMSuspend'),
(4, 'program', 'PGMActivate'),
(4, 'program', 'PGMClose'),
(4, 'program', 'PGMDelete'),
(4, 'program', 'PGMProject'),
...
(5, 'product', 'dashboard'),
(5, 'program', 'createGuide'),
(5, 'program', 'PGMBrowse'),
(5, 'program', 'PGMProduct'),
(5, 'program', 'PGMCreate'),
(5, 'program', 'PGMEdit'),
(5, 'program', 'PGMStart'),
(5, 'program', 'PGMSuspend'),
(5, 'program', 'PGMActivate'),
(5, 'program', 'PGMClose'),
(5, 'program', 'PGMDelete'),
(5, 'program', 'PGMProject'),
...
(6, 'product', 'build'),
(6, 'product', 'dashboard'),
(6, 'program', 'createGuide'),
(6, 'program', 'PGMBrowse'),
(6, 'program', 'PGMProduct'),
(6, 'program', 'PGMCreate'),
(6, 'program', 'PGMEdit'),
(6, 'program', 'PGMStart'),
(6, 'program', 'PGMSuspend'),
(6, 'program', 'PGMActivate'),
(6, 'program', 'PGMClose'),
(6, 'program', 'PGMDelete'),
(6, 'program', 'PGMProject'),
(6, 'program', 'PGMStakeholder'),
(6, 'program', 'createStakeholder'),
...
(7, 'product', 'dashboard'),
(7, 'program', 'createGuide'),
(7, 'program', 'PGMBrowse'),
(7, 'program', 'PGMProduct'),
(7, 'program', 'PGMCreate'),
(7, 'program', 'PGMEdit'),
(7, 'program', 'PGMStart'),
(7, 'program', 'PGMSuspend'),
(7, 'program', 'PGMActivate'),
(7, 'program', 'PGMClose'),
(7, 'program', 'PGMDelete'),
(7, 'program', 'PGMProject'),
...
(8, 'product', 'build'),
(8, 'product', 'dashboard'),
(8, 'program', 'createGuide'),
(8, 'program', 'PGMBrowse'),
(8, 'program', 'PGMProduct'),
(8, 'program', 'PGMCreate'),
(8, 'program', 'PGMEdit'),
(8, 'program', 'PGMStart'),
(8, 'program', 'PGMSuspend'),
(8, 'program', 'PGMActivate'),
(8, 'program', 'PGMClose'),
(8, 'program', 'PGMDelete'),
(8, 'program', 'PGMProject'),
(8, 'program', 'PGMStakeholder'),
(8, 'program', 'createStakeholder'),
...
(9, 'product', 'build'),
(9, 'product', 'dashboard'),
(9, 'program', 'createGuide'),
(9, 'program', 'PGMBrowse'),
(9, 'program', 'PGMProduct'),
(9, 'program', 'PGMCreate'),
(9, 'program', 'PGMEdit'),
(9, 'program', 'PGMStart'),
(9, 'program', 'PGMSuspend'),
(9, 'program', 'PGMActivate'),
(9, 'program', 'PGMClose'),
(9, 'program', 'PGMDelete'),
(9, 'program', 'PGMProject'),
(9, 'program', 'PGMStakeholder'),
(9, 'program', 'createStakeholder'),
...
INSERT INTO `zt_config` (`owner`, `module`, `section`, `key`, `value`) VALUES ('system', 'program', '', 'mainCurrency', 'CNY');
