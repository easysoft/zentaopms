...
(2,'build','unlinkStory'),
(2,'build','view'),
(2,'caselib','batchCreateCase'),
(2,'caselib','browse'),
(2,'caselib','create'),
(2,'caselib','createCase'),
(2,'caselib','delete'),
(2,'caselib','edit'),
(2,'caselib','exportTemplet'),
(2,'caselib','import'),
(2,'caselib','index'),
(2,'caselib','showImport'),
(2,'caselib','view'),
(2,'company','browse'),
(2,'company','dynamic'),
(2,'company','edit'),
...
(2,'doc','tableContents'),
(2,'doc','view'),
(2,'execution','activate'),
(2,'execution','addWhitelist'),
(2,'execution','all'),
(2,'execution','batchedit'),
(2,'execution','batchUnlinkStory'),
(2,'execution','browse'),
(2,'execution','bug'),
(2,'execution','build'),
(2,'execution','burn'),
...
(2,'execution','importplanstories'),
(2,'execution','importtask'),
(2,'execution','index'),
(2,'execution','kanban'),
(2,'execution','kanbanColsColor'),
(2,'execution','kanbanHideCols'),
(2,'execution','linkStory'),
(2,'execution','manageMembers'),
(2,'execution','manageProducts'),
...
(2,'execution','unbindWhitelist'),
(2,'execution','unlinkMember'),
(2,'execution','unlinkStory'),
(2,'execution','updateOrder'),
(2,'execution','view'),
...
(2,'product','view'),
(2,'product','whitelist'),
(2,'productplan','batchEdit'),
(2,'productplan','batchUnlinkBug'),
(2,'productplan','batchUnlinkStory'),
(2,'productplan','browse'),
(2,'productplan','create'),
(2,'productplan','delete'),
(2,'productplan','edit'),
(2,'productplan','linkBug'),
(2,'productplan','linkStory'),
(2,'productplan','unlinkBug'),
...
(2,'program','view'),
(2,'project','activate'),
(2,'project','addWhitelist'),
(2,'project','browse'),
(2,'project','close'),
(2,'project','copyGroup'),
(2,'project','create'),
(2,'project','createGroup'),
(2,'project','edit'),
(2,'project','editGroup'),
(2,'project','group'),
(2,'project','index'),
(2,'project','kanban'),
(2,'project','manageGroupMember'),
(2,'project','manageMembers'),
(2,'project','managePriv'),
...
(2,'projectstory','view'),
(2,'qa','index'),
(2,'release','batchUnlinkBug'),
(2,'release','batchUnlinkStory'),
(2,'release','browse'),
(2,'release','changeStatus'),
(2,'release','create'),
(2,'release','delete'),
(2,'release','edit'),
(2,'release','export'),
...
(2,'story','activate'),
(2,'story','assignTo'),
(2,'story','batchAssignTo'),
(2,'story','batchChangeBranch'),
(2,'story','batchChangeModule'),
(2,'story','batchChangePlan'),
(2,'story','batchChangeStage'),
(2,'story','batchClose'),
(2,'story','batchCreate'),
(2,'story','batchEdit'),
(2,'story','batchReview'),
...
(2,'task','start'),
(2,'task','view'),
(2,'testcase','batchCaseTypeChange'),
(2,'testcase','batchChangeBranch'),
(2,'testcase','batchChangeModule'),
(2,'testcase','batchConfirmStoryChange'),
(2,'testcase','batchCreate'),
(2,'testcase','batchDelete'),
(2,'testcase','batchEdit'),
(2,'testcase','batchReview'),
(2,'testcase','browse'),
(2,'testcase','bugs'),
(2,'testcase','confirmChange'),
(2,'testcase','confirmLibcaseChange'),
(2,'testcase','confirmStoryChange'),
(2,'testcase','create'),
(2,'testcase','createBug'),
(2,'testcase','delete'),
(2,'testcase','edit'),
(2,'testcase','export'),
(2,'testcase','exportTemplet'),
(2,'testcase','groupCase'),
(2,'testcase','ignoreLibcaseChange'),
(2,'testcase','import'),
(2,'testcase','importFromLib'),
(2,'testcase','linkCases'),
(2,'testcase','review'),
(2,'testcase','showImport'),
(2,'testcase','view'),
(2,'testreport','browse'),
(2,'testreport','create'),
(2,'testreport','delete'),
(2,'testreport','edit'),
(2,'testreport','view'),
(2,'testsuite','batchUnlinkCases'),
(2,'testsuite','browse'),
(2,'testsuite','create'),
(2,'testsuite','delete'),
(2,'testsuite','edit'),
(2,'testsuite','index'),
(2,'testsuite','linkCase'),
(2,'testsuite','unlinkCase'),
(2,'testsuite','view'),
(2,'testtask','activate'),
