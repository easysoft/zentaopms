...
CREATE TABLE IF NOT EXISTS `zt_company` (
  ...
  `backyard` varchar(120) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zt_user` (
  ...
  `superior` varchar(30) NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `zt_charter` (
  ...
  `budgetUnit` varchar(30) NOT NULL DEFAULT '',
  `product` text DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zt_metric` (
  ...
  `scope` varchar(30) NOT NULL DEFAULT '',
  `object` varchar(30) NOT NULL DEFAULT '',
  `stage` varchar(10) NULL DEFAULT 'wait',
  `type` varchar(10) NULL DEFAULT 'php',
  `name` varchar(90) NOT NULL DEFAULT '',
