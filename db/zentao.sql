...
('scale', 'user', 'story', 'released', 'php', '按人员统计的待处理研发需求数', 'count_of_pending_story_in_user', '待处理研发需求数', 'count', '按人员统计的待处理研发需求数表示每个人待处理的研发需求数量之和。反映了每个人员需要处理的研发需求数量的规模。该数值越大，说明需要投入越多的时间处理研发需求。', '所有研发需求个数求和\r\n过滤已删除的研发需求\r\n过滤状态为已关闭的研发需求\r\n过滤已删除产品下的研发需求\r\n过滤已删除的无产品项目下的研发需求', 'realtime', 'system', '2023-08-22 08:00:00', '1', '0', 'nodate'),
