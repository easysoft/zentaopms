...
(1, 2, 'my', 'profile'),
(1, 2, 'project', 'relation'),
(1, 2, 'sunyard', 'createEffort'),
(1, 2, 'repo', 'revision'),
(1, 2, 'project', 'timeTotal'),
(1, 2, 'user', 'exportEffortEveryday'),
(1, 2, 'repo', 'log'),
(1, 2, 'user', 'profile'),
(1, 2, 'user', 'project'),
(1, 2, 'user', 'todo'),
(1, 2, 'user', 'effortEveryday'),
(1, 2, 'project', 'kanban'),
(1, 2, 'doc', 'deleteLib'),
(1, 2, 'my', 'dynamic'),
(1, 2, 'project', 'exportTimeTotal'),
(1, 2, 'project', 'bug'),
(1, 2, 'story', 'create'),
(1, 2, 'todo', 'create'),
(1, 2, 'task', 'view'),
(1, 2, 'repo', 'download'),
(1, 2, 'project', 'effort'),
(1, 2, 'thread', 'editThread'),
(1, 2, 'bug', 'create'),
(1, 2, 'task', 'export'),
(1, 2, 'report', 'workload'),
(1, 2, 'story', 'activate'),
(1, 2, 'report', 'workSummary'),
(1, 2, 'repo', 'settings'),
(1, 2, 'project', 'story'),
...
(1, 2, 'svn', 'cat'),
(1, 2, 'misc', 'ping'),
(1, 2, 'project', 'projectTotal'),
(1, 2, 'repo', 'showSyncComment'),
(1, 2, 'project', 'team'),
(1, 2, 'file', 'delete'),
(1, 2, 'report', 'index'),
...
(1, 2, 'tree', 'fix'),
(1, 2, 'project', 'exportProjectTotal'),
(1, 2, 'tree', 'delete'),
(1, 2, 'user', 'dynamic'),
(1, 2, 'story', 'tasks'),
(1, 2, 'tree', 'updateOrder'),
(1, 2, 'project', 'exportEstimate'),
(1, 2, 'user', 'task'),
(1, 2, 'product', 'delete'),
(1, 2, 'release', 'create'),
(1, 2, 'bug', 'index'),
...
(1, 3, 'bug', 'batchEdit'),
(1, 3, 'project', 'estimate'),
(1, 3, 'search', 'buildForm'),
(1, 3, 'repo', 'diff'),
(1, 3, 'bug', 'edit'),
(1, 3, 'doc', 'index'),
(1, 3, 'story', 'ajaxGetProjectStories'),
(1, 3, 'project', 'exportEstimate'),
(1, 3, 'sunyard', 'createEffort'),
...
(1, 3, 'todo', 'fullcalendar'),
(1, 3, 'testtask', 'browse'),
(1, 3, 'effort', 'batchEdit'),
(1, 3, 'task', 'activate'),
(1, 3, 'file', 'download'),
...
(1, 3, 'product', 'roadmap'),
(1, 3, 'repo', 'download'),
(1, 3, 'sunyard', 'exportEffortEveryday'),
(1, 3, 'doc', 'browse'),
(1, 3, 'todo', 'batchEdit'),
(1, 3, 'thread', 'editReply'),
...
(1, 4, 'project', 'teamTotal'),
(1, 4, 'doc', 'deleteLib'),
(1, 4, 'user', 'effortfullcalendar'),
(1, 4, 'project', 'timeTotal'),
...
(1, 4, 'sunyard', 'createEffort'),
(1, 4, 'testcase', 'delete'),
(1, 4, 'effort', 'batchEdit'),
(1, 4, 'bug', 'report'),
(1, 4, 'file', 'delete'),
(1, 4, 'testtask', 'cases'),
(1, 4, 'file', 'ajaxUpload'),
...
(1, 4, 'effort', 'fullcalendar'),
(1, 4, 'project', 'browse'),
(1, 4, 'project', 'story'),
(1, 4, 'story', 'report'),
(1, 4, 'bug', 'browse'),
(1, 4, 'project', 'projectTotal'),
(1, 4, 'search', 'select'),
(1, 4, 'repo', 'log'),
(1, 4, 'svn', 'diff'),
(1, 4, 'project', 'bug'),
(1, 4, 'thread', 'editReply'),
(1, 4, 'todo', 'delete'),
(1, 4, 'project', 'estimate'),
(1, 4, 'testtask', 'create'),
(1, 4, 'my', 'task'),
...
(1, 4, 'bug', 'resolve'),
(1, 4, 'release', 'view'),
(1, 4, 'user', 'effortEveryday'),
(1, 4, 'project', 'index'),
(1, 4, 'project', 'exportProjectTotal'),
(1, 4, 'my', 'effort'),
(1, 5, 'effort', 'fullcalendar'),
(1, 5, 'effort', 'export'),
(1, 5, 'effort', 'delete'),
(1, 5, 'effort', 'view'),
(1, 5, 'effort', 'batchEdit'),
(1, 5, 'effort', 'edit'),
(1, 5, 'effort', 'createForObject'),
(1, 5, 'effort', 'batchCreate'),
(1, 5, 'sunyard', 'exportEffortEveryday'),
(1, 5, 'sunyard', 'createEffort'),
(1, 5, 'sunyard', 'effortEveryday'),
(1, 5, 'thread', 'editReply'),
(1, 5, 'thread', 'reply'),
(1, 5, 'thread', 'editThread'),
(1, 5, 'thread', 'post'),
(1, 5, 'thread', 'view'),
(1, 5, 'forum', 'board'),
(1, 5, 'forum', 'index'),
(1, 5, 'repo', 'ajaxSyncComment'),
(1, 5, 'repo', 'download'),
(1, 5, 'repo', 'diff'),
(1, 5, 'repo', 'showSyncComment'),
(1, 5, 'repo', 'delete'),
(1, 5, 'repo', 'create'),
(1, 5, 'repo', 'settings'),
(1, 5, 'repo', 'revision'),
...
(1, 5, 'file', 'download'),
(1, 5, 'tree', 'fix'),
(1, 5, 'tree', 'ajaxGetSonModules'),
(1, 5, 'tree', 'ajaxGetOptionMenu'),
(1, 5, 'tree', 'delete'),
(1, 5, 'tree', 'edit'),
...
(1, 5, 'action', 'undelete'),
(1, 5, 'action', 'trash'),
(1, 5, 'user', 'todofullcalendar'),
(1, 5, 'user', 'effortfullcalendar'),
(1, 5, 'user', 'exportEffortEveryday'),
(1, 5, 'user', 'effortEveryday'),
...
(1, 5, 'testcase', 'confirmStoryChange'),
(1, 5, 'testcase', 'export'),
(1, 5, 'testcase', 'delete'),
(1, 5, 'testcase', 'edit'),
(1, 5, 'testcase', 'view'),
(1, 5, 'testcase', 'batchCreate'),
(1, 5, 'testcase', 'create'),
...
(1, 1, 'project', 'order'),
(1, 1, 'project', 'edit'),
(1, 2, 'project', 'fullcalendar'),
(1, 2, 'my', 'bug'),
(1, 4, 'search', 'buildQuery'),
(1, 3, 'index', 'index'),
(1, 4, 'project', 'exportTimeTotal'),
...
(1, 2, 'effort', 'batchEdit'),
(1, 3, 'my', 'editProfile'),
(1, 3, 'effort', 'export'),
(1, 4, 'search', 'deleteQuery'),
(1, 3, 'story', 'tasks'),
(1, 3, 'report', 'workload'),
(1, 3, 'sunyard', 'effortEveryday'),
(1, 3, 'task', 'batchCreate'),
(1, 3, 'project', 'teamTotal'),
(1, 3, 'task', 'start'),
(1, 3, 'task', 'batchClose'),
...
(1, 3, 'project', 'relation'),
(1, 3, 'product', 'view'),
(1, 3, 'api', 'getModel'),
(1, 2, 'product', 'dynamic'),
(1, 4, 'repo', 'showSyncComment'),
(1, 4, 'sunyard', 'exportEffortEveryday'),
(1, 4, 'todo', 'create'),
(1, 4, 'bug', 'close'),
(1, 4, 'user', 'dynamic'),
(1, 4, 'sunyard', 'effortEveryday'),
(1, 5, 'build', 'create'),
(1, 5, 'task', 'report'),
...
(1, 2, 'product', 'doc'),
(1, 2, 'sunyard', 'exportEffortEveryday'),
(1, 2, 'user', 'todofullcalendar'),
(1, 2, 'project', 'view'),
(1, 2, 'bug', 'saveTemplate'),
(1, 3, 'repo', 'view'),
(1, 3, 'effort', 'view'),
(1, 3, 'repo', 'ajaxSyncComment'),
(1, 3, 'project', 'timeTotal'),
...
(1, 5, 'task', 'create'),
(1, 5, 'project', 'fullcalendar'),
(1, 5, 'project', 'effort'),
(1, 5, 'project', 'deletesunyard'),
(1, 6, 'file', 'ajaxUpload'),
(1, 6, 'misc', 'ping'),
(1, 2, 'qa', 'index'),
(1, 3, 'testcase', 'index'),
(1, 4, 'my', 'changePassword'),
(1, 5, 'project', 'exportTimeTotal'),
...
(1, 4, 'user', 'exportEffortEveryday'),
(1, 5, 'project', 'exportTeamTotal'),
(1, 1, 'my', 'task'),
(1, 2, 'tree', 'browse'),
(1, 3, 'task', 'assignTo'),
(1, 4, 'bug', 'create'),
(1, 5, 'project', 'exportProjectTotal'),
(1, 1, 'my', 'todo'),
(1, 2, 'task', 'ajaxGetProjectTasks'),
(1, 5, 'project', 'exportEstimate'),
(1, 1, 'my', 'index'),
(1, 2, 'report', 'productInfo'),
(1, 3, 'repo', 'revision'),
(1, 4, 'doc', 'index'),
(1, 5, 'project', 'timeTotal'),
(1, 1, 'index', 'index'),
(1, 2, 'release', 'browse'),
(1, 5, 'project', 'teamTotal'),
(1, 1, 'action', 'undelete'),
(1, 1, 'mail', 'index'),
(1, 1, 'mail', 'detect'),
(1, 1, 'mail', 'edit'),
...
(1, 1, 'admin', 'checkDB'),
(1, 1, 'admin', 'clearData'),
(1, 2, 'project', 'estimate'),
(1, 2, 'forum', 'board'),
(1, 2, 'project', 'ajaxGetProducts'),
(1, 2, 'tree', 'ajaxGetSonModules'),
(1, 4, 'doc', 'editLib'),
(1, 5, 'project', 'projectTotal'),
(1, 5, 'project', 'createEstimate'),
(1, 5, 'project', 'estimate'),
(1, 1, 'todo', 'fullcalendar'),
(1, 2, 'product', 'edit'),
(1, 3, 'todo', 'edit'),
...
(1, 3, 'project', 'team'),
(1, 4, 'user', 'project'),
(1, 5, 'project', 'relation'),
(1, 1, 'testcase', 'batchEdit'),
(1, 3, 'task', 'finish'),
(1, 4, 'thread', 'view'),
(1, 5, 'project', 'maintainrelation'),
(1, 1, 'story', 'batchEdit'),
(1, 2, 'company', 'browse'),
(1, 3, 'repo', 'showSyncComment'),
(1, 4, 'project', 'burnData'),
(1, 5, 'project', 'deleterelation'),
(1, 1, 'todo', 'batchEdit'),
(1, 3, 'todo', 'mark'),
(1, 4, 'product', 'roadmap'),
(1, 5, 'project', 'kanban'),
...
(1, 2, 'build', 'view'),
(1, 2, 'project', 'exportTeamTotal'),
(1, 2, 'thread', 'editReply'),
...
(1, 2, 'user', 'effortfullcalendar'),
(1, 2, 'product', 'order'),
(1, 2, 'repo', 'ajaxSyncComment'),
(1, 2, 'forum', 'index'),
(1, 2, 'repo', 'diff'),
...
(1, 3, 'task', 'view'),
(1, 3, 'user', 'exportEffortEveryday'),
(1, 3, 'user', 'effortEveryday'),
(1, 3, 'task', 'ajaxGetUserTasks'),
(1, 3, 'my', 'index'),
(1, 3, 'user', 'profile'),
(1, 3, 'report', 'workSummary'),
(1, 3, 'company', 'index'),
(1, 3, 'user', 'bug'),
(1, 3, 'user', 'project'),
(1, 3, 'user', 'todo'),
...
(1, 3, 'project', 'index'),
(1, 3, 'project', 'fullcalendar'),
(1, 3, 'project', 'ajaxGetProducts'),
(1, 3, 'project', 'effort'),
(1, 3, 'project', 'exportTeamTotal'),
(1, 3, 'my', 'project'),
(1, 3, 'thread', 'post'),
(1, 3, 'release', 'view'),
...
(1, 3, 'svn', 'cat'),
(1, 3, 'svn', 'diff'),
(1, 3, 'user', 'effortfullcalendar'),
(1, 3, 'project', 'exportTimeTotal'),
(1, 3, 'user', 'todofullcalendar'),
(1, 3, 'project', 'exportProjectTotal'),
(1, 4, 'company', 'dynamic'),
(1, 4, 'report', 'workSummary'),
(1, 4, 'company', 'browse'),
(1, 4, 'group', 'browse'),
(1, 4, 'testcase', 'view'),
(1, 4, 'testcase', 'create'),
...
(1, 4, 'project', 'fullcalendar'),
(1, 4, 'project', 'relation'),
(1, 4, 'task', 'view'),
