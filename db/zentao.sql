...
CREATE TABLE IF NOT EXISTS `zt_auditplan` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '活动检查编号',
  `objectID` mediumint(9) NOT NULL DEFAULT '0' COMMENT '活动或文档编号',
  `objectType` char(30) NOT NULL DEFAULT '' COMMENT '检查类型',
  `process` mediumint(9) NOT NULL DEFAULT '0' COMMENT '所属过程',
  `processType` char(30) NOT NULL DEFAULT '' COMMENT '过程分类',
