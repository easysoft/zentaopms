...
CREATE TABLE IF NOT EXISTS `zt_story` (
  ...
  `subStatus` varchar(30) NOT NULL DEFAULT '',
  `color` char(7) NOT NULL DEFAULT '',
  `stage` enum('','wait','defining','inroadmap','incharter','planning','planned','projected','designing','designed','developing','developed','testing','tested','verified','rejected','delivering','pending','released','closed') NOT NULL DEFAULT 'wait',
