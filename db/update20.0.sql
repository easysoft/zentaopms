...
('scale', 'user', 'demand', 'released', 'php', '按人员统计的被指派的需求池需求数', 'count_of_assigned_demand_in_user', '待处理需求池需求数', 'count', '按人员统计的被指派的需求池需求数表示每个人待处理的需求池需求数量之和。反映了每个人员需要处理的需求池需求数量的规模。该数值越大，说明需要投入越多的时间处理需求池需求', '所有需求池需求个数求和\r\n指派给为某人\r\n过滤已删除的需求池需求\r\n过滤状态为已关闭的需求池需求', 'realtime', 'system', '2024-05-07 08:00:00', '1', '0', 'nodate'),
...
('scale', 'project', 'requirement', 'released', 'php', '按项目统计的已完成研发需求数', 'count_of_finished_requirement_in_project', '已完成用户需求数', 'count', '按项目统计的已完成用户需求数是指状态为已关闭且关闭原因为已完成的用户需求的数量。反映了项目团队在满足用户期望和需求方面的已经实现的任务和计划。已完成用户需求数量的增加表示项目团队已经成功完成了一定数量的用户需求工作，并取得了一定的成果', '项目中用户需求的个数求和\r\n状态为已关闭\r\n关闭原因为已完成\r\n过滤已删除的用户需求\r\n过滤已删除的项目', 'realtime', 'system', '2024-05-07 08:00:00', '1', '0', 'nodate');
