...
('scale', 'user', 'demand', 'released', 'php', '按人员统计的待处理需求池需求数', 'count_of_assigned_demand_in_user', '待处理需求池需求数', 'count', '按人员统计的待处理需求池需求数表示每个人待处理的需求池需求数量之和。反映了每个人员需要处理的需求池需求数量的规模。该数值越大，说明需要投入越多的时间处理需求池需求', '所有需求池需求个数求和\r\n过滤已删除的需求池需求\r\n过滤状态为已关闭的需求池需求', 'realtime', 'system', '2024-05-07 08:00:00', '1', '0', 'nodate');
