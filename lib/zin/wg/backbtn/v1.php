...
class backBtn extends btn
{
    ...
    protected function getProps(): array
    {
        ...
        $backs = array(
            ...
            'testtask'       => 'testtask-browse,testtask-cases,qa-index,testcase-browse,execution-build,my-index,my-effort,company-effort,company-calendar,product-dynamic,project-dynamic,execution-dynamic,project-view,execution-view,project-testcase,project-testtask,execution-testtask,my-work',
            'testreport'     => 'testreport-browse,project-testreport,execution-testreport,execution-testtask',
            'tree'           => 'product-browse,project-browse,execution-task,bug-browse,projectstory-story,host-browse,execution-story,feedback-admin,ticket-browse,testcase-browse,caselib-browse,dataview-browse,deliverable-browse,workflowdatasource-browse,ai-myskill,ai-browseskill',
            ...
            'productplan'    => 'productplan-browse,productplan-view,kanban-view,projectplan-browse,my-index,my-effort,company-effort,company-calendar,product-dynamic,project-dynamic,project-view,charter-view',
            ...
            'product'        => 'product-all,product-browse,program-productview,program-product,product-view,product-dynamic,my-index,charter-view,testtask-view,roadmap-browse,productplan-browse,product-track,product-project,release-browse,product-roadmap,doc-productspace,tree-browse,product-whitelist,APP',
            ...
            'deliverable'    => 'deliverable-browse,project-deliverable,action-trash,activity-view',
