...
class backBtn extends btn
{
    ...
    protected function getProps(): array
    {
        ...
        $backs = array(
            ...
            'build'          => 'execution-build,build-view,project-index,kanban-view,testtask-browse,projectbuild-browse,my-effort,my-index,project-dynamic,execution-dynamic',
            ...
            'researchtask'   => 'marketresearch-task,my-index,product-dynamic,project-dynamic',
            'review'         => 'review-browse,my-index,product-dynamic,project-dynamic',
