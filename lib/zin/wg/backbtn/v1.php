...
class backBtn extends btn
{
    ...
    protected function getProps(): array
    {
        ...
        $backs = array(
            ...
            'testtask'       => 'testtask-browse,testtask-cases,qa-index,testcase-browse,execution-build,my-index,my-effort,company-effort,product-dynamic,project-dynamic,execution-dynamic,project-view,execution-view',
            ...
            'design'         => 'design-browse,projectstory-track,my-effort,company-effort,my-index',
            'release'        => 'release-browse,release-view,product-roadmap,kanban-view,projectrelease-browse,story-view,my-index,my-effort,company-effort,product-dynamic,project-dynamic,project-view',
            'productplan'    => 'productplan-browse,kanban-view,projectplan-browse,my-index,my-effort,company-effort,product-dynamic,project-dynamic,project-view,charter-view',
            'programplan'    => 'project-execution',
            'projectrelease' => 'projectrelease-browse',
            'projectstory'   => 'projectstory-story',
            'build'          => 'execution-build,build-view,project-index,kanban-view,testtask-browse,projectbuild-browse,my-effort,company-effort,my-index,project-dynamic,execution-dynamic,project-view,execution-view',
            ...
            'todo'           => 'my-todo,my-effort,company-effort',
            'feedback'       => 'feedback-admin,feedback-browse,my-work,my-contribute,my-effort,company-effort',
            'ticket'         => 'my-effort,company-effort,ticket-browse,my-work,my-contribute',
