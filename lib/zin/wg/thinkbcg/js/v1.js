...
window.initBcgModel = function()
{
    $.getLib(config.webRoot + 'js/echarts/echarts.common.min.js', {root: false}, function()
    {
        ...
        const minXAxis  = markLineX <= minX ? markLineX : 40;
        const maxXAxis  = markLineX >= maxX ? markLineX : 40;
        const minYAxis  = markLineY <= minY ? markLineY : 40;
        const maxYAxis  = markLineY >= maxY ? markLineY : 40;
