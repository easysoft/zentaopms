...
function createMonaco(id, action, options, diffContent, onMouseDown, onMouseMove, vsPath, clientLang)
{
    ...
    require(['vs/editor/editor.main'], function ()
    {
        if(action == 'diff')
        {
            ...
            if(onMouseDown) getOriginalEditor.onMouseDown(function(){eval(onMouseDown + '(obj)')})
            if(onMouseMove) getOriginalEditor.onMouseMove(function(){eval(onMouseMove + '(obj)')})
        }
        else
        {
        ...
        if(onMouseDown) editor.onMouseDown(function(){eval(onMouseDown + '(obj)')})
        if(onMouseMove) editor.onMouseMove(function(){eval(onMouseMove + '(obj)')})
        if(selectedLines)
        {
