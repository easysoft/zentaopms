...
class docApp extends wg
{
    ...
    protected function build()
    {
        ...
        (
            ...
            $hasZentaoSlashMenu ? jsCall('setZentaoSlashMenu', $this->getZentaoListMenu(), $lang->doc->zentaoData, $config->vision, $config->doc->zentaoListMenuPosition, data('docID')) : null
        );
    }
}
