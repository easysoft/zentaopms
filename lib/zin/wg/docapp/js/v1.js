...
const actionsMap =
{
    ...
    doc: function(info)
    {
        ...
        if (isApi) {
            ...
            if (canExportApi) moreItems.push({icon: 'export', text: lang.exportWord, command: 'exportApi'});
            if (canExportOpenAPI) moreItems.push({icon: 'export', text: lang.exportOpenAPI, command: 'exportOpenAPI'});
        }
        const docApp = this;
    ...
    'doc-list': function(info)
    {
        ...
        if(isApiLib(docApp.lib))
        {
            ...
            return [
                ...
                exportItems.length ? {icon: 'export', text: lang.export, type: 'dropdown', items: exportItems} : null,
