...
const commands =
{
    ...
    handleMovedDoc(_, args)
    {
        ...
        else if(docType === 'text') docApp.startEditDoc(docID);
    },
...
async function mentionsFetcher(query)
{
    ...
    const mentions = await zui.fetchData($.createLink('user', 'ajaxGetItems', `params=noclosed,nodeleted&search=${zui.encodeBase64(query)}&maxCount=10`));
