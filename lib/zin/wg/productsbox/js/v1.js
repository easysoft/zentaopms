...
window.addNewLine = function(e)
{
    ...
    /* 重新初始化新一行的下拉控件. */
    newLine.find('.form-group.linkProduct').html(`<div id=products${index} class='form-group-wrapper picker-box' data-call="loadBranches(event)" data-on="change"></div>`);
