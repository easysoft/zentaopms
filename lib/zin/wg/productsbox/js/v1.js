...
window.addNewLine = function(e)
{
    ...
    newLine.find('.branchBox').html(`<div id=branch${index} class='form-group-wrapper picker-box'></div>`, false);
    newLine.find('div[id^=plan]').html(`<div id=plans${index} class='form-group-wrapper picker-box'></div>`, false);
