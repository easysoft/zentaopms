...
{
    $(modeClass + ' .think-form-batch .form-batch-col-actions .btn[data-type="add"]').prop({
    ...
    $(modeClass + ' .think-form-batch .form-batch-col-actions .btn[data-type="delete"]').prop({
        disabled: disabled,
    })
}

$(document).on('click', '.form-batch-col-actions .btn', function()
{
    renderRowData();
