...
window.showBtnModal = function(deliverable, category)
{
    ...
    actions.push(`<a class="${btnClass}" target='_blank' href="${createDocUrl}"><i class="icon icon-doc"></i>${createDoc}</a>`);
    actions.push(`<a class="${btnClass}" data-toggle="modal" href="${uploadDocUrl}"><i class="icon icon-file"></i>${uploadFile}</a>`);
