...
EOT;
    ...
    static public function exportConfigVars()
    {
        ...
        $jsLang->program      = isset($lang->program->common) ? $lang->program->common : '';
        $jsLang->project      = isset($lang->project->common) ? $lang->project->common : '';
        $jsLang->product      = isset($lang->product->common) ? $lang->product->common : '';
        $jsLang->task         = isset($lang->task->common) ? $lang->task->common : '';
        $jsLang->story        = isset($lang->story->common) ? $lang->story->common : '';
        $jsLang->bug          = isset($lang->bug->common) ? $lang->bug->common : '';
        $jsLang->testcase     = isset($lang->testcase->common) ? $lang->testcase->common : '';
        $jsLang->testsuite    = isset($lang->testsuite->common) ? $lang->testsuite->common : '';
        $jsLang->zahost       = isset($lang->zahost->common) ? $lang->zahost->common : '';
        $jsLang->zanode       = isset($lang->zanode->common) ? $lang->zanode->common : '';
        $jsLang->gitlab       = isset($lang->gitlab->common) ? $lang->gitlab->common : '';
        $jsLang->gogs         = isset($lang->gogs->common) ? $lang->gogs->common : '';
        $jsLang->gitea        = isset($lang->gitea->common) ? $lang->gitea->common : '';
        $jsLang->jenkins      = isset($lang->jenkins->common) ? $lang->jenkins->common : '';
        $jsLang->sonarqube    = isset($lang->sonarqube->common) ? $lang->sonarqube->common : '';
        $jsLang->repo         = isset($lang->repo->common) ? $lang->repo->common : '';
