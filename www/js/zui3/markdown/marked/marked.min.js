...
/** marked-highlight https://github.com/markedjs/marked-highlight MIT License */
(function(a,b){"object"==typeof exports&&"undefined"!=typeof module?b(exports):"function"==typeof define&&define.amd?define(["exports"],b):(a="undefined"==typeof globalThis?a||self:globalThis,b(a.markedHighlight={}))})(this,function(a){'use strict';function b(a){return(a||"").match(/\S*/)[0]}function c(a){return b=>{"string"==typeof b&&b!==a.text&&(a.escaped=!0,a.text=b)}}function d(a,b){if(b){if(e.test(a))return a.replace(f,j);}else if(g.test(a))return a.replace(h,j);return a}const e=/[&<>"']/,f=new RegExp(e.source,"g"),g=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,h=new RegExp(g.source,"g"),i={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},j=a=>i[a];a.markedHighlight=function(a){if("function"==typeof a&&(a={highlight:a}),!a||"function"!=typeof a.highlight)throw new Error("Must provide highlight function");return"string"!=typeof a.langPrefix&&(a.langPrefix="language-"),"string"!=typeof a.emptyLangClass&&(a.emptyLangClass=""),{async:!!a.async,walkTokens(d){if("code"===d.type){const e=b(d.lang);if(a.async)return Promise.resolve(a.highlight(d.text,e,d.lang||"")).then(c(d));const f=a.highlight(d.text,e,d.lang||"");if(f instanceof Promise)throw new Error("markedHighlight is not set to async but the highlight function is async. Set the async option to true on markedHighlight to await the async highlight function.");c(d)(f)}},useNewRenderer:!0,renderer:{code(c,e,f){"object"==typeof c&&(f=c.escaped,e=c.lang,c=c.text);const g=b(e),h=g?a.langPrefix+d(g):a.emptyLangClass,i=h?` class="${h}"`:"";return c=c.replace(/\n$/,""),`<pre><code${i}>${f?c:d(c,!0)}\n</code></pre>`}}}}});
